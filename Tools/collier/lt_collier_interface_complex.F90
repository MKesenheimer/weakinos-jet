...
!! version with complex parameters as input for the routines
!!
!!
...
#include "lt_collier1.h"
  ...
  RealType :: pi,DeltaIR1,DeltaIR2
  RealType :: DeltaIR1s,DeltaIR2s
  ComplexType :: p10,p21,p20,m02,m12,m22
...
#include "lt_collier1.h"
  ...
  RealType :: pi,DeltaIR1,DeltaIR2
  RealType :: DeltaIR1s,DeltaIR2s
  ComplexType :: p10,p21,p32,p30,p20,p31,m02,m12,m22,m32
...
#include "lt_collier1.h"
  ...
  RealType :: pi,DeltaIR1,DeltaIR2
  RealType :: DeltaIR1s,DeltaIR2s
  ComplexType :: p10,p21,p32,p43,p40,p20,p31,p42,p30,p41,m02,m12,m22,m32,m42
...
ComplexType function D0i(i, p1, p2, p3, p4, p1p2, p2p3, &
  ...
  implicit none
  integer i
  ComplexType p1, p2, p3, p4, p1p2, p2p3, m1, m2, m3, m4
