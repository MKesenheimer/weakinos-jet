...
!! version with real parameters as input for the routines
!!
!!
...
#include "lt_collier1.h"
  integer :: i,j,j0,rank
  RealType :: pi,DeltaIR1,DeltaIR2
  RealType :: DeltaIR1s,DeltaIR2s
  RealType :: m
  ComplexType :: mc
  ComplexType :: Atab(Naa)
...
!!$  &     'aa00', 'aa00:1', 'aa00:2' /
  ...
  call A_cll(Acoeff,Acoeffuv,mc,rank,Aerr)
...
#include "lt_collier1.h"
  ...
  RealType :: pi,DeltaIR1,DeltaIR2
  RealType :: DeltaIR1s,DeltaIR2s
  RealType :: p10,m02,m12
  ComplexType :: p10c,m02c,m12c
  ComplexType :: Btab(Nbb)
...
!!$  &     'dbb001', 'dbb001:1', 'dbb001:2' /
  ...
  call B_cll(Bcoeff,Bcoeffuv,p10c,m02c,m12c,rank,Berr)
  call DB_cll(DBcoeff,DBcoeffuv,p10c,m02c,m12c,rank,DBerr)
...
#include "lt_collier1.h"
  ...
  RealType :: pi,DeltaIR1,DeltaIR2
  RealType :: DeltaIR1s,DeltaIR2s
  RealType :: p10,p21,p20,m02,m12,m22
  ComplexType :: p10c,p21c,p20c,m02c,m12c,m22c
  ComplexType :: Ctab(Ncc)
...
!!$  &    'cc2222', 'cc2222:1', 'cc2222:2' /
  ...
  call C_cll(Ccoeff,Ccoeffuv,p10c,p21c,p20c,m02c,m12c,m22c,rank,Cerr)
...
#include "lt_collier1.h"
  ...
  RealType :: pi,DeltaIR1,DeltaIR2
  RealType :: DeltaIR1s,DeltaIR2s
  RealType :: p10,p21,p32,p30,p20,p31,m02,m12,m22,m32
  ComplexType :: p10c,p21c,p32c,p30c,p20c,p31c,m02c,m12c,m22c,m32c
  ComplexType :: Dtab(Ndd)
...
!!$  &    'dd33333', 'dd33333:1', 'dd33333:2' /
  ...
  call D_cll(Dcoeff,Dcoeffuv,p10c,p21c,p32c,p30c,p20c,p31c,m02c,m12c,m22c,m32c,rank,Derr)
...
subroutine Eput(Etab,p10,p21,p32,p43,p40,p20,p31,p42,p30,p41,m02,m12,m22,m32,m42)
  use COLLIER
  implicit none
#include "lt_collier1.h"
  integer :: i,j,j0,rank
  RealType :: pi,DeltaIR1,DeltaIR2
  RealType :: DeltaIR1s,DeltaIR2s
  RealType :: p10,p21,p32,p43,p40,p20,p31,p42,p30,p41,m02,m12,m22,m32,m42
  ComplexType :: p10c,p21c,p32c,p43c,p40c,p20c,p31c,p42c,p30c,p41c,m02c,m12c,m22c,m32c,m42c
  ComplexType :: Etab(Nee)
...
!!$  &    'ee4444', 'ee4444:1', 'ee4444:2' /
  ...
  call E_cll(Ecoeff,Ecoeffuv,p10c,p21c,p32c,p43c,p40c,p20c,p31c,p42c,p30c,p41c,m02c,m12c,m22c,m32c,m42c,rank,Eerr)
...
#define Ncc 66
  ...
  call Cput(b,p1,p2,p1p2,m1,m2,m3)
  C0i = b(i+epsi)
end function C0i
...
ComplexType function D0i(i, p1, p2, p3, p4, p1p2, p2p3, &
     m1, m2, m3, m4)
  implicit none
  integer i
  RealType p1, p2, p3, p4, p1p2, p2p3, m1, m2, m3, m4
...
#define Ndd 240  
  ...
  call Dput(b,p1, p2, p3, p4, p1p2, p2p3, &
     m1, m2, m3, m4)
  D0i = b(i+epsi)
end function D0i
...
ComplexType function E0i(i, p1, p2, p3, p4, p5, &
...
subroutine clearcache
  ...
  integer ncache
  ncache=1
  call InitEvent_cll(ncache) ! only one cache system as in LoopTools
...
subroutine init_collier(Nmax,Rmax)
  use COLLIER
  implicit none
  integer :: Nmax,Rmax,Nmax2,ncache
  print*, "===================================================="
  print*, "             init Collier                           "
  call Init_cll(Nmax,Rmax,'') ! Nmax: max number of legs; Rmax: max rank
  ncache=1
  ! ncache = number of cache systems to be used (here ncache = 1)
  ! Nmax2   = maximal N up to which N-point integrals are cached
  Nmax2  = Nmax
  ncache = 1
  call InitCacheSystem_cll(ncache,Nmax2)
  print*
...
subroutine setparam_collier(delta_uv,mu2,lambda)
  use COLLIER
  implicit none
  double precision :: delta_uv,mu2,lambda
