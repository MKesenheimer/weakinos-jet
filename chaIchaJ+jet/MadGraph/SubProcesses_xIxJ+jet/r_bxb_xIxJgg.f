      SUBROUTINE SMATRIX_BXB_XIXJGG(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_bxb_xIxJgg/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_BXB_XIXJGG(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_BXB_XIXJGG(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,20),W(1,4),GT1XJM,MTL,WTL,W(1,21))                                                          
      CALL FSIXXX(W(1,3),W(1,21),GT1XIP,BMASS,ZERO,W(1,22))                                                          
      CALL IOVXXX(W(1,22),W(1,1),W(1,6),GG,AMP(11))             
      CALL HIOXXX(W(1,20),W(1,4),GT2XJM,MTR,WTR,W(1,23))                                                          
      ...
      CALL FSOXXX(W(1,4),W(1,25),GT1XJM,BMASS,ZERO,W(1,26))                                                          
      ...
      CALL FSOXXX(W(1,4),W(1,28),GT2XJM,BMASS,ZERO,W(1,29))                                                          
      ...
      CALL FSOXXX(W(1,4),W(1,37),GT1XJM,BMASS,ZERO,W(1,38))                                                          
      CALL IOVXXX(W(1,2),W(1,38),W(1,6),GG,AMP(23))             
      CALL HVSXXX(W(1,5),W(1,28),GC,MTR,WTR,W(1,39))     
      CALL FSOXXX(W(1,4),W(1,39),GT2XJM,BMASS,ZERO,W(1,40))                                                          
     ...
     &             -AMP(  56)+AMP(  57)+AMP(  58)+AMP(  59)+AMP(  60)
      MATRIX_BXB_XIXJGG = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_BXB_XIXJGG =MATRIX_BXB_XIXJGG+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
