...
C  
C BORN AMPLITUDE IS d~ d -> x1+ x2- g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      CALL JIOXXX(W(1,3),W(1,4),GZXIJ,ZMASS,ZWIDTH,W(1, 10))                                                          
      CALL IOVXXX(W(1,2),W(1,7),W(1,10),GZD,AMP(4))            
      CALL FVIXXX(W(1,2),W(1,5),GG,ZERO,ZERO,W(1,11))     
      CALL IOVXXX(W(1,11),W(1,1),W(1,10),GZD,AMP(5))            
      do i=1,ngraphs
         if(ihel.eq.-1)then
