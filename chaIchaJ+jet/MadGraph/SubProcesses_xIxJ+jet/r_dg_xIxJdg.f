      SUBROUTINE SMATRIX_DG_XIXJDG(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_dg_xIxJdg/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_DG_XIXJDG(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_DG_XIXJDG(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,7),W(1,26),GZD,ZERO,ZERO,W(1,27))    
      CALL IOVXXX(W(1,1),W(1,27),W(1,6),GG,AMP(17))             
      CALL FVIXXX(W(1,1),W(1,26),GZD,ZERO,ZERO,W(1,28))    
     ...
     &             +AMP(  18)+AMP(  19)+AMP(  22)+AMP(  23)+AMP(  24)
      MATRIX_DG_XIXJDG = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_DG_XIXJDG =MATRIX_DG_XIXJDG+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
