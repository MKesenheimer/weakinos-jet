      SUBROUTINE SMATRIX_BD_XIXIDB(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_bd_xIxIdb/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_BD_XIXIDB(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_BD_XIXIDB(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,2),W(1,4),GULXIM,MUL,WUL,W(1,17))                                                          
      ...
      CALL IOVXXX(W(1,14),W(1,6),W(1,24),GAD,AMP(12))            
      CALL IOVXXX(W(1,14),W(1,6),W(1,27),GZD,AMP(13))            
      CALL HIOXXX(W(1,3),W(1,4),GH1XII,MH1,WH1,W(1,30))                                                          
      CALL IOSXXX(W(1,14),W(1,6),W(1,30),GH1BB,AMP(14))          
      CALL HIOXXX(W(1,3),W(1,4),GH2XII,MH2,WH2,W(1,31))                                                          
      CALL IOSXXX(W(1,14),W(1,6),W(1,31),GH2BB,AMP(15))          
      CALL HIOXXX(W(1,3),W(1,4),GH3XII,MH3,WH3,W(1,32))                                                          
      CALL IOSXXX(W(1,14),W(1,6),W(1,32),GH3BB,AMP(16))          
      CALL FVIXXX(W(1,1),W(1,24),GAD,BMASS,ZERO,W(1,33))    
      CALL IOVXXX(W(1,33),W(1,6),W(1,8),GG,AMP(17))             
      CALL FVIXXX(W(1,1),W(1,27),GZD,BMASS,ZERO,W(1,34))    
      CALL IOVXXX(W(1,34),W(1,6),W(1,8),GG,AMP(18))             
      CALL FSIXXX(W(1,1),W(1,30),GH1BB,BMASS,ZERO,W(1, 35))                                                          
      CALL IOVXXX(W(1,35),W(1,6),W(1,8),GG,AMP(19))             
      CALL FSIXXX(W(1,1),W(1,31),GH2BB,BMASS,ZERO,W(1, 36))                                                          
      CALL IOVXXX(W(1,36),W(1,6),W(1,8),GG,AMP(20))             
      CALL FSIXXX(W(1,1),W(1,32),GH3BB,BMASS,ZERO,W(1, 37))                                                          
      CALL IOVXXX(W(1,37),W(1,6),W(1,8),GG,AMP(21))             
     ...
     &             +AMP(  21)+AMP(  22)+AMP(  23)
      MATRIX_BD_XIXIDB = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_BD_XIXIDB =MATRIX_BD_XIXIDB+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
