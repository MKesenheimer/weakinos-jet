...
C  
C BORN AMPLITUDE IS d~ d -> x1+ x1- g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      CALL HIOXXX(W(1,3),W(1,1),GULXIP,MUL,WUL,W(1,8))                                                          
      ...
      CALL JIOXXX(W(1,3),W(1,4),GAX,ZERO,AWIDTH,W(1,10))    
      CALL IOVXXX(W(1,2),W(1,7),W(1,10),GAD,AMP(4))            
      CALL JIOXXX(W(1,3),W(1,4),GZXII,ZMASS,ZWIDTH,W(1, 11))                                                          
      CALL IOVXXX(W(1,2),W(1,7),W(1,11),GZD,AMP(5))            
      CALL FVIXXX(W(1,2),W(1,5),GG,ZERO,ZERO,W(1,12))     
      CALL IOVXXX(W(1,12),W(1,1),W(1,10),GAD,AMP(6))            
      CALL IOVXXX(W(1,12),W(1,1),W(1,11),GZD,AMP(7))            
      do i=1,ngraphs
         if(ihel.eq.-1)then
