...
C  
C BORN AMPLITUDE IS u~ u -> x1+ x1- g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      CALL IOVXXX(W(1,2),W(1,7),W(1,6),GAU,AMP(1))            
      CALL JIOXXX(W(1,3),W(1,4),GZXII,ZMASS,ZWIDTH,W(1, 8))                                                          
      CALL IOVXXX(W(1,2),W(1,7),W(1,8),GZU,AMP(2))            
      CALL FVIXXX(W(1,2),W(1,5),GG,ZERO,ZERO,W(1,9))     
      CALL IOVXXX(W(1,9),W(1,1),W(1,6),GAU,AMP(3))            
      CALL IOVXXX(W(1,9),W(1,1),W(1,8),GZU,AMP(4))            
      ...
      CALL FSIXXX(W(1,11),W(1,12),GDLXIP,ZERO,ZERO,W(1,13))                                                          
      CALL IOVXXX(W(1,13),W(1,1),W(1,5),GG,AMP(5))             
      CALL HIOXXX(W(1,11),W(1,1),GDLXIP,MDL,WDL,W(1,14))                                                          
      CALL IOSXXX(W(1,9),W(1,10),W(1,14),GDLXIM,AMP(6))         
      CALL VSSXXX(W(1,5),W(1,14),W(1,12),GC,AMP(7))             
      do i=1,ngraphs
         if(ihel.eq.-1)then
