      SUBROUTINE SMATRIX_UUX_XIXIDDX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_uux_xIxIddx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_UUX_XIXIDDX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_UUX_XIXIDDX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,1),W(1,30),GDLXIM,MDL,WDL,W(1,32))                                                          
      CALL FSICXX(W(1,31),W(1,32),GQLGOP,MGO,WGO,W(1,33))                                                          
      CALL HIOXXX(W(1,33),W(1,2),GQLGOP,MUL,WUL,W(1,34))                                                          
     ...
     &             -AMP(  12)-AMP(  15)-AMP(  16)-AMP(  17)
      MATRIX_UUX_XIXIDDX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_UUX_XIXIDDX =MATRIX_UUX_XIXIDDX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
