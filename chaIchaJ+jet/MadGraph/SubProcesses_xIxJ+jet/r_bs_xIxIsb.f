      SUBROUTINE SMATRIX_BS_XIXISB(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_bs_xIxIsb/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_BS_XIXISB(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_BS_XIXISB(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,2),W(1,4),GULXIM,MCL,WCL,W(1,17))                                                          
     ...
     &             +AMP(  21)+AMP(  22)+AMP(  23)
      MATRIX_BS_XIXISB = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_BS_XIXISB =MATRIX_BS_XIXISB+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
