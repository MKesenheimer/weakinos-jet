      SUBROUTINE SMATRIX_CCX_XIXISSX(P1,ANS)
C  
...
C  
C FOR PROCESS : c c~ -> x1+ x1- s s~  
C  
C Crossing   1 is c c~ -> x1+ x1- s s~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_Ramps_ccx_xIxIssx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_CCX_XIXISSX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_CCX_XIXISSX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,1),W(1,15),GAU,ZERO,ZERO,W(1,21))    
      CALL JIOXXX(W(1,21),W(1,2),GG,ZERO,ZERO,W(1,22))     
      CALL IOVXXX(W(1,6),W(1,5),W(1,22),GG,AMP(7))             
      CALL FVIXXX(W(1,1),W(1,18),GZU,ZERO,ZERO,W(1,23))    
      ...
      CALL HIOXXX(W(1,33),W(1,2),GQLGOP,MCL,WCL,W(1,34))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,34),GULXIM,AMP(14))         
      CALL FSOXXX(W(1,30),W(1,29),GDLXIM,ZERO,ZERO,W(1,35))                                                          
      CALL JIOXXX(W(1,1),W(1,35),GG,ZERO,ZERO,W(1,36))     
      CALL IOVXXX(W(1,6),W(1,5),W(1,36),GG,AMP(15))             
      CALL FSIXXX(W(1,27),W(1,32),GDLXIP,ZERO,ZERO,W(1,37))                                                          
     ...
     &             -AMP(  12)-AMP(  15)-AMP(  16)-AMP(  17)
      MATRIX_CCX_XIXISSX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_CCX_XIXISSX =MATRIX_CCX_XIXISSX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
