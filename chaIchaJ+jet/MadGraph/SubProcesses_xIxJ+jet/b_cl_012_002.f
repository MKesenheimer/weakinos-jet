...
C  
C BORN AMPLITUDE IS d~ g -> x1+ x1- d~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      CALL HIOXXX(W(1,3),W(1,1),GULXIP,MUL,WUL,W(1,6))                                                          
      ...
      CALL HIOXXX(W(1,3),W(1,9),GULXIP,MUL,WUL,W(1,10))                                                          
      CALL IOSXXX(W(1,5),W(1,4),W(1,10),GULXIM,AMP(3))         
      CALL JIOXXX(W(1,3),W(1,4),GAX,ZERO,AWIDTH,W(1,11))    
      CALL FVIXXX(W(1,5),W(1,2),GG,ZERO,ZERO,W(1,12))     
      CALL IOVXXX(W(1,12),W(1,1),W(1,11),GAD,AMP(4))            
      CALL JIOXXX(W(1,3),W(1,4),GZXII,ZMASS,ZWIDTH,W(1, 13))                                                          
      CALL IOVXXX(W(1,12),W(1,1),W(1,13),GZD,AMP(5))            
