...
C ----------
      ...
      CALL HIOXXX(W(1,10),W(1,1),GDLXJP,MDL,WDL,W(1,11))                                                          
      CALL IOSXXX(W(1,7),W(1,9),W(1,11),GDLXIM,AMP(3))         
      CALL HIOXXX(W(1,5),W(1,9),GDLXIM,MDL,WDL,W(1,12))                                                          
      CALL VSSXXX(W(1,2),W(1,11),W(1,12),GC,AMP(4))             
      CALL HIOXXX(W(1,10),W(1,8),GDLXJP,MDL,WDL,W(1,13))                                                          
      CALL IOSXXX(W(1,5),W(1,9),W(1,13),GDLXIM,AMP(5))         
      do i=1,ngraphs
         if(ihel.eq.-1)then
