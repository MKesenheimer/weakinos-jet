      SUBROUTINE SMATRIX_GB_XIXJBG(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_gb_xIxJbg/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_GB_XIXJBG(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_GB_XIXJBG(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FSOXXX(W(1,4),W(1,14),GT1XJM,BMASS,ZERO,W(1,15))                                                          
      ...
      CALL FSOXXX(W(1,4),W(1,24),GT1XJM,BMASS,ZERO,W(1,25))                                                          
      ...
      CALL FSOXXX(W(1,4),W(1,22),GT2XJM,BMASS,ZERO,W(1,34))                                                          
      ...
      CALL FVIXXX(W(1,44),W(1,1),GG,BMASS,ZERO,W(1,59))     
      CALL IOVXXX(W(1,59),W(1,5),W(1,6),GG,AMP(41))             
      CALL FVIXXX(W(1,47),W(1,1),GG,BMASS,ZERO,W(1,60))     
      CALL IOVXXX(W(1,60),W(1,5),W(1,6),GG,AMP(42))             
      CALL FVIXXX(W(1,50),W(1,1),GG,BMASS,ZERO,W(1,61))     
      CALL IOVXXX(W(1,61),W(1,5),W(1,6),GG,AMP(43))             
      CALL FVIXXX(W(1,53),W(1,1),GG,BMASS,ZERO,W(1,62))     
      ...
      CALL FSOXXX(W(1,5),W(1,46),GH1BB,BMASS,ZERO,W(1, 65))                                                          
      CALL JIOXXX(W(1,2),W(1,65),GG,ZERO,ZERO,W(1,66))     
      CALL VVVXXX(W(1,6),W(1,1),W(1,66),G,AMP(50))              
      CALL FSOXXX(W(1,5),W(1,49),GH2BB,BMASS,ZERO,W(1, 67))                                                          
      CALL JIOXXX(W(1,2),W(1,67),GG,ZERO,ZERO,W(1,68))     
      CALL VVVXXX(W(1,6),W(1,1),W(1,68),G,AMP(51))              
      CALL FSOXXX(W(1,5),W(1,52),GH3BB,BMASS,ZERO,W(1, 69))                                                          
      CALL JIOXXX(W(1,2),W(1,69),GG,ZERO,ZERO,W(1,70))     
      CALL VVVXXX(W(1,6),W(1,1),W(1,70),G,AMP(52))              
      CALL FVOXXX(W(1,63),W(1,1),GG,BMASS,ZERO,W(1,71))     
      CALL IOVXXX(W(1,2),W(1,71),W(1,6),GG,AMP(53))             
      CALL FVOXXX(W(1,65),W(1,1),GG,BMASS,ZERO,W(1,72))     
      CALL IOVXXX(W(1,2),W(1,72),W(1,6),GG,AMP(54))             
      CALL FVOXXX(W(1,67),W(1,1),GG,BMASS,ZERO,W(1,73))     
      CALL IOVXXX(W(1,2),W(1,73),W(1,6),GG,AMP(55))             
      CALL FVOXXX(W(1,69),W(1,1),GG,BMASS,ZERO,W(1,74))     
      ...
      CALL FSIXXX(W(1,38),W(1,46),GH1BB,BMASS,ZERO,W(1, 76))                                                          
      CALL IOVXXX(W(1,76),W(1,5),W(1,6),GG,AMP(58))             
      CALL FSIXXX(W(1,38),W(1,49),GH2BB,BMASS,ZERO,W(1, 77))                                                          
      CALL IOVXXX(W(1,77),W(1,5),W(1,6),GG,AMP(59))             
      CALL FSIXXX(W(1,38),W(1,52),GH3BB,BMASS,ZERO,W(1, 78))                                                          
     ...
     &             +AMP(  60)+AMP(  61)+AMP(  62)+AMP(  63)+AMP(  64)
      MATRIX_GB_XIXJBG = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_GB_XIXJBG =MATRIX_GB_XIXJBG+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
