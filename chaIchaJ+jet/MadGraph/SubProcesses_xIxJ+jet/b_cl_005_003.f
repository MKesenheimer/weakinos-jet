...
C ----------
      ...
      CALL IOVXXX(W(1,8),W(1,1),W(1,6),GZU,AMP(2))            
      ...
      CALL IOVXXX(W(1,12),W(1,1),W(1,5),GG,AMP(3))             
      CALL HIOXXX(W(1,10),W(1,1),GDLXJP,MDL,WDL,W(1,13))                                                          
      CALL IOSXXX(W(1,8),W(1,9),W(1,13),GDLXIM,AMP(4))         
      CALL VSSXXX(W(1,5),W(1,13),W(1,11),GC,AMP(5))             
      do i=1,ngraphs
         if(ihel.eq.-1)then
