...
C ----------
      ...
      CALL IOVXXX(W(1,7),W(1,2),W(1,8),GZU,AMP(2))            
      CALL FVOXXX(W(1,2),W(1,5),GG,ZERO,ZERO,W(1,9))     
      CALL IOVXXX(W(1,1),W(1,9),W(1,6),GAU,AMP(3))            
      CALL IOVXXX(W(1,1),W(1,9),W(1,8),GZU,AMP(4))            
      CALL OXXXXX(P(0,3),MXI,NHEL(3),+1*IC(3),W(1,10))         
      CALL IXXXXX(P(0,4),MXI,NHEL(4),-1*IC(4),W(1,11))         
      CALL HIOXXX(W(1,11),W(1,2),GDLXIP,MDL,WDL,W(1,12))                                                          
      CALL IOSXXX(W(1,7),W(1,10),W(1,12),GDLXIM,AMP(5))         
      CALL HIOXXX(W(1,1),W(1,10),GDLXIM,MDL,WDL,W(1,13))                                                          
      CALL FSIXXX(W(1,11),W(1,13),GDLXIP,ZERO,ZERO,W(1,14))                                                          
      CALL IOVXXX(W(1,14),W(1,2),W(1,5),GG,AMP(6))             
      CALL VSSXXX(W(1,5),W(1,12),W(1,13),GC,AMP(7))             
      do i=1,ngraphs
         if(ihel.eq.-1)then
