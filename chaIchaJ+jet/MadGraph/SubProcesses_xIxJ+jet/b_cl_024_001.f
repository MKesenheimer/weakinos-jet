...
C  
C BORN AMPLITUDE IS g u -> x1+ x2- u  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      CALL IOVXXX(W(1,2),W(1,7),W(1,6),GZU,AMP(1))            
      CALL FVIXXX(W(1,2),W(1,1),GG,ZERO,ZERO,W(1,8))     
      ...
      CALL HIOXXX(W(1,2),W(1,9),GDLXIM,MDL,WDL,W(1,11))                                                          
      CALL FSIXXX(W(1,10),W(1,11),GDLXJP,ZERO,ZERO,W(1,12))                                                          
      CALL IOVXXX(W(1,12),W(1,5),W(1,1),GG,AMP(3))             
      CALL HVSXXX(W(1,1),W(1,11),-GC,MDL,WDL,W(1,13))    
