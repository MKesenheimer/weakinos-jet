      SUBROUTINE SMATRIX_SXS_XIXJGG(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_sxs_xIxJgg/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_SXS_XIXJGG(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_SXS_XIXJGG(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,14),W(1,4),GULXJM,MCL,WCL,W(1,15))                                                          
      ...
      CALL FSOXXX(W(1,4),W(1,23),GULXJM,ZERO,ZERO,W(1,24))                                                          
      ...
      CALL FVIXXX(W(1,14),W(1,26),GZD,ZERO,ZERO,W(1,31))    
      CALL IOVXXX(W(1,31),W(1,1),W(1,6),GG,AMP(21))             
      CALL FVOXXX(W(1,1),W(1,26),GZD,ZERO,ZERO,W(1,32))    
     ...
     &             -AMP(  18)+AMP(  19)-AMP(  20)-AMP(  22)+AMP(  23)
      MATRIX_SXS_XIXJGG = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_SXS_XIXJGG =MATRIX_SXS_XIXJGG+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
