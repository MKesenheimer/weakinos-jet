...
C  
C BORN AMPLITUDE IS u g -> x1+ x2- u  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      CALL IOVXXX(W(1,1),W(1,7),W(1,6),GZU,AMP(1))            
      CALL FVIXXX(W(1,1),W(1,2),GG,ZERO,ZERO,W(1,8))     
      CALL IOVXXX(W(1,8),W(1,5),W(1,6),GZU,AMP(2))            
      CALL OXXXXX(P(0,3),MXI,NHEL(3),+1*IC(3),W(1,9))         
      CALL IXXXXX(P(0,4),MXJ,NHEL(4),-1*IC(4),W(1,10))         
      CALL HIOXXX(W(1,1),W(1,9),GDLXIM,MDL,WDL,W(1,11))                                                          
      CALL FSIXXX(W(1,10),W(1,11),GDLXJP,ZERO,ZERO,W(1,12))                                                          
      CALL IOVXXX(W(1,12),W(1,5),W(1,2),GG,AMP(3))             
      CALL HVSXXX(W(1,2),W(1,11),-GC,MDL,WDL,W(1,13))    
      CALL IOSXXX(W(1,10),W(1,5),W(1,13),GDLXJP,AMP(4))         
      CALL HIOXXX(W(1,8),W(1,9),GDLXIM,MDL,WDL,W(1,14))                                                          
      CALL IOSXXX(W(1,10),W(1,5),W(1,14),GDLXJP,AMP(5))         
      do i=1,ngraphs
         if(ihel.eq.-1)then
