      SUBROUTINE SB_CL_034_001(P1,ANS)
C  
...
C  
C BORN AMPLITUDE IS g u -> x1+ x1- u  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_034/  amp2,       jamp2

      integer j,jj
      integer max_bhel
      parameter( max_bhel =          32)
      double complex saveamp(ngraphs,max_bhel)
      common/to_saveamp_034/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_034/savemom
...
C          write(*,*) "momenta not the same in Born"
     ...
     &       nhel(1,ihel).eq.-1) THEN
                 T=B_CL_034_001(P1,NHEL(1,IHEL),IHEL,JC(1),T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_034_001(P,NHEL,HELL,IC,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVXXX(W(1,13),W(1,5),W(1,1),GG,AMP(5))             
      CALL HVSXXX(W(1,1),W(1,12),-GC,MDL,WDL,W(1,14))    
      CALL IOSXXX(W(1,11),W(1,5),W(1,14),GDLXIP,AMP(6))         
      CALL HIOXXX(W(1,9),W(1,10),GDLXIM,MDL,WDL,W(1,15))                                                          
      CALL IOSXXX(W(1,11),W(1,5),W(1,15),GDLXIP,AMP(7))         
      do i=1,ngraphs
         if(ihel.eq.-1)then
     ...
     &             +AMP(   6)+AMP(   7)
      DO I = 1, NCOLOR
          ...
          if(ihel.eq.-1) then
             B_CL_034_001=B_CL_034_001 +RTEMP
          elseif(ihel.eq.1) then
             B_CL_034_001=B_CL_034_001 +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
