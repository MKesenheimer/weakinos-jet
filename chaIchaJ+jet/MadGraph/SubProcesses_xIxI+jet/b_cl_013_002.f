...
C ----------
      ...
      CALL IOSXXX(W(1,3),W(1,9),W(1,8),GULXIP,AMP(2))         
      ...
      CALL IOVXXX(W(1,11),W(1,2),W(1,10),GAD,AMP(4))            
      CALL JIOXXX(W(1,3),W(1,4),GZXII,ZMASS,ZWIDTH,W(1, 12))                                                          
      CALL IOVXXX(W(1,11),W(1,2),W(1,12),GZD,AMP(5))            
      CALL IOVXXX(W(1,1),W(1,9),W(1,10),GAD,AMP(6))            
      CALL IOVXXX(W(1,1),W(1,9),W(1,12),GZD,AMP(7))            
      do i=1,ngraphs
