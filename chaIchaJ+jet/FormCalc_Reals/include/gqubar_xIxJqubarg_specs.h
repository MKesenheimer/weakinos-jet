...
#undef PROCNAME
#define PROCNAME "V5iFb3iiFb12iF12iFb3iiV5i"
...
#undef Mass
#define Mass(f,c) Compose(f,c,0,Mf(3,Gen(2)),MCha(Cha(3)),MCha(Cha(4)),Mf(3,Gen(5)),0)

#undef Charge
#define Charge(f,c) Compose(f,c,0,-2/3.D0,1,-1,-2/3.D0,0)
