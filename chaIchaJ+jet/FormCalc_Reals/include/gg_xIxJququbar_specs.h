...
#undef PROCNAME
#define PROCNAME "V5iV5iFb12iF12iF3iiFb3ii"
...
#undef Mass
#define Mass(f,c) Compose(f,c,0,0,MCha(Cha(3)),MCha(Cha(4)),Mf(3,Gen(5)),Mf(3,Gen(6)))

#undef Charge
#define Charge(f,c) Compose(f,c,0,0,1,-1,2/3.D0,-2/3.D0)
