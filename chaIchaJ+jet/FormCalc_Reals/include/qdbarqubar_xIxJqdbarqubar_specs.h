...
#undef PROCNAME
#define PROCNAME "Fb4iiFb3iiFb12iF12iFb4iiFb3ii"
...
#undef Mass
#define Mass(f,c) Compose(f,c,Mf(4,Gen(1)),Mf(3,Gen(2)),MCha(Cha(3)),MCha(Cha(4)),Mf(4,Gen(5)),Mf(3,Gen(6)))

#undef Charge
#define Charge(f,c) Compose(f,c,1/3.D0,-2/3.D0,1,-1,1/3.D0,-2/3.D0)
