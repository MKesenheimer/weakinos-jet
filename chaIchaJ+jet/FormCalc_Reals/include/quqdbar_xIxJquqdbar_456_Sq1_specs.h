...
#undef PROCNAME
#define PROCNAME "F3iiFb4iiFb12iF12iF3iiFb4ii"
...
#undef Mass
#define Mass(f,c) Compose(f,c,Mf(3,Gen(1)),Mf(4,Gen(2)),MCha(Cha(3)),MCha(Cha(4)),Mf(3,Gen(5)),Mf(4,Gen(6)))

#undef Charge
#define Charge(f,c) Compose(f,c,2/3.D0,1/3.D0,1,-1,2/3.D0,1/3.D0)
