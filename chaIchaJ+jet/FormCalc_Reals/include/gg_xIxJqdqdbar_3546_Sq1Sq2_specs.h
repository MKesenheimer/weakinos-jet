...
#undef PROCNAME
#define PROCNAME "V5iV5iFb12iF12iF4iiFb4ii"
...
#undef Mass
#define Mass(f,c) Compose(f,c,0,0,MCha(Cha(3)),MCha(Cha(4)),Mf(4,Gen(5)),Mf(4,Gen(6)))

#undef Charge
#define Charge(f,c) Compose(f,c,0,0,1,-1,-1/3.D0,1/3.D0)
