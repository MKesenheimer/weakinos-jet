...
#undef PROCNAME
#define PROCNAME "Fb3iiV5iFb12iF12iFb3ii"
...
#undef Mass
#define Mass(f,c) Compose(f,c,Mf(3,Gen(1)),0,MCha(Cha(3)),MCha(Cha(4)),Mf(3,Gen(5)))

#undef Charge
#define Charge(f,c) Compose(f,c,-2/3.D0,0,1,-1,-2/3.D0)
