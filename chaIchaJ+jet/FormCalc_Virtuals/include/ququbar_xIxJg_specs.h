...
#undef PROCNAME
#define PROCNAME "F3iiFb3iiFb12iF12iV5i"
...
#undef Mass
#define Mass(f,c) Compose(f,c,Mf(3,Gen(1)),Mf(3,Gen(2)),MCha(Cha(3)),MCha(Cha(4)),0)

#undef Charge
#define Charge(f,c) Compose(f,c,2/3.D0,-2/3.D0,1,-1,0)
