...
* generated by FormCalc 9.4 (7 Jun 2016) on 20-Dec-2016 16:36
#endif
...
#undef PROCNAME
#define PROCNAME "F4iiFb4iiF11iF11iV5i"
...
#undef Mass
#define Mass(f,c) Compose(f,c,Mf(4,Gen(1)),Mf(4,Gen(2)),MNeu(Neu(3)),MNeu(Neu(4)),0)
