...
* generated by FormCalc 9.4 (7 Jun 2016) on 18-Jan-2017 20:02
#endif
...
#undef PROCNAME
#define PROCNAME "F3iiFb3iiF11iF11iV5i"
...
#undef Mass
#define Mass(f,c) Compose(f,c,Mf(3,Gen(1)),Mf(3,Gen(2)),MNeu(Neu(3)),MNeu(Neu(4)),0)

#undef Charge
#define Charge(f,c) Compose(f,c,2/3.D0,-2/3.D0,0,0,0)
