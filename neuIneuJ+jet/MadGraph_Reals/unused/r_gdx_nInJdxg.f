      SUBROUTINE SMATRIX_GDX_NINJDXG(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_gdx_nInJdxg/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_GDX_NINJDXG(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_GDX_NINJDXG(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,4),W(1,2),GDLNJP,MDL,WDL,W(1,7))                                                          
      ...
      CALL HIOXXX(W(1,4),W(1,2),GDRNJP,MDR,WDR,W(1,10))                                                          
      ...
      CALL HIOXXX(W(1,13),W(1,3),GDLNIM,MDL,WDL,W(1,14))                                                          
      CALL FSIXXX(W(1,4),W(1,14),GDLNJP,ZERO,ZERO,W(1,15))                                                          
      CALL IOVXXX(W(1,15),W(1,2),W(1,6),GG,AMP(3))             
      CALL HIOXXX(W(1,13),W(1,3),GDRNIM,MDR,WDR,W(1,16))                                                          
      ...
      CALL HIOXXX(W(1,5),W(1,3),GDRNIM,MDR,WDR,W(1,22))                                                          
      ...
      CALL HIOXXX(W(1,52),W(1,2),GDLNIP,MDL,WDL,W(1,54))                                                          
      ...
      CALL HIOXXX(W(1,52),W(1,2),GDRNIP,MDR,WDR,W(1,57))                                                          
      ...
      CALL HIOXXX(W(1,13),W(1,53),GDLNJM,MDL,WDL,W(1,60))                                                          
      CALL FSIXXX(W(1,52),W(1,60),GDLNIP,ZERO,ZERO,W(1,61))                                                          
      CALL IOVXXX(W(1,61),W(1,2),W(1,6),GG,AMP(43))             
      CALL HIOXXX(W(1,13),W(1,53),GDRNJM,MDR,WDR,W(1,62))                                                          
     ...
     &             +AMP(  60)+AMP(  63)+AMP(  64)+AMP(  65)+AMP(  66)
      MATRIX_GDX_NINJDXG = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_GDX_NINJDXG =MATRIX_GDX_NINJDXG+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
