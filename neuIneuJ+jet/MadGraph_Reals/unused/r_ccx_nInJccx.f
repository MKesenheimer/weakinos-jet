      SUBROUTINE SMATRIX_CCX_NINJCCX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_ccx_nInJccx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_CCX_NINJCCX(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_CCX_NINJCCX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     27))                                                          
      CALL HIOXXX(W(1,27),W(1,2),GQLGOP,MCL,WCL,W(1,28))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,28),GULNIM,AMP(15))         
      CALL HIOXXX(W(1,27),W(1,2),GQRGOP,MCR,WCR,W(1,29))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,29),GURNIM,AMP(16))         
      CALL FSICXX(W(1,5),W(1,10),GQRGOP,MGO,WGO,W(1,      
     &     30))                                                          
      CALL HIOXXX(W(1,30),W(1,2),GQLGOP,MCL,WCL,W(1,31))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,31),GULNIM,AMP(17))         
      CALL HIOXXX(W(1,30),W(1,2),GQRGOP,MCR,WCR,W(1,32))                                                          
     ...
     &     33))                                                          
      ...
      CALL HIOXXX(W(1,34),W(1,2),GQLGOP,MCL,WCL,W(1,35))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,35),GULNIM,AMP(19))         
      CALL HIOXXX(W(1,34),W(1,2),GQRGOP,MCR,WCR,W(1,36))                                                          
     ...
     &     37))                                                          
      ...
      CALL HIOXXX(W(1,38),W(1,2),GQLGOP,MCL,WCL,W(1,39))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,39),GULNIM,AMP(21))         
      CALL HIOXXX(W(1,38),W(1,2),GQRGOP,MCR,WCR,W(1,40))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,40),GURNIM,AMP(22))         
      CALL JIOXXX(W(1,1),W(1,2),GG,ZERO,ZERO,W(1,41))     
      CALL HVSXXX(W(1,41),W(1,33),GC,MCL,WCL,W(1,42))     
      CALL IOSXXX(W(1,6),W(1,3),W(1,42),GULNIM,AMP(23))         
      CALL HVSXXX(W(1,41),W(1,37),GC,MCR,WCR,W(1,43))     
      ...
      CALL HIOCXX(W(1,46),W(1,4),GULNJP,MCL,WCL,W(1,      
     &     47))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,47),GULNIM,AMP(27))         
      CALL HIOCXX(W(1,46),W(1,4),GURNJP,MCR,WCR,W(1,      
     &     48))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,48),GURNIM,AMP(28))         
      CALL HIOXXX(W(1,1),W(1,3),GULNIM,MCL,WCL,W(1,49))                                                          
      CALL FSOCXX(W(1,4),W(1,49),GULNJP,ZERO,ZERO,W(1,      
     &     50))                                                          
      CALL JIOCXX(W(1,5),W(1,50),GG,ZERO,ZERO,W(1,51))    
      CALL IOVXXX(W(1,6),W(1,2),W(1,51),GG,AMP(29))             
      CALL HIOXXX(W(1,1),W(1,3),GURNIM,MCR,WCR,W(1,52))                                                          
      CALL FSOCXX(W(1,4),W(1,52),GURNJP,ZERO,ZERO,W(1,      
     &     53))                                                          
      ...
      CALL HIOXXX(W(1,61),W(1,2),GQLGOP,MCL,WCL,W(1,62))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,62),GULNJM,AMP(39))         
      CALL HIOXXX(W(1,61),W(1,2),GQRGOP,MCR,WCR,W(1,63))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,63),GURNJM,AMP(40))         
      CALL FSIXXX(W(1,1),W(1,15),GQRGOM,MGO,WGO,W(1,64))                                                          
      CALL HIOXXX(W(1,64),W(1,2),GQLGOP,MCL,WCL,W(1,65))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,65),GULNJM,AMP(41))         
      CALL HIOXXX(W(1,64),W(1,2),GQRGOP,MCR,WCR,W(1,66))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,66),GURNJM,AMP(42))         
      CALL HVSXXX(W(1,41),W(1,13),GC,MCL,WCL,W(1,67))     
      CALL IOSXXX(W(1,6),W(1,4),W(1,67),GULNJM,AMP(43))         
      CALL HVSXXX(W(1,41),W(1,15),GC,MCR,WCR,W(1,68))     
      ...
      CALL HIOCXX(W(1,46),W(1,3),GULNIP,MCL,WCL,W(1,      
     &     69))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,69),GULNJM,AMP(47))         
      CALL HIOCXX(W(1,46),W(1,3),GURNIP,MCR,WCR,W(1,      
     &     70))                                                          
     ...
     &     75))                                                          
      CALL HIOXXX(W(1,75),W(1,2),GQLGOP,MCL,WCL,W(1,76))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,76),GULNJM,AMP(53))         
      CALL HIOXXX(W(1,75),W(1,2),GQRGOP,MCR,WCR,W(1,77))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,77),GURNJM,AMP(54))         
      CALL FSICXX(W(1,5),W(1,52),GQRGOP,MGO,WGO,W(1,      
     &     78))                                                          
      CALL HIOXXX(W(1,78),W(1,2),GQLGOP,MCL,WCL,W(1,79))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,79),GULNJM,AMP(55))         
      CALL HIOXXX(W(1,78),W(1,2),GQRGOP,MCR,WCR,W(1,80))                                                          
      ...
      CALL HIOXXX(W(1,81),W(1,2),GULNJP,MCL,WCL,W(1,83))                                                          
      CALL JIOXXX(W(1,1),W(1,82),GG,ZERO,ZERO,W(1,84))     
      CALL HVSXXX(W(1,84),W(1,83),GC,MCL,WCL,W(1,85))     
      CALL IOSXXX(W(1,6),W(1,3),W(1,85),GULNIM,AMP(57))         
      CALL HIOXXX(W(1,81),W(1,2),GURNJP,MCR,WCR,W(1,86))                                                          
      CALL HVSXXX(W(1,84),W(1,86),GC,MCR,WCR,W(1,87))     
      ...
      CALL HIOXXX(W(1,119),W(1,2),GULNIP,MCL,WCL,W(1,120))                                                          
      CALL HVSXXX(W(1,84),W(1,120),GC,MCL,WCL,W(1,121))     
      CALL IOSXXX(W(1,6),W(1,4),W(1,121),GULNJM,AMP(93))         
      CALL HIOXXX(W(1,119),W(1,2),GURNIP,MCR,WCR,W(1,122))                                                          
      CALL HVSXXX(W(1,84),W(1,122),GC,MCR,WCR,W(1,123))     
      ...
      CALL HIOXXX(W(1,126),W(1,82),GQLGOP,MCL,WCL,W(1,127))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,127),GULNJM,AMP(97))         
      CALL HIOXXX(W(1,126),W(1,82),GQRGOP,MCR,WCR,W(1,128))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,128),GURNJM,AMP(98))         
      CALL FSIXXX(W(1,1),W(1,122),GQRGOM,MGO,WGO,W(1,129))                                                          
      CALL HIOXXX(W(1,129),W(1,82),GQLGOP,MCL,WCL,W(1,130))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,130),GULNJM,AMP(99))         
      CALL HIOXXX(W(1,129),W(1,82),GQRGOP,MCR,WCR,W(1,131))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,131),GURNJM,AMP(100))         
      CALL HIOXXX(W(1,119),W(1,96),GULNIP,MCL,WCL,W(1,132))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,132),GULNJM,AMP(101))         
      CALL HIOXXX(W(1,119),W(1,96),GURNIP,MCR,WCR,W(1,133))                                                          
     ...
     &             +AMP( 108)+AMP( 117)+AMP( 118)+AMP( 119)+AMP( 120)
      MATRIX_CCX_NINJCCX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_CCX_NINJCCX =MATRIX_CCX_NINJCCX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
