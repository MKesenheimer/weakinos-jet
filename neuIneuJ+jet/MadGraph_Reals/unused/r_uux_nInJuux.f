      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_UUX_NINJUUX(P,NHEL(1,IHEL),JC(1))            
...
C ----------
     ...
     &     37))                                                          
      ...
      CALL HIOCXX(W(1,46),W(1,4),GULNJP,MUL,WUL,W(1,      
     &     47))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,47),GULNIM,AMP(27))         
      CALL HIOCXX(W(1,46),W(1,4),GURNJP,MUR,WUR,W(1,      
     &     48))                                                          
     ...
     &     53))                                                          
      ...
      CALL HIOCXX(W(1,46),W(1,3),GULNIP,MUL,WUL,W(1,      
     &     69))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,69),GULNJM,AMP(47))         
      CALL HIOCXX(W(1,46),W(1,3),GURNIP,MUR,WUR,W(1,      
     &     70))                                                          
