      SUBROUTINE SMATRIX_UUX_NINJGG(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_uux_nInJgg/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_UUX_NINJGG(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_UUX_NINJGG(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,4),W(1,20),GULNJP,MUL,WUL,W(1,21))                                                          
      CALL FSOXXX(W(1,3),W(1,21),GULNIM,ZERO,ZERO,W(1,22))                                                          
      CALL IOVXXX(W(1,1),W(1,22),W(1,6),GG,AMP(11))             
      CALL HIOXXX(W(1,4),W(1,20),GURNJP,MUR,WUR,W(1,23))                                                          
      ...
      CALL HIOXXX(W(1,1),W(1,3),GURNIM,MUR,WUR,W(1,28))                                                          
      ...
      CALL HIOXXX(W(1,1),W(1,53),GURNJM,MUR,WUR,W(1,73))                                                          
     ...
     &             -AMP(  66)-AMP(  67)-AMP(  68)-AMP(  69)-AMP(  70)
      MATRIX_UUX_NINJGG = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_UUX_NINJGG =MATRIX_UUX_NINJGG+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
