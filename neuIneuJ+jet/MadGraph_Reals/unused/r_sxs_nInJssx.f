      SUBROUTINE SMATRIX_SXS_NINJSSX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_sxs_nInJssx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_SXS_NINJSSX(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_SXS_NINJSSX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     23))                                                          
      ...
      CALL HIOXXX(W(1,24),W(1,1),GQLGOP,MSL,WSL,W(1,25))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,25),GDLNJM,AMP(11))         
      CALL HIOXXX(W(1,24),W(1,1),GQRGOP,MSR,WSR,W(1,26))                                                          
     ...
     &     27))                                                          
      ...
      CALL HIOXXX(W(1,28),W(1,1),GQLGOP,MSL,WSL,W(1,29))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,29),GDLNJM,AMP(13))         
      CALL HIOXXX(W(1,28),W(1,1),GQRGOP,MSR,WSR,W(1,30))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,30),GDRNJM,AMP(14))         
      CALL JIOXXX(W(1,2),W(1,1),GG,ZERO,ZERO,W(1,31))     
      CALL HVSXXX(W(1,31),W(1,23),GC,MSL,WSL,W(1,32))     
      CALL IOSXXX(W(1,6),W(1,4),W(1,32),GDLNJM,AMP(15))         
      CALL HVSXXX(W(1,31),W(1,27),GC,MSR,WSR,W(1,33))     
      ...
      CALL HIOCXX(W(1,36),W(1,3),GDLNIP,MSL,WSL,W(1,      
     &     37))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,37),GDLNJM,AMP(19))         
      CALL HIOCXX(W(1,36),W(1,3),GDRNIP,MSR,WSR,W(1,      
     &     38))                                                          
     ...
     &     43))                                                          
      CALL HIOXXX(W(1,43),W(1,1),GQLGOP,MSL,WSL,W(1,44))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,44),GDLNJM,AMP(25))         
      CALL HIOXXX(W(1,43),W(1,1),GQRGOP,MSR,WSR,W(1,45))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,45),GDRNJM,AMP(26))         
      CALL FSICXX(W(1,5),W(1,10),GQRGOP,MGO,WGO,W(1,      
     &     46))                                                          
      CALL HIOXXX(W(1,46),W(1,1),GQLGOP,MSL,WSL,W(1,47))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,47),GDLNJM,AMP(27))         
      CALL HIOXXX(W(1,46),W(1,1),GQRGOP,MSR,WSR,W(1,48))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,48),GDRNJM,AMP(28))         
      CALL HIOXXX(W(1,2),W(1,4),GDLNJM,MSL,WSL,W(1,49))                                                          
      CALL FSOCXX(W(1,3),W(1,49),GDLNIP,ZERO,ZERO,W(1,      
     &     50))                                                          
      CALL JIOCXX(W(1,5),W(1,50),GG,ZERO,ZERO,W(1,51))    
      CALL IOVXXX(W(1,6),W(1,1),W(1,51),GG,AMP(29))             
      CALL HIOXXX(W(1,2),W(1,4),GDRNJM,MSR,WSR,W(1,52))                                                          
      CALL FSOCXX(W(1,3),W(1,52),GDRNIP,ZERO,ZERO,W(1,      
     &     53))                                                          
     ...
     &     68))                                                          
      ...
      CALL HIOCXX(W(1,36),W(1,4),GDLNJP,MSL,WSL,W(1,      
     &     79))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,79),GDLNIM,AMP(55))         
      CALL HIOCXX(W(1,36),W(1,4),GDRNJP,MSR,WSR,W(1,      
     &     80))                                                          
      ...
      CALL HIOXXX(W(1,81),W(1,1),GDLNJP,MSL,WSL,W(1,87))                                                          
      ...
      CALL HIOXXX(W(1,81),W(1,1),GDRNJP,MSR,WSR,W(1,90))                                                          
      ...
      CALL HVSXXX(W(1,97),W(1,87),GC,MSL,WSL,W(1,98))     
      CALL IOSXXX(W(1,6),W(1,3),W(1,98),GDLNIM,AMP(67))         
      CALL HVSXXX(W(1,97),W(1,90),GC,MSR,WSR,W(1,99))     
      ...
      CALL HIOXXX(W(1,119),W(1,1),GDLNIP,MSL,WSL,W(1,124))                                                          
      ...
      CALL HIOXXX(W(1,119),W(1,1),GDRNIP,MSR,WSR,W(1,127))                                                          
      ...
      CALL HVSXXX(W(1,97),W(1,124),GC,MSL,WSL,W(1,134))     
      CALL IOSXXX(W(1,6),W(1,4),W(1,134),GDLNJM,AMP(103))         
      CALL HVSXXX(W(1,97),W(1,127),GC,MSR,WSR,W(1,135))     
      ...
      CALL HIOXXX(W(1,136),W(1,82),GQLGOP,MSL,WSL,W(1,137))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,137),GDLNJM,AMP(107))         
      CALL HIOXXX(W(1,136),W(1,82),GQRGOP,MSR,WSR,W(1,138))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,138),GDRNJM,AMP(108))         
      CALL FSIXXX(W(1,2),W(1,127),GQRGOM,MGO,WGO,W(1,139))                                                          
      CALL HIOXXX(W(1,139),W(1,82),GQLGOP,MSL,WSL,W(1,140))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,140),GDLNJM,AMP(109))         
      CALL HIOXXX(W(1,139),W(1,82),GQRGOP,MSR,WSR,W(1,141))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,141),GDRNJM,AMP(110))         
      CALL HIOXXX(W(1,119),W(1,106),GDLNIP,MSL,WSL,W(1,142))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,142),GDLNJM,AMP(111))         
      CALL HIOXXX(W(1,119),W(1,106),GDRNIP,MSR,WSR,W(1,143))                                                          
     ...
     &             +AMP( 110)-AMP( 117)-AMP( 118)-AMP( 119)-AMP( 120)
      MATRIX_SXS_NINJSSX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_SXS_NINJSSX =MATRIX_SXS_NINJSSX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
