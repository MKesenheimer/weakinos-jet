      SUBROUTINE SMATRIX_SXB_NINJSXB(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_sxb_nInJsxb/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_SXB_NINJSXB(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_SXB_NINJSXB(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     13))                                                          
      ...
      CALL HIOXXX(W(1,5),W(1,4),GDLNJM,MSL,WSL,W(1,17))                                                          
      ...
      CALL HIOXXX(W(1,5),W(1,4),GDRNJM,MSR,WSR,W(1,21))                                                          
     ...
     &     30))                                                          
      ...
      CALL HIOXXX(W(1,5),W(1,3),GDLNIM,MSL,WSL,W(1,33))                                                          
      ...
      CALL HIOXXX(W(1,5),W(1,3),GDRNIM,MSR,WSR,W(1,37))                                                          
      ...
      CALL HIOXXX(W(1,41),W(1,1),GDLNJP,MSL,WSL,W(1,43))                                                          
      ...
      CALL HIOXXX(W(1,41),W(1,1),GDRNJP,MSR,WSR,W(1,46))                                                          
     ...
     &     73))                                                          
      ...
      CALL HIOXXX(W(1,76),W(1,1),GDLNIP,MSL,WSL,W(1,77))                                                          
      ...
      CALL HIOXXX(W(1,76),W(1,1),GDRNIP,MSR,WSR,W(1,80))                                                          
     ...
     &             +AMP(  66)
      MATRIX_SXB_NINJSXB = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_SXB_NINJSXB =MATRIX_SXB_NINJSXB+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
