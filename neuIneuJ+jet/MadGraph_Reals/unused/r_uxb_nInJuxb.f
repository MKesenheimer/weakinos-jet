      SUBROUTINE SMATRIX_UXB_NINJUXB(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_uxb_nInJuxb/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_UXB_NINJUXB(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_UXB_NINJUXB(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     73))                                                          
      ...
      CALL HIOXXX(W(1,76),W(1,1),GULNIP,MUL,WUL,W(1,77))                                                          
      ...
      CALL HIOXXX(W(1,76),W(1,1),GURNIP,MUR,WUR,W(1,80))                                                          
     ...
     &             +AMP(  66)
      MATRIX_UXB_NINJUXB = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_UXB_NINJUXB =MATRIX_UXB_NINJUXB+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
