      SUBROUTINE SMATRIX_DXB_NINJDXB(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_dxb_nInJdxb/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_DXB_NINJDXB(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_DXB_NINJDXB(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     60))                                                          
      ...
      CALL FVOXXX(W(1,1),W(1,57),GZD,ZERO,ZERO,W(1,65))    
     ...
     &     73))                                                          
      ...
      CALL HIOXXX(W(1,76),W(1,1),GDRNIP,MDR,WDR,W(1,80))                                                          
      ...
      CALL FSIXXX(W(1,76),W(1,17),GDLNIP,ZERO,ZERO,W(1,85))                                                          
      CALL JIOXXX(W(1,85),W(1,1),GG,ZERO,ZERO,W(1,86))     
      CALL IOVXXX(W(1,2),W(1,42),W(1,86),GG,AMP(57))             
      CALL FSIXXX(W(1,76),W(1,21),GDRNIP,ZERO,ZERO,W(1,87))                                                          
     ...
     &     91))                                                          
      CALL HIOXXX(W(1,2),W(1,91),GB1GOM,MBL,WB1,W(1,92))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,92),GB1N2P,AMP(63))        
      CALL HIOXXX(W(1,2),W(1,91),GB2GOM,MBR,WB2,W(1,93))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,93),GB2N2P,AMP(64))        
      CALL FSOCXX(W(1,69),W(1,80),GQRGOM,MGO,WGO,W(1,      
     &     94))                                                          
      CALL HIOXXX(W(1,2),W(1,94),GB1GOM,MBL,WB1,W(1,95))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,95),GB1N2P,AMP(65))        
      CALL HIOXXX(W(1,2),W(1,94),GB2GOM,MBR,WB2,W(1,96))                                                          
     ...
     &             +AMP(  66)
      MATRIX_DXB_NINJDXB = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_DXB_NINJDXB =MATRIX_DXB_NINJDXB+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
