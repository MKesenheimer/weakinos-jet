      SUBROUTINE SMATRIX_BXB_NINJDDX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_bxb_nInJddx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_BXB_NINJDDX(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_BXB_NINJDDX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     26))                                                          
      ...
      CALL HVSXXX(W(1,27),W(1,25),GC,MDL,WDL,W(1,28))     
      CALL IOSXXX(W(1,6),W(1,4),W(1,28),GDLNJM,AMP(17))         
      CALL HVSXXX(W(1,27),W(1,26),GC,MDR,WDR,W(1,29))     
     ...
     &     34))                                                          
      ...
      CALL HVSXXX(W(1,27),W(1,15),GC,MDL,WDL,W(1,35))     
      CALL IOSXXX(W(1,6),W(1,3),W(1,35),GDLNIM,AMP(23))         
      CALL HVSXXX(W(1,27),W(1,16),GC,MDR,WDR,W(1,36))     
     ...
     &             -AMP(  66)
      MATRIX_BXB_NINJDDX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_BXB_NINJDDX =MATRIX_BXB_NINJDDX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
