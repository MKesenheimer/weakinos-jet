      SUBROUTINE SMATRIX_SXCX_NINJCXSX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_sxcx_nInJcxsx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_SXCX_NINJCXSX(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_SXCX_NINJCXSX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,45),W(1,2),GURNIP,MCR,WCR,W(1,50))                                                          
      ...
      CALL HIOXXX(W(1,5),W(1,46),GULNJM,MCL,WCL,W(1,53))                                                          
      CALL JSSXXX(W(1,47),W(1,53),GC,ZERO,ZERO,W(1,54))     
      CALL IOVXXX(W(1,6),W(1,1),W(1,54),GG,AMP(27))             
      CALL HIOXXX(W(1,5),W(1,46),GURNJM,MCR,WCR,W(1,55))                                                          
     ...
     &             +AMP(  56)-AMP(  57)-AMP(  58)-AMP(  59)-AMP(  60)
      MATRIX_SXCX_NINJCXSX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_SXCX_NINJCXSX =MATRIX_SXCX_NINJCXSX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
