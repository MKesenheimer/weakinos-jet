      SUBROUTINE SMATRIX_CXC_NINJCCX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_cxc_nInJccx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_CXC_NINJCCX(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_CXC_NINJCCX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     15))                                                          
      ...
      CALL FSOXXX(W(1,3),W(1,13),GULNIM,ZERO,ZERO,W(1,19))                                                          
      CALL JIOXXX(W(1,2),W(1,19),GG,ZERO,ZERO,W(1,20))     
      CALL IOVXXX(W(1,6),W(1,1),W(1,20),GG,AMP(9))             
      CALL FSOXXX(W(1,3),W(1,15),GURNIM,ZERO,ZERO,W(1,21))                                                          
     ...
     &     23))                                                          
      ...
      CALL HIOXXX(W(1,24),W(1,1),GQLGOP,MCL,WCL,W(1,25))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,25),GULNJM,AMP(11))         
      CALL HIOXXX(W(1,24),W(1,1),GQRGOP,MCR,WCR,W(1,26))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,26),GURNJM,AMP(12))         
      CALL HIOCXX(W(1,5),W(1,3),GURNIP,MCR,WCR,W(1,      
     &     27))                                                          
      CALL FSIXXX(W(1,2),W(1,27),GQRGOM,MGO,WGO,W(1,28))                                                          
      CALL HIOXXX(W(1,28),W(1,1),GQLGOP,MCL,WCL,W(1,29))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,29),GULNJM,AMP(13))         
      CALL HIOXXX(W(1,28),W(1,1),GQRGOP,MCR,WCR,W(1,30))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,30),GURNJM,AMP(14))         
      CALL JIOXXX(W(1,2),W(1,1),GG,ZERO,ZERO,W(1,31))     
      CALL HVSXXX(W(1,31),W(1,23),GC,MCL,WCL,W(1,32))     
      CALL IOSXXX(W(1,6),W(1,4),W(1,32),GULNJM,AMP(15))         
      CALL HVSXXX(W(1,31),W(1,27),GC,MCR,WCR,W(1,33))     
      CALL IOSXXX(W(1,6),W(1,4),W(1,33),GURNJM,AMP(16))         
      CALL FSOXXX(W(1,4),W(1,23),GULNJM,ZERO,ZERO,W(1,34))                                                          
      CALL IOVXXX(W(1,6),W(1,34),W(1,31),GG,AMP(17))             
      CALL FSOXXX(W(1,4),W(1,27),GURNJM,ZERO,ZERO,W(1,35))                                                          
      CALL IOVXXX(W(1,6),W(1,35),W(1,31),GG,AMP(18))             
      CALL FVICXX(W(1,5),W(1,31),GG,ZERO,ZERO,W(1,36))    
      CALL HIOCXX(W(1,36),W(1,3),GULNIP,MCL,WCL,W(1,      
     &     37))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,37),GULNJM,AMP(19))         
      CALL HIOCXX(W(1,36),W(1,3),GURNIP,MCR,WCR,W(1,      
     &     38))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,38),GURNJM,AMP(20))         
      CALL HIOCXX(W(1,5),W(1,17),GQLGOP,MCL,WCL,W(1,      
     &     39))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,39),GULNJM,AMP(21))         
      CALL HIOCXX(W(1,5),W(1,17),GQRGOP,MCR,WCR,W(1,      
     &     40))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,40),GURNJM,AMP(22))         
      CALL HIOCXX(W(1,5),W(1,18),GQLGOP,MCL,WCL,W(1,      
     &     41))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,41),GULNJM,AMP(23))         
      CALL HIOCXX(W(1,5),W(1,18),GQRGOP,MCR,WCR,W(1,      
     &     42))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,42),GURNJM,AMP(24))         
      CALL FSICXX(W(1,5),W(1,7),GQLGOP,MGO,WGO,W(1,      
     &     43))                                                          
      CALL HIOXXX(W(1,43),W(1,1),GQLGOP,MCL,WCL,W(1,44))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,44),GULNJM,AMP(25))         
      CALL HIOXXX(W(1,43),W(1,1),GQRGOP,MCR,WCR,W(1,45))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,45),GURNJM,AMP(26))         
      CALL FSICXX(W(1,5),W(1,10),GQRGOP,MGO,WGO,W(1,      
     &     46))                                                          
      CALL HIOXXX(W(1,46),W(1,1),GQLGOP,MCL,WCL,W(1,47))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,47),GULNJM,AMP(27))         
      CALL HIOXXX(W(1,46),W(1,1),GQRGOP,MCR,WCR,W(1,48))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,48),GURNJM,AMP(28))         
      CALL HIOXXX(W(1,2),W(1,4),GULNJM,MCL,WCL,W(1,49))                                                          
      CALL FSOCXX(W(1,3),W(1,49),GULNIP,ZERO,ZERO,W(1,      
     &     50))                                                          
      CALL JIOCXX(W(1,5),W(1,50),GG,ZERO,ZERO,W(1,51))    
      CALL IOVXXX(W(1,6),W(1,1),W(1,51),GG,AMP(29))             
      CALL HIOXXX(W(1,2),W(1,4),GURNJM,MCR,WCR,W(1,52))                                                          
      CALL FSOCXX(W(1,3),W(1,52),GURNIP,ZERO,ZERO,W(1,      
     &     53))                                                          
      ...
      CALL HIOCXX(W(1,5),W(1,57),GQLGOP,MCL,WCL,W(1,      
     &     61))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,61),GULNIM,AMP(39))         
      CALL HIOCXX(W(1,5),W(1,57),GQRGOP,MCR,WCR,W(1,      
     &     62))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,62),GURNIM,AMP(40))         
      CALL HIOCXX(W(1,5),W(1,58),GQLGOP,MCL,WCL,W(1,      
     &     63))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,63),GULNIM,AMP(41))         
      CALL HIOCXX(W(1,5),W(1,58),GQRGOP,MCR,WCR,W(1,      
     &     64))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,64),GURNIM,AMP(42))         
      CALL FSICXX(W(1,5),W(1,49),GQLGOP,MGO,WGO,W(1,      
     &     65))                                                          
      CALL HIOXXX(W(1,65),W(1,1),GQLGOP,MCL,WCL,W(1,66))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,66),GULNIM,AMP(43))         
      CALL HIOXXX(W(1,65),W(1,1),GQRGOP,MCR,WCR,W(1,67))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,67),GURNIM,AMP(44))         
      CALL FSICXX(W(1,5),W(1,52),GQRGOP,MGO,WGO,W(1,      
     &     68))                                                          
      CALL HIOXXX(W(1,68),W(1,1),GQLGOP,MCL,WCL,W(1,69))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,69),GULNIM,AMP(45))         
      CALL HIOXXX(W(1,68),W(1,1),GQRGOP,MCR,WCR,W(1,70))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,70),GURNIM,AMP(46))         
      CALL FSIXXX(W(1,2),W(1,13),GQLGOM,MGO,WGO,W(1,71))                                                          
      CALL HIOXXX(W(1,71),W(1,1),GQLGOP,MCL,WCL,W(1,72))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,72),GULNIM,AMP(47))         
      CALL HIOXXX(W(1,71),W(1,1),GQRGOP,MCR,WCR,W(1,73))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,73),GURNIM,AMP(48))         
      CALL FSIXXX(W(1,2),W(1,15),GQRGOM,MGO,WGO,W(1,74))                                                          
      CALL HIOXXX(W(1,74),W(1,1),GQLGOP,MCL,WCL,W(1,75))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,75),GULNIM,AMP(49))         
      CALL HIOXXX(W(1,74),W(1,1),GQRGOP,MCR,WCR,W(1,76))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,76),GURNIM,AMP(50))         
      CALL HVSXXX(W(1,31),W(1,13),GC,MCL,WCL,W(1,77))     
      CALL IOSXXX(W(1,6),W(1,3),W(1,77),GULNIM,AMP(51))         
      CALL HVSXXX(W(1,31),W(1,15),GC,MCR,WCR,W(1,78))     
      CALL IOSXXX(W(1,6),W(1,3),W(1,78),GURNIM,AMP(52))         
      CALL IOVXXX(W(1,6),W(1,19),W(1,31),GG,AMP(53))             
      CALL IOVXXX(W(1,6),W(1,21),W(1,31),GG,AMP(54))             
      CALL HIOCXX(W(1,36),W(1,4),GULNJP,MCL,WCL,W(1,      
     &     79))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,79),GULNIM,AMP(55))         
      CALL HIOCXX(W(1,36),W(1,4),GURNJP,MCR,WCR,W(1,      
     &     80))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,80),GURNIM,AMP(56))         
      CALL IXXXXX(P(0,4),MNJ,NHEL(4),-1*IC(4),W(1,81))         
      CALL OXXXXX(P(0,5),ZERO,NHEL(5),+1*IC(5),W(1,82))        
      CALL FSIXXX(W(1,81),W(1,7),GULNJP,ZERO,ZERO,W(1,83))                                                          
      CALL JIOXXX(W(1,83),W(1,1),GG,ZERO,ZERO,W(1,84))     
      CALL IOVXXX(W(1,6),W(1,82),W(1,84),GG,AMP(57))             
      CALL FSIXXX(W(1,81),W(1,10),GURNJP,ZERO,ZERO,W(1,85))                                                          
      CALL JIOXXX(W(1,85),W(1,1),GG,ZERO,ZERO,W(1,86))     
      CALL IOVXXX(W(1,6),W(1,82),W(1,86),GG,AMP(58))             
      CALL HIOXXX(W(1,81),W(1,1),GULNJP,MCL,WCL,W(1,87))                                                          
      CALL FSOXXX(W(1,3),W(1,87),GULNIM,ZERO,ZERO,W(1,88))                                                          
      CALL JIOXXX(W(1,2),W(1,88),GG,ZERO,ZERO,W(1,89))     
      CALL IOVXXX(W(1,6),W(1,82),W(1,89),GG,AMP(59))             
      CALL HIOXXX(W(1,81),W(1,1),GURNJP,MCR,WCR,W(1,90))                                                          
      CALL FSOXXX(W(1,3),W(1,90),GURNIM,ZERO,ZERO,W(1,91))                                                          
      ...
      CALL HVSXXX(W(1,97),W(1,87),GC,MCL,WCL,W(1,98))     
      CALL IOSXXX(W(1,6),W(1,3),W(1,98),GULNIM,AMP(67))         
      CALL HVSXXX(W(1,97),W(1,90),GC,MCR,WCR,W(1,99))     
      CALL IOSXXX(W(1,6),W(1,3),W(1,99),GURNIM,AMP(68))         
      ...
      CALL HIOXXX(W(1,100),W(1,82),GQLGOP,MCL,WCL,W(1,101))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,101),GULNIM,AMP(71))         
      CALL HIOXXX(W(1,100),W(1,82),GQRGOP,MCR,WCR,W(1,102))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,102),GURNIM,AMP(72))         
      CALL FSIXXX(W(1,2),W(1,90),GQRGOM,MGO,WGO,W(1,103))                                                          
      CALL HIOXXX(W(1,103),W(1,82),GQLGOP,MCL,WCL,W(1,104))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,104),GULNIM,AMP(73))         
      CALL HIOXXX(W(1,103),W(1,82),GQRGOP,MCR,WCR,W(1,105))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,105),GURNIM,AMP(74))         
      CALL FVOXXX(W(1,1),W(1,97),GG,ZERO,ZERO,W(1,106))     
      CALL HIOXXX(W(1,81),W(1,106),GULNJP,MCL,WCL,W(1,107))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,107),GULNIM,AMP(75))         
      CALL HIOXXX(W(1,81),W(1,106),GURNJP,MCR,WCR,W(1,108))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,108),GURNIM,AMP(76))         
      CALL JIOCXX(W(1,81),W(1,3),GZNIJ,ZMASS,ZWIDTH,W(1,109))                                                          
      CALL FVIXXX(W(1,2),W(1,109),GZU,ZERO,ZERO,W(1,110))    
      CALL JIOXXX(W(1,110),W(1,82),GG,ZERO,ZERO,W(1,111))     
      CALL IOVXXX(W(1,6),W(1,1),W(1,111),GG,AMP(77))             
      CALL IOVXXX(W(1,6),W(1,106),W(1,109),GZU,AMP(78))            
      CALL FVOXXX(W(1,1),W(1,109),GZU,ZERO,ZERO,W(1,112))    
      CALL IOVXXX(W(1,6),W(1,112),W(1,97),GG,AMP(79))             
      CALL FVOXXX(W(1,82),W(1,109),GZU,ZERO,ZERO,W(1,113))    
      ...
      CALL IOVXXX(W(1,6),W(1,117),W(1,109),GZU,AMP(84))            
      ...
      CALL FSIXXX(W(1,119),W(1,49),GULNIP,ZERO,ZERO,W(1,120))                                                          
      CALL JIOXXX(W(1,120),W(1,1),GG,ZERO,ZERO,W(1,121))     
      CALL IOVXXX(W(1,6),W(1,82),W(1,121),GG,AMP(93))             
      CALL FSIXXX(W(1,119),W(1,52),GURNIP,ZERO,ZERO,W(1,122))                                                          
      CALL JIOXXX(W(1,122),W(1,1),GG,ZERO,ZERO,W(1,123))     
      CALL IOVXXX(W(1,6),W(1,82),W(1,123),GG,AMP(94))             
      CALL HIOXXX(W(1,119),W(1,1),GULNIP,MCL,WCL,W(1,124))                                                          
      CALL FSOXXX(W(1,4),W(1,124),GULNJM,ZERO,ZERO,W(1,125))                                                          
      CALL JIOXXX(W(1,2),W(1,125),GG,ZERO,ZERO,W(1,126))     
      CALL IOVXXX(W(1,6),W(1,82),W(1,126),GG,AMP(95))             
      CALL HIOXXX(W(1,119),W(1,1),GURNIP,MCR,WCR,W(1,127))                                                          
      CALL FSOXXX(W(1,4),W(1,127),GURNJM,ZERO,ZERO,W(1,128))                                                          
      ...
      CALL HVSXXX(W(1,97),W(1,124),GC,MCL,WCL,W(1,134))     
      CALL IOSXXX(W(1,6),W(1,4),W(1,134),GULNJM,AMP(103))         
      CALL HVSXXX(W(1,97),W(1,127),GC,MCR,WCR,W(1,135))     
      CALL IOSXXX(W(1,6),W(1,4),W(1,135),GURNJM,AMP(104))         
      ...
      CALL HIOXXX(W(1,136),W(1,82),GQLGOP,MCL,WCL,W(1,137))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,137),GULNJM,AMP(107))         
      CALL HIOXXX(W(1,136),W(1,82),GQRGOP,MCR,WCR,W(1,138))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,138),GURNJM,AMP(108))         
      CALL FSIXXX(W(1,2),W(1,127),GQRGOM,MGO,WGO,W(1,139))                                                          
      CALL HIOXXX(W(1,139),W(1,82),GQLGOP,MCL,WCL,W(1,140))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,140),GULNJM,AMP(109))         
      CALL HIOXXX(W(1,139),W(1,82),GQRGOP,MCR,WCR,W(1,141))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,141),GURNJM,AMP(110))         
      CALL HIOXXX(W(1,119),W(1,106),GULNIP,MCL,WCL,W(1,142))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,142),GULNJM,AMP(111))         
      CALL HIOXXX(W(1,119),W(1,106),GURNIP,MCR,WCR,W(1,143))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,143),GURNJM,AMP(112))         
     ...
     &             +AMP( 110)-AMP( 117)-AMP( 118)-AMP( 119)-AMP( 120)
      MATRIX_CXC_NINJCCX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_CXC_NINJCCX =MATRIX_CXC_NINJCCX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
