      SUBROUTINE SMATRIX_SXS_NINJGG(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_sxs_nInJgg/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_SXS_NINJGG(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_SXS_NINJGG(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,4),W(1,13),GDLNJP,MSL,WSL,W(1,14))                                                          
      CALL FSOXXX(W(1,3),W(1,14),GDLNIM,ZERO,ZERO,W(1,15))                                                          
      CALL IOVXXX(W(1,2),W(1,15),W(1,6),GG,AMP(3))             
      CALL HIOXXX(W(1,4),W(1,13),GDRNJP,MSR,WSR,W(1,16))                                                          
      ...
      CALL HIOXXX(W(1,20),W(1,3),GDRNIM,MSR,WSR,W(1,23))                                                          
      CALL FSIXXX(W(1,4),W(1,23),GDRNJP,ZERO,ZERO,W(1,24))                                                          
      CALL IOVXXX(W(1,24),W(1,1),W(1,6),GG,AMP(12))             
      CALL HIOXXX(W(1,4),W(1,1),GDLNJP,MSL,WSL,W(1,25))                                                          
      ...
      CALL HIOXXX(W(1,4),W(1,1),GDRNJP,MSR,WSR,W(1,28))                                                          
      ...
      CALL HIOXXX(W(1,2),W(1,53),GDLNJM,MSL,WSL,W(1,54))                                                          
      ...
      CALL HIOXXX(W(1,2),W(1,53),GDRNJM,MSR,WSR,W(1,57))                                                          
      ...
      CALL HIOXXX(W(1,52),W(1,13),GDLNIP,MSL,WSL,W(1,60))                                                          
      CALL FSOXXX(W(1,53),W(1,60),GDLNJM,ZERO,ZERO,W(1,61))                                                          
      CALL IOVXXX(W(1,2),W(1,61),W(1,6),GG,AMP(43))             
      CALL HIOXXX(W(1,52),W(1,13),GDRNIP,MSR,WSR,W(1,62))                                                          
      ...
      CALL HIOXXX(W(1,52),W(1,1),GDRNIP,MSR,WSR,W(1,73))                                                          
     ...
     &             -AMP(  66)+AMP(  67)+AMP(  68)+AMP(  71)+AMP(  72)
      MATRIX_SXS_NINJGG = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_SXS_NINJGG =MATRIX_SXS_NINJGG+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
