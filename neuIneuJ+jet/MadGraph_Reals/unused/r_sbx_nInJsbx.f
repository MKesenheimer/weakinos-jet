      SUBROUTINE SMATRIX_SBX_NINJSBX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_sbx_nInJsbx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_SBX_NINJSBX(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_SBX_NINJSBX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     21))                                                          
      ...
      CALL HIOXXX(W(1,22),W(1,2),GB1GOP,MBL,WB1,W(1,23))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,23),GB1N1M,AMP(7))         
      CALL HIOXXX(W(1,22),W(1,2),GB2GOP,MBR,WB2,W(1,24))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,24),GB2N1M,AMP(8))         
     ...
     &     32))                                                          
      CALL HIOXXX(W(1,32),W(1,2),GB1GOP,MBL,WB1,W(1,33))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,33),GB1N1M,AMP(13))         
      CALL HIOXXX(W(1,32),W(1,2),GB2GOP,MBR,WB2,W(1,34))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,34),GB2N1M,AMP(14))         
      CALL HIOXXX(W(1,1),W(1,3),GDLNIM,MSL,WSL,W(1,35))                                                          
     ...
     &     36))                                                          
      ...
      CALL HIOXXX(W(1,1),W(1,3),GDRNIM,MSR,WSR,W(1,38))                                                          
     ...
     &     39))                                                          
      ...
      CALL HIOXXX(W(1,47),W(1,2),GB1GOP,MBL,WB1,W(1,48))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,48),GB1N2M,AMP(21))         
      CALL HIOXXX(W(1,47),W(1,2),GB2GOP,MBR,WB2,W(1,49))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,49),GB2N2M,AMP(22))         
      CALL FSIXXX(W(1,1),W(1,15),GQRGOM,MGO,WGO,W(1,50))                                                          
      CALL HIOXXX(W(1,50),W(1,2),GB1GOP,MBL,WB1,W(1,51))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,51),GB1N2M,AMP(23))         
      CALL HIOXXX(W(1,50),W(1,2),GB2GOP,MBR,WB2,W(1,52))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,52),GB2N2M,AMP(24))         
      CALL FSICXX(W(1,5),W(1,35),GQLGOP,MGO,WGO,W(1,      
     &     53))                                                          
      CALL HIOXXX(W(1,53),W(1,2),GB1GOP,MBL,WB1,W(1,54))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,54),GB1N2M,AMP(25))         
      CALL HIOXXX(W(1,53),W(1,2),GB2GOP,MBR,WB2,W(1,55))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,55),GB2N2M,AMP(26))         
      CALL FSICXX(W(1,5),W(1,38),GQRGOP,MGO,WGO,W(1,      
     &     56))                                                          
      CALL HIOXXX(W(1,56),W(1,2),GB1GOP,MBL,WB1,W(1,57))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,57),GB1N2M,AMP(27))         
      CALL HIOXXX(W(1,56),W(1,2),GB2GOP,MBR,WB2,W(1,58))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,58),GB2N2M,AMP(28))         
      CALL IXXXXX(P(0,4),MNJ,NHEL(4),-1*IC(4),W(1,59))         
      CALL OXXXXX(P(0,5),ZERO,NHEL(5),+1*IC(5),W(1,60))        
      CALL HIOXXX(W(1,59),W(1,2),GB1N2P,MBL,WB1,W(1,61))                                                          
      ...
      CALL HIOXXX(W(1,59),W(1,2),GB2N2P,MBR,WB2,W(1,64))                                                          
     ...
     &     76))                                                          
      ...
      CALL FVIXXX(W(1,1),W(1,73),GZD,ZERO,ZERO,W(1,81))    
      ...
      CALL HIOXXX(W(1,86),W(1,2),GB1N1P,MBL,WB1,W(1,87))                                                          
      CALL HVSXXX(W(1,62),W(1,87),GC,MBL,WB1,W(1,88))     
      CALL IOSXXX(W(1,6),W(1,4),W(1,88),GB1N2M,AMP(53))         
      CALL HIOXXX(W(1,86),W(1,2),GB2N1P,MBR,WB2,W(1,89))                                                          
     ...
     &             +AMP(  66)
      MATRIX_SBX_NINJSBX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_SBX_NINJSBX =MATRIX_SBX_NINJSBX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
