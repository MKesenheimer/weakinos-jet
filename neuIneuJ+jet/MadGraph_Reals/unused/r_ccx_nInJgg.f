      SUBROUTINE SMATRIX_CCX_NINJGG(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_ccx_nInJgg/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_CCX_NINJGG(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_CCX_NINJGG(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,4),W(1,20),GULNJP,MCL,WCL,W(1,21))                                                          
      CALL FSOXXX(W(1,3),W(1,21),GULNIM,ZERO,ZERO,W(1,22))                                                          
      CALL IOVXXX(W(1,1),W(1,22),W(1,6),GG,AMP(11))             
      CALL HIOXXX(W(1,4),W(1,20),GURNJP,MCR,WCR,W(1,23))                                                          
      CALL FSOXXX(W(1,3),W(1,23),GURNIM,ZERO,ZERO,W(1,24))                                                          
      CALL IOVXXX(W(1,1),W(1,24),W(1,6),GG,AMP(12))             
      CALL HIOXXX(W(1,1),W(1,3),GULNIM,MCL,WCL,W(1,25))                                                          
      CALL FSIXXX(W(1,4),W(1,25),GULNJP,ZERO,ZERO,W(1,26))                                                          
      CALL FVIXXX(W(1,26),W(1,5),GG,ZERO,ZERO,W(1,27))     
      CALL IOVXXX(W(1,27),W(1,2),W(1,6),GG,AMP(13))             
      CALL HIOXXX(W(1,1),W(1,3),GURNIM,MCR,WCR,W(1,28))                                                          
      CALL FSIXXX(W(1,4),W(1,28),GURNJP,ZERO,ZERO,W(1,29))                                                          
      ...
      CALL FVOXXX(W(1,20),W(1,43),GZU,ZERO,ZERO,W(1,48))    
      CALL IOVXXX(W(1,1),W(1,48),W(1,6),GG,AMP(37))             
      CALL FVIXXX(W(1,1),W(1,43),GZU,ZERO,ZERO,W(1,49))    
      ...
      CALL HIOXXX(W(1,52),W(1,20),GULNIP,MCL,WCL,W(1,66))                                                          
      CALL FSOXXX(W(1,53),W(1,66),GULNJM,ZERO,ZERO,W(1,67))                                                          
      CALL IOVXXX(W(1,1),W(1,67),W(1,6),GG,AMP(51))             
      CALL HIOXXX(W(1,52),W(1,20),GURNIP,MCR,WCR,W(1,68))                                                          
      CALL FSOXXX(W(1,53),W(1,68),GURNJM,ZERO,ZERO,W(1,69))                                                          
      CALL IOVXXX(W(1,1),W(1,69),W(1,6),GG,AMP(52))             
      CALL HIOXXX(W(1,1),W(1,53),GULNJM,MCL,WCL,W(1,70))                                                          
      ...
      CALL HIOXXX(W(1,1),W(1,53),GURNJM,MCR,WCR,W(1,73))                                                          
      CALL FSIXXX(W(1,52),W(1,73),GURNIP,ZERO,ZERO,W(1,74))                                                          
     ...
     &             -AMP(  66)-AMP(  67)-AMP(  68)-AMP(  69)-AMP(  70)
      MATRIX_CCX_NINJGG = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_CCX_NINJGG =MATRIX_CCX_NINJGG+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
