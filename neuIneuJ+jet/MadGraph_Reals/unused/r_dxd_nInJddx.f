...
C ----------
     ...
     &     27))                                                          
      ...
      CALL HIOCXX(W(1,36),W(1,3),GDLNIP,MDL,WDL,W(1,      
     &     37))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,37),GDLNJM,AMP(19))         
      CALL HIOCXX(W(1,36),W(1,3),GDRNIP,MDR,WDR,W(1,      
     &     38))                                                          
     ...
     &     68))                                                          
      ...
      CALL HIOCXX(W(1,36),W(1,4),GDLNJP,MDL,WDL,W(1,      
     &     79))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,79),GDLNIM,AMP(55))         
      CALL HIOCXX(W(1,36),W(1,4),GDRNJP,MDR,WDR,W(1,      
     &     80))                                                          
