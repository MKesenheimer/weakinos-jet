      SUBROUTINE SMATRIX_UBX_NINJUBX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_ubx_nInJubx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_UBX_NINJUBX(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_UBX_NINJUBX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     32))                                                          
      ...
      CALL HIOXXX(W(1,1),W(1,3),GULNIM,MUL,WUL,W(1,35))                                                          
      CALL FSOCXX(W(1,4),W(1,35),GULNJP,ZERO,ZERO,W(1,      
     &     36))                                                          
      CALL JIOCXX(W(1,5),W(1,36),GG,ZERO,ZERO,W(1,37))    
      CALL IOVXXX(W(1,6),W(1,2),W(1,37),GG,AMP(15))             
      CALL HIOXXX(W(1,1),W(1,3),GURNIM,MUR,WUR,W(1,38))                                                          
      CALL FSOCXX(W(1,4),W(1,38),GURNJP,ZERO,ZERO,W(1,      
     &     39))                                                          
     ...
     &             +AMP(  66)
      MATRIX_UBX_NINJUBX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_UBX_NINJUBX =MATRIX_UBX_NINJUBX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
