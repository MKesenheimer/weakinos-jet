      SUBROUTINE SMATRIX_UXU_NINJUUX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_uxu_nInJuux/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_UXU_NINJUUX(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_UXU_NINJUUX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     23))                                                          
      ...
      CALL HIOXXX(W(1,24),W(1,1),GQLGOP,MUL,WUL,W(1,25))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,25),GULNJM,AMP(11))         
      CALL HIOXXX(W(1,24),W(1,1),GQRGOP,MUR,WUR,W(1,26))                                                          
     ...
     &     27))                                                          
      ...
      CALL HVSXXX(W(1,31),W(1,23),GC,MUL,WUL,W(1,32))     
      CALL IOSXXX(W(1,6),W(1,4),W(1,32),GULNJM,AMP(15))         
      CALL HVSXXX(W(1,31),W(1,27),GC,MUR,WUR,W(1,33))     
     ...
     &     50))                                                          
      ...
      CALL HIOXXX(W(1,2),W(1,4),GURNJM,MUR,WUR,W(1,52))                                                          
     ...
     &     68))                                                          
      ...
      CALL HIOCXX(W(1,36),W(1,4),GULNJP,MUL,WUL,W(1,      
     &     79))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,79),GULNIM,AMP(55))         
      CALL HIOCXX(W(1,36),W(1,4),GURNJP,MUR,WUR,W(1,      
     &     80))                                                          
      ...
      CALL HIOXXX(W(1,81),W(1,1),GULNJP,MUL,WUL,W(1,87))                                                          
      ...
      CALL HIOXXX(W(1,81),W(1,1),GURNJP,MUR,WUR,W(1,90))                                                          
      ...
      CALL HVSXXX(W(1,97),W(1,87),GC,MUL,WUL,W(1,98))     
      CALL IOSXXX(W(1,6),W(1,3),W(1,98),GULNIM,AMP(67))         
      CALL HVSXXX(W(1,97),W(1,90),GC,MUR,WUR,W(1,99))     
      ...
      CALL HIOXXX(W(1,119),W(1,1),GULNIP,MUL,WUL,W(1,124))                                                          
      ...
      CALL HIOXXX(W(1,119),W(1,1),GURNIP,MUR,WUR,W(1,127))                                                          
      ...
      CALL HVSXXX(W(1,97),W(1,124),GC,MUL,WUL,W(1,134))     
      CALL IOSXXX(W(1,6),W(1,4),W(1,134),GULNJM,AMP(103))         
      CALL HVSXXX(W(1,97),W(1,127),GC,MUR,WUR,W(1,135))     
      ...
      CALL HIOXXX(W(1,136),W(1,82),GQLGOP,MUL,WUL,W(1,137))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,137),GULNJM,AMP(107))         
      CALL HIOXXX(W(1,136),W(1,82),GQRGOP,MUR,WUR,W(1,138))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,138),GURNJM,AMP(108))         
      CALL FSIXXX(W(1,2),W(1,127),GQRGOM,MGO,WGO,W(1,139))                                                          
      CALL HIOXXX(W(1,139),W(1,82),GQLGOP,MUL,WUL,W(1,140))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,140),GULNJM,AMP(109))         
      CALL HIOXXX(W(1,139),W(1,82),GQRGOP,MUR,WUR,W(1,141))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,141),GURNJM,AMP(110))         
      CALL HIOXXX(W(1,119),W(1,106),GULNIP,MUL,WUL,W(1,142))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,142),GULNJM,AMP(111))         
      CALL HIOXXX(W(1,119),W(1,106),GURNIP,MUR,WUR,W(1,143))                                                          
     ...
     &             +AMP( 110)-AMP( 117)-AMP( 118)-AMP( 119)-AMP( 120)
      MATRIX_UXU_NINJUUX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_UXU_NINJUUX =MATRIX_UXU_NINJUUX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
