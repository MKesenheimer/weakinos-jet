...
C ----------
      ...
      CALL HIOXXX(W(1,1),W(1,3),GULNIM,MUL,WUL,W(1,9))                                                          
      CALL FSIXXX(W(1,4),W(1,9),GULNJP,ZERO,ZERO,W(1,10))                                                          
      CALL IOVXXX(W(1,10),W(1,2),W(1,5),GG,AMP(3))             
      CALL HIOXXX(W(1,1),W(1,3),GURNIM,MUR,WUR,W(1,11))                                                          
      CALL FSIXXX(W(1,4),W(1,11),GURNJP,ZERO,ZERO,W(1,12))                                                          
      ...
      CALL HIOXXX(W(1,1),W(1,16),GULNJM,MUL,WUL,W(1,21))                                                          
      CALL IOSXXX(W(1,15),W(1,14),W(1,21),GULNIP,AMP(11))         
      CALL HIOXXX(W(1,1),W(1,16),GURNJM,MUR,WUR,W(1,22))                                                          
      CALL IOSXXX(W(1,15),W(1,14),W(1,22),GURNIP,AMP(12))         
