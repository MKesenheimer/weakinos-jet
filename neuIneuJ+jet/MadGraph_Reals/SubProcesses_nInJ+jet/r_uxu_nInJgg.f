      SUBROUTINE SMATRIX_UXU_NINJGG(P1,ANS)
C  
...
C  
C FOR PROCESS : u~ u -> n1 n2 g g  
C  
C Crossing   1 is u~ u -> n1 n2 g g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_Ramps_uxu_nInJgg/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_UXU_NINJGG(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_UXU_NINJGG(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,4),W(1,13),GULNJP,MUL,WUL,W(1,14))                                                          
      CALL FSOXXX(W(1,3),W(1,14),GULNIM,ZERO,ZERO,W(1,15))                                                          
      CALL IOVXXX(W(1,2),W(1,15),W(1,6),GG,AMP(3))             
      CALL HIOXXX(W(1,4),W(1,13),GURNJP,MUR,WUR,W(1,16))                                                          
      ...
      CALL HIOXXX(W(1,20),W(1,3),GURNIM,MUR,WUR,W(1,23))                                                          
      CALL FSIXXX(W(1,4),W(1,23),GURNJP,ZERO,ZERO,W(1,24))                                                          
      CALL IOVXXX(W(1,24),W(1,1),W(1,6),GG,AMP(12))             
      CALL HIOXXX(W(1,4),W(1,1),GULNJP,MUL,WUL,W(1,25))                                                          
      ...
      CALL HIOXXX(W(1,4),W(1,1),GURNJP,MUR,WUR,W(1,28))                                                          
      ...
      CALL HIOXXX(W(1,2),W(1,53),GULNJM,MUL,WUL,W(1,54))                                                          
      ...
      CALL HIOXXX(W(1,2),W(1,53),GURNJM,MUR,WUR,W(1,57))                                                          
      ...
      CALL HIOXXX(W(1,52),W(1,13),GULNIP,MUL,WUL,W(1,60))                                                          
      CALL FSOXXX(W(1,53),W(1,60),GULNJM,ZERO,ZERO,W(1,61))                                                          
      CALL IOVXXX(W(1,2),W(1,61),W(1,6),GG,AMP(43))             
      CALL HIOXXX(W(1,52),W(1,13),GURNIP,MUR,WUR,W(1,62))                                                          
      ...
      CALL HIOXXX(W(1,52),W(1,1),GURNIP,MUR,WUR,W(1,73))                                                          
     ...
     &             -AMP(  66)+AMP(  67)+AMP(  68)+AMP(  71)+AMP(  72)
      MATRIX_UXU_NINJGG = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_UXU_NINJGG =MATRIX_UXU_NINJGG+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
