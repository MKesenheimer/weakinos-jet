      SUBROUTINE SB_CL_003_003(P1,ANS)
C  
...
C          write(*,*) "momenta not the same in Born"
     ...
     &       nhel(5,ihel).eq.-1) THEN
                 T=B_CL_003_003(P1,NHEL(1,IHEL),IHEL,JC(1),T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_003_003(P,NHEL,HELL,IC,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,4),W(1,2),GDLN1P,MDL,WDL,W(1,       
     &     6))                                                          
      CALL FVIXXX(W(1,1),W(1,5),GG,ZERO,ZERO,W(1,7))     
      CALL IOSXXX(W(1,7),W(1,3),W(1,6),GDLN1M,AMP(1))         
      CALL HIOXXX(W(1,4),W(1,2),GDRN1P,MDR,WDR,W(1,       
     &     8))                                                          
     ...
     &             -AMP(  11)-AMP(  12)-AMP(  13)-AMP(  14)
      DO I = 1, NCOLOR
          ...
          if(ihel.eq.-1) then
             B_CL_003_003=B_CL_003_003 +RTEMP
          elseif(ihel.eq.1) then
             B_CL_003_003=B_CL_003_003 +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
