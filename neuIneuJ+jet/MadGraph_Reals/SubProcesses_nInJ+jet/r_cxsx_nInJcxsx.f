      SUBROUTINE SMATRIX_CXSX_NINJCXSX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_cxsx_nInJcxsx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_CXSX_NINJCXSX(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_CXSX_NINJCXSX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,5),W(1,46),GULNJM,MCL,WCL,W(1,55))                                                          
      CALL FSOXXX(W(1,1),W(1,55),GQLGOP,MGO,WGO,W(1,56))                                                          
      CALL IOSXXX(W(1,6),W(1,56),W(1,47),GQLGOM,AMP(31))         
      CALL HIOXXX(W(1,5),W(1,46),GURNJM,MCR,WCR,W(1,57))                                                          
      ...
      CALL HIOXXX(W(1,45),W(1,1),GULNIP,MCL,WCL,W(1,59))                                                          
      ...
      CALL HIOXXX(W(1,45),W(1,1),GURNIP,MCR,WCR,W(1,62))                                                          
     ...
     &             -AMP(  56)+AMP(  57)+AMP(  58)+AMP(  59)+AMP(  60)
      MATRIX_CXSX_NINJCXSX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_CXSX_NINJCXSX =MATRIX_CXSX_NINJCXSX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
