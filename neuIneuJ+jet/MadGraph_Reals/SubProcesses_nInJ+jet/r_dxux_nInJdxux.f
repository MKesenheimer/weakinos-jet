...
C ----------
      ...
      CALL HIOCXX(W(1,78),W(1,56),GQLGOP,MUL,WUL,W(1,      
     &     79))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,79),GULNIM,AMP(53))         
      CALL HIOCXX(W(1,78),W(1,56),GQRGOP,MUR,WUR,W(1,      
     &     80))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,80),GURNIM,AMP(54))         
      CALL HIOCXX(W(1,78),W(1,58),GQLGOP,MUL,WUL,W(1,      
     &     81))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,81),GULNIM,AMP(55))         
      CALL HIOCXX(W(1,78),W(1,58),GQRGOP,MUR,WUR,W(1,      
     &     82))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,82),GURNIM,AMP(56))         
      CALL HIOCXX(W(1,78),W(1,37),GQLGOP,MUL,WUL,W(1,      
     &     83))                                                          
      CALL IOSXXX(W(1,6),W(1,46),W(1,83),GULNJM,AMP(57))         
      CALL HIOCXX(W(1,78),W(1,37),GQRGOP,MUR,WUR,W(1,      
     &     84))                                                          
      CALL IOSXXX(W(1,6),W(1,46),W(1,84),GURNJM,AMP(58))         
      CALL HIOCXX(W(1,78),W(1,38),GQLGOP,MUL,WUL,W(1,      
     &     85))                                                          
      CALL IOSXXX(W(1,6),W(1,46),W(1,85),GULNJM,AMP(59))         
      CALL HIOCXX(W(1,78),W(1,38),GQRGOP,MUR,WUR,W(1,      
     &     86))                                                          
