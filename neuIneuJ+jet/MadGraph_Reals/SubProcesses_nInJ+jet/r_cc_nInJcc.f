      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_CC_NINJCC(P,NHEL(1,IHEL),JC(1))            
...
C ----------
     ...
     &     13))                                                          
      ...
      CALL FSOCXX(W(1,3),W(1,23),GULNIP,ZERO,ZERO,W(1,      
     &     28))                                                          
      CALL IOVCXX(W(1,6),W(1,28),W(1,24),GG,AMP(13))            
      CALL FSOCXX(W(1,3),W(1,26),GURNIP,ZERO,ZERO,W(1,      
     &     29))                                                          
      ...
      CALL FSOCXX(W(1,3),W(1,39),GULNIP,ZERO,ZERO,W(1,      
     &     43))                                                          
      CALL IOVCXX(W(1,6),W(1,43),W(1,8),GG,AMP(31))            
      CALL FSOCXX(W(1,3),W(1,41),GURNIP,ZERO,ZERO,W(1,      
     &     44))                                                          
      ...
      CALL FSOCXX(W(1,4),W(1,53),GULNJP,ZERO,ZERO,W(1,      
     &     57))                                                          
      CALL IOVCXX(W(1,6),W(1,57),W(1,24),GG,AMP(41))            
      CALL FSOCXX(W(1,4),W(1,55),GURNJP,ZERO,ZERO,W(1,      
     &     58))                                                          
      ...
      CALL HIOCXX(W(1,67),W(1,4),GULNJP,MCL,WCL,W(1,      
     &     71))                                                          
      CALL JSSXXX(W(1,71),W(1,7),GC,ZERO,ZERO,W(1,72))     
      CALL IOVXXX(W(1,1),W(1,68),W(1,72),GG,AMP(59))             
      CALL HIOCXX(W(1,67),W(1,4),GURNJP,MCR,WCR,W(1,      
     &     73))                                                          
      ...
      CALL HIOCXX(W(1,67),W(1,3),GULNIP,MCL,WCL,W(1,      
     &     83))                                                          
      CALL JSSXXX(W(1,83),W(1,23),GC,ZERO,ZERO,W(1,84))     
      CALL IOVXXX(W(1,2),W(1,68),W(1,84),GG,AMP(69))             
      CALL HIOCXX(W(1,67),W(1,3),GURNIP,MCR,WCR,W(1,      
     &     85))                                                          
      ...
      CALL FSOCXX(W(1,118),W(1,83),GQLGOM,MGO,WGO,W(1,      
     &     119))                                                          
      ...
      CALL FSOCXX(W(1,118),W(1,85),GQRGOM,MGO,WGO,W(1,      
     &     122))                                                          
      ...
      CALL HIOCXX(W(1,97),W(1,118),GQLGOM,MCL,WCL,W(1,      
     &     125))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,125),GULNJP,AMP(109))        
      CALL HIOCXX(W(1,97),W(1,118),GQRGOM,MCR,WCR,W(1,      
     &     126))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,126),GURNJP,AMP(110))        
      CALL HIOCXX(W(1,98),W(1,118),GQLGOM,MCL,WCL,W(1,      
     &     127))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,127),GULNJP,AMP(111))        
      CALL HIOCXX(W(1,98),W(1,118),GQRGOM,MCR,WCR,W(1,      
     &     128))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,128),GURNJP,AMP(112))        
      CALL HIOCXX(W(1,75),W(1,118),GQLGOM,MCL,WCL,W(1,      
     &     129))                                                          
      CALL IOSCXX(W(1,6),W(1,3),W(1,129),GULNIP,AMP(113))        
      CALL HIOCXX(W(1,75),W(1,118),GQRGOM,MCR,WCR,W(1,      
     &     130))                                                          
      CALL IOSCXX(W(1,6),W(1,3),W(1,130),GURNIP,AMP(114))        
      CALL HIOCXX(W(1,76),W(1,118),GQLGOM,MCL,WCL,W(1,      
     &     131))                                                          
      CALL IOSCXX(W(1,6),W(1,3),W(1,131),GULNIP,AMP(115))        
      CALL HIOCXX(W(1,76),W(1,118),GQRGOM,MCR,WCR,W(1,      
     &     132))                                                          
      CALL IOSCXX(W(1,6),W(1,3),W(1,132),GURNIP,AMP(116))        
      CALL FSOCXX(W(1,118),W(1,71),GQLGOM,MGO,WGO,W(1,      
     &     133))                                                          
      ...
      CALL FSOCXX(W(1,118),W(1,73),GQRGOM,MGO,WGO,W(1,      
     &     136))                                                          
