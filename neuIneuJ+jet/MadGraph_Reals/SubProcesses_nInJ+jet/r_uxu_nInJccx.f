      SUBROUTINE SMATRIX_UXU_NINJCCX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_uxu_nInJccx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_UXU_NINJCCX(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_UXU_NINJCCX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     40))                                                          
      ...
      CALL HIOXXX(W(1,69),W(1,1),GULNIP,MUL,WUL,W(1,74))                                                          
      ...
      CALL HIOXXX(W(1,69),W(1,1),GURNIP,MUR,WUR,W(1,77))                                                          
     ...
     &             +AMP(  56)-AMP(  57)-AMP(  58)-AMP(  59)-AMP(  60)
      MATRIX_UXU_NINJCCX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_UXU_NINJCCX =MATRIX_UXU_NINJCCX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
