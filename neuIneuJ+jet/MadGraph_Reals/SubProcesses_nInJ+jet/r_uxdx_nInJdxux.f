      SUBROUTINE SMATRIX_UXDX_NINJDXUX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_uxdx_nInJdxux/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_UXDX_NINJDXUX(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_UXDX_NINJDXUX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,4),W(1,14),GULNJP,MUL,WUL,W(1,15))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,15),GULNIM,AMP(5))         
      CALL HIOXXX(W(1,4),W(1,14),GURNJP,MUR,WUR,W(1,16))                                                          
      ...
      CALL HIOXXX(W(1,33),W(1,1),GQRGOP,MUR,WUR,W(1,35))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,35),GURNIM,AMP(18))         
      CALL FSIXXX(W(1,5),W(1,24),GQRGOM,MGO,WGO,W(1,36))                                                          
      CALL HIOXXX(W(1,36),W(1,1),GQLGOP,MUL,WUL,W(1,37))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,37),GULNIM,AMP(19))         
      CALL HIOXXX(W(1,36),W(1,1),GQRGOP,MUR,WUR,W(1,38))                                                          
      ...
      CALL HIOXXX(W(1,61),W(1,1),GQLGOP,MUL,WUL,W(1,62))                                                          
      CALL IOSXXX(W(1,6),W(1,46),W(1,62),GULNJM,AMP(31))         
      CALL HIOXXX(W(1,61),W(1,1),GQRGOP,MUR,WUR,W(1,63))                                                          
      CALL IOSXXX(W(1,6),W(1,46),W(1,63),GURNJM,AMP(32))         
      CALL FSIXXX(W(1,5),W(1,50),GQRGOM,MGO,WGO,W(1,64))                                                          
      CALL HIOXXX(W(1,64),W(1,1),GQLGOP,MUL,WUL,W(1,65))                                                          
      CALL IOSXXX(W(1,6),W(1,46),W(1,65),GULNJM,AMP(33))         
      CALL HIOXXX(W(1,64),W(1,1),GQRGOP,MUR,WUR,W(1,66))                                                          
      CALL IOSXXX(W(1,6),W(1,46),W(1,66),GURNJM,AMP(34))         
      CALL HIOXXX(W(1,45),W(1,1),GULNIP,MUL,WUL,W(1,67))                                                          
      CALL HVSXXX(W(1,8),W(1,67),GC,MUL,WUL,W(1,68))     
      CALL IOSXXX(W(1,6),W(1,46),W(1,68),GULNJM,AMP(35))         
      CALL HIOXXX(W(1,45),W(1,1),GURNIP,MUR,WUR,W(1,69))                                                          
      CALL HVSXXX(W(1,8),W(1,69),GC,MUR,WUR,W(1,70))     
      ...
      CALL HIOXXX(W(1,45),W(1,14),GULNIP,MUL,WUL,W(1,73))                                                          
      CALL IOSXXX(W(1,6),W(1,46),W(1,73),GULNJM,AMP(39))         
      CALL HIOXXX(W(1,45),W(1,14),GURNIP,MUR,WUR,W(1,74))                                                          
      ...
      CALL FSICXX(W(1,78),W(1,17),GQLGOP,MGO,WGO,W(1,      
     &     79))                                                          
      CALL HIOXXX(W(1,79),W(1,1),GQLGOP,MUL,WUL,W(1,80))                                                          
      CALL IOSXXX(W(1,6),W(1,46),W(1,80),GULNJM,AMP(53))         
      CALL HIOXXX(W(1,79),W(1,1),GQRGOP,MUR,WUR,W(1,81))                                                          
      CALL IOSXXX(W(1,6),W(1,46),W(1,81),GURNJM,AMP(54))         
      CALL FSICXX(W(1,78),W(1,19),GQRGOP,MGO,WGO,W(1,      
     &     82))                                                          
      CALL HIOXXX(W(1,82),W(1,1),GQLGOP,MUL,WUL,W(1,83))                                                          
      CALL IOSXXX(W(1,6),W(1,46),W(1,83),GULNJM,AMP(55))         
      CALL HIOXXX(W(1,82),W(1,1),GQRGOP,MUR,WUR,W(1,84))                                                          
      CALL IOSXXX(W(1,6),W(1,46),W(1,84),GURNJM,AMP(56))         
      CALL FSICXX(W(1,78),W(1,53),GQLGOP,MGO,WGO,W(1,      
     &     85))                                                          
      CALL HIOXXX(W(1,85),W(1,1),GQLGOP,MUL,WUL,W(1,86))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,86),GULNIM,AMP(57))         
      CALL HIOXXX(W(1,85),W(1,1),GQRGOP,MUR,WUR,W(1,87))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,87),GURNIM,AMP(58))         
      CALL FSICXX(W(1,78),W(1,55),GQRGOP,MGO,WGO,W(1,      
     &     88))                                                          
      CALL HIOXXX(W(1,88),W(1,1),GQLGOP,MUL,WUL,W(1,89))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,89),GULNIM,AMP(59))         
      CALL HIOXXX(W(1,88),W(1,1),GQRGOP,MUR,WUR,W(1,90))                                                          
     ...
     &             +AMP(  56)-AMP(  57)-AMP(  58)-AMP(  59)-AMP(  60)
      MATRIX_UXDX_NINJDXUX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_UXDX_NINJDXUX =MATRIX_UXDX_NINJDXUX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
