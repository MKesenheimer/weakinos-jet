      SUBROUTINE SMATRIX_CXC_NINJGG(P1,ANS)
C  
...
C  
C FOR PROCESS : c~ c -> n1 n2 g g  
C  
C Crossing   1 is c~ c -> n1 n2 g g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_Ramps_cxc_nInJgg/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_CXC_NINJGG(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_CXC_NINJGG(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FSIXXX(W(1,4),W(1,7),GULNJP,ZERO,ZERO,W(1,8))                                                          
      ...
      CALL HIOXXX(W(1,4),W(1,13),GULNJP,MCL,WCL,W(1,14))                                                          
      CALL FSOXXX(W(1,3),W(1,14),GULNIM,ZERO,ZERO,W(1,15))                                                          
      CALL IOVXXX(W(1,2),W(1,15),W(1,6),GG,AMP(3))             
      CALL HIOXXX(W(1,4),W(1,13),GURNJP,MCR,WCR,W(1,16))                                                          
      ...
      CALL HIOXXX(W(1,20),W(1,3),GURNIM,MCR,WCR,W(1,23))                                                          
      CALL FSIXXX(W(1,4),W(1,23),GURNJP,ZERO,ZERO,W(1,24))                                                          
      CALL IOVXXX(W(1,24),W(1,1),W(1,6),GG,AMP(12))             
      CALL HIOXXX(W(1,4),W(1,1),GULNJP,MCL,WCL,W(1,25))                                                          
      CALL FSOXXX(W(1,3),W(1,25),GULNIM,ZERO,ZERO,W(1,26))                                                          
      CALL FVOXXX(W(1,26),W(1,5),GG,ZERO,ZERO,W(1,27))     
      CALL IOVXXX(W(1,2),W(1,27),W(1,6),GG,AMP(13))             
      CALL HIOXXX(W(1,4),W(1,1),GURNJP,MCR,WCR,W(1,28))                                                          
      CALL FSOXXX(W(1,3),W(1,28),GURNIM,ZERO,ZERO,W(1,29))                                                          
      ...
      CALL HVSXXX(W(1,5),W(1,7),-GC,MCL,WCL,W(1,33))    
      CALL FSIXXX(W(1,4),W(1,33),GULNJP,ZERO,ZERO,W(1,34))                                                          
      CALL IOVXXX(W(1,34),W(1,1),W(1,6),GG,AMP(21))             
      CALL HVSXXX(W(1,5),W(1,10),-GC,MCR,WCR,W(1,35))    
      CALL FSIXXX(W(1,4),W(1,35),GURNJP,ZERO,ZERO,W(1,36))                                                          
      CALL IOVXXX(W(1,36),W(1,1),W(1,6),GG,AMP(22))             
      CALL HVSXXX(W(1,5),W(1,25),GC,MCL,WCL,W(1,37))     
      CALL FSOXXX(W(1,3),W(1,37),GULNIM,ZERO,ZERO,W(1,38))                                                          
      CALL IOVXXX(W(1,2),W(1,38),W(1,6),GG,AMP(23))             
      CALL HVSXXX(W(1,5),W(1,28),GC,MCR,WCR,W(1,39))     
      CALL FSOXXX(W(1,3),W(1,39),GURNIM,ZERO,ZERO,W(1,40))                                                          
      ...
      CALL FVIXXX(W(1,2),W(1,43),GZU,ZERO,ZERO,W(1,44))    
      CALL FVIXXX(W(1,44),W(1,5),GG,ZERO,ZERO,W(1,45))     
      CALL IOVXXX(W(1,45),W(1,1),W(1,6),GG,AMP(33))             
      CALL FVOXXX(W(1,13),W(1,43),GZU,ZERO,ZERO,W(1,46))    
      ...
      CALL FVIXXX(W(1,20),W(1,43),GZU,ZERO,ZERO,W(1,48))    
      CALL IOVXXX(W(1,48),W(1,1),W(1,6),GG,AMP(37))             
      CALL FVOXXX(W(1,1),W(1,43),GZU,ZERO,ZERO,W(1,49))    
      ...
      CALL HIOXXX(W(1,2),W(1,53),GULNJM,MCL,WCL,W(1,54))                                                          
      ...
      CALL HIOXXX(W(1,2),W(1,53),GURNJM,MCR,WCR,W(1,57))                                                          
      CALL FSIXXX(W(1,52),W(1,57),GURNIP,ZERO,ZERO,W(1,58))                                                          
      CALL FVIXXX(W(1,58),W(1,5),GG,ZERO,ZERO,W(1,59))     
      CALL IOVXXX(W(1,59),W(1,1),W(1,6),GG,AMP(42))             
      CALL HIOXXX(W(1,52),W(1,13),GULNIP,MCL,WCL,W(1,60))                                                          
      CALL FSOXXX(W(1,53),W(1,60),GULNJM,ZERO,ZERO,W(1,61))                                                          
      CALL IOVXXX(W(1,2),W(1,61),W(1,6),GG,AMP(43))             
      CALL HIOXXX(W(1,52),W(1,13),GURNIP,MCR,WCR,W(1,62))                                                          
      CALL FSOXXX(W(1,53),W(1,62),GURNJM,ZERO,ZERO,W(1,63))                                                          
      ...
      CALL HIOXXX(W(1,20),W(1,53),GULNJM,MCL,WCL,W(1,66))                                                          
      CALL FSIXXX(W(1,52),W(1,66),GULNIP,ZERO,ZERO,W(1,67))                                                          
      CALL IOVXXX(W(1,67),W(1,1),W(1,6),GG,AMP(51))             
      CALL HIOXXX(W(1,20),W(1,53),GURNJM,MCR,WCR,W(1,68))                                                          
      CALL FSIXXX(W(1,52),W(1,68),GURNIP,ZERO,ZERO,W(1,69))                                                          
      CALL IOVXXX(W(1,69),W(1,1),W(1,6),GG,AMP(52))             
      CALL HIOXXX(W(1,52),W(1,1),GULNIP,MCL,WCL,W(1,70))                                                          
      CALL FSOXXX(W(1,53),W(1,70),GULNJM,ZERO,ZERO,W(1,71))                                                          
      CALL FVOXXX(W(1,71),W(1,5),GG,ZERO,ZERO,W(1,72))     
      CALL IOVXXX(W(1,2),W(1,72),W(1,6),GG,AMP(53))             
      CALL HIOXXX(W(1,52),W(1,1),GURNIP,MCR,WCR,W(1,73))                                                          
      CALL FSOXXX(W(1,53),W(1,73),GURNJM,ZERO,ZERO,W(1,74))                                                          
      ...
      CALL HVSXXX(W(1,5),W(1,54),-GC,MCL,WCL,W(1,78))    
      CALL FSIXXX(W(1,52),W(1,78),GULNIP,ZERO,ZERO,W(1,79))                                                          
      CALL IOVXXX(W(1,79),W(1,1),W(1,6),GG,AMP(61))             
      CALL HVSXXX(W(1,5),W(1,57),-GC,MCR,WCR,W(1,80))    
      CALL FSIXXX(W(1,52),W(1,80),GURNIP,ZERO,ZERO,W(1,81))                                                          
      CALL IOVXXX(W(1,81),W(1,1),W(1,6),GG,AMP(62))             
      CALL HVSXXX(W(1,5),W(1,70),GC,MCL,WCL,W(1,82))     
      CALL FSOXXX(W(1,53),W(1,82),GULNJM,ZERO,ZERO,W(1,83))                                                          
      CALL IOVXXX(W(1,2),W(1,83),W(1,6),GG,AMP(63))             
      CALL HVSXXX(W(1,5),W(1,73),GC,MCR,WCR,W(1,84))     
      CALL FSOXXX(W(1,53),W(1,84),GURNJM,ZERO,ZERO,W(1,85))                                                          
     ...
     &             -AMP(  66)+AMP(  67)+AMP(  68)+AMP(  71)+AMP(  72)
      MATRIX_CXC_NINJGG = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_CXC_NINJGG =MATRIX_CXC_NINJGG+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
