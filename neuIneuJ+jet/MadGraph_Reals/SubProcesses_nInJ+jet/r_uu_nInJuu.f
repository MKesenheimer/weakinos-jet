      SUBROUTINE SMATRIX_UU_NINJUU(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_uu_nInJuu/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_UU_NINJUU(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_UU_NINJUU(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     13))                                                          
      ...
      CALL HIOXXX(W(1,1),W(1,14),GQLGOM,MUL,WUL,W(1,15))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,15),GULNJP,AMP(5))        
      CALL HIOXXX(W(1,1),W(1,14),GQRGOM,MUR,WUR,W(1,16))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,16),GURNJP,AMP(6))        
      CALL FSOXXX(W(1,5),W(1,10),GQRGOP,MGO,WGO,W(1,17))                                                          
      CALL HIOXXX(W(1,1),W(1,17),GQLGOM,MUL,WUL,W(1,18))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,18),GULNJP,AMP(7))        
      CALL HIOXXX(W(1,1),W(1,17),GQRGOM,MUR,WUR,W(1,19))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,19),GURNJP,AMP(8))        
      CALL FVIXXX(W(1,2),W(1,8),GG,ZERO,ZERO,W(1,20))     
      CALL HIOXXX(W(1,20),W(1,3),GULNIM,MUL,WUL,W(1,21))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,21),GULNJP,AMP(9))        
      CALL HIOXXX(W(1,20),W(1,3),GURNIM,MUR,WUR,W(1,22))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,22),GURNJP,AMP(10))        
      CALL HIOXXX(W(1,1),W(1,4),GULNJM,MUL,WUL,W(1,23))                                                          
      CALL JIOXXX(W(1,2),W(1,5),GG,ZERO,ZERO,W(1,24))     
      CALL HVSXXX(W(1,24),W(1,23),-GC,MUL,WUL,W(1,25))    
      CALL IOSCXX(W(1,6),W(1,3),W(1,25),GULNIP,AMP(11))        
      CALL HIOXXX(W(1,1),W(1,4),GURNJM,MUR,WUR,W(1,26))                                                          
      CALL HVSXXX(W(1,24),W(1,26),-GC,MUR,WUR,W(1,27))    
     ...
     &     29))                                                          
      ...
      CALL HIOXXX(W(1,2),W(1,4),GULNJM,MUL,WUL,W(1,39))                                                          
      CALL HVSXXX(W(1,8),W(1,39),-GC,MUL,WUL,W(1,40))    
      CALL IOSCXX(W(1,6),W(1,3),W(1,40),GULNIP,AMP(29))        
      CALL HIOXXX(W(1,2),W(1,4),GURNJM,MUR,WUR,W(1,41))                                                          
      CALL HVSXXX(W(1,8),W(1,41),-GC,MUR,WUR,W(1,42))    
     ...
     &     44))                                                          
      ...
      CALL HIOXXX(W(1,1),W(1,45),GQLGOM,MUL,WUL,W(1,46))                                                          
      CALL IOSCXX(W(1,6),W(1,3),W(1,46),GULNIP,AMP(33))        
      CALL HIOXXX(W(1,1),W(1,45),GQRGOM,MUR,WUR,W(1,47))                                                          
      CALL IOSCXX(W(1,6),W(1,3),W(1,47),GURNIP,AMP(34))        
      CALL FSOXXX(W(1,5),W(1,41),GQRGOP,MGO,WGO,W(1,48))                                                          
      CALL HIOXXX(W(1,1),W(1,48),GQLGOM,MUL,WUL,W(1,49))                                                          
      CALL IOSCXX(W(1,6),W(1,3),W(1,49),GULNIP,AMP(35))        
      CALL HIOXXX(W(1,1),W(1,48),GQRGOM,MUR,WUR,W(1,50))                                                          
      CALL IOSCXX(W(1,6),W(1,3),W(1,50),GURNIP,AMP(36))        
      CALL HIOXXX(W(1,20),W(1,4),GULNJM,MUL,WUL,W(1,51))                                                          
      CALL IOSCXX(W(1,6),W(1,3),W(1,51),GULNIP,AMP(37))        
      CALL HIOXXX(W(1,20),W(1,4),GURNJM,MUR,WUR,W(1,52))                                                          
      CALL IOSCXX(W(1,6),W(1,3),W(1,52),GURNIP,AMP(38))        
      CALL HIOXXX(W(1,1),W(1,3),GULNIM,MUL,WUL,W(1,53))                                                          
      CALL HVSXXX(W(1,24),W(1,53),-GC,MUL,WUL,W(1,54))    
      CALL IOSCXX(W(1,6),W(1,4),W(1,54),GULNJP,AMP(39))        
      CALL HIOXXX(W(1,1),W(1,3),GURNIM,MUR,WUR,W(1,55))                                                          
      CALL HVSXXX(W(1,24),W(1,55),-GC,MUR,WUR,W(1,56))    
     ...
     &     58))                                                          
      ...
      CALL HIOXXX(W(1,2),W(1,59),GQLGOM,MUL,WUL,W(1,60))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,60),GULNJP,AMP(43))        
      CALL HIOXXX(W(1,2),W(1,59),GQRGOM,MUR,WUR,W(1,61))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,61),GURNJP,AMP(44))        
      CALL FSOXXX(W(1,5),W(1,55),GQRGOP,MGO,WGO,W(1,62))                                                          
      CALL HIOXXX(W(1,2),W(1,62),GQLGOM,MUL,WUL,W(1,63))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,63),GULNJP,AMP(45))        
      CALL HIOXXX(W(1,2),W(1,62),GQRGOM,MUR,WUR,W(1,64))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,64),GURNJP,AMP(46))        
      CALL HIOXXX(W(1,36),W(1,3),GULNIM,MUL,WUL,W(1,65))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,65),GULNJP,AMP(47))        
      CALL HIOXXX(W(1,36),W(1,3),GURNIM,MUR,WUR,W(1,66))                                                          
      ...
      CALL HIOCXX(W(1,67),W(1,4),GULNJP,MUL,WUL,W(1,      
     &     71))                                                          
      CALL JSSXXX(W(1,71),W(1,7),GC,ZERO,ZERO,W(1,72))     
      CALL IOVXXX(W(1,1),W(1,68),W(1,72),GG,AMP(59))             
      CALL HIOCXX(W(1,67),W(1,4),GURNJP,MUR,WUR,W(1,      
     &     73))                                                          
      ...
      CALL HIOCXX(W(1,67),W(1,3),GULNIP,MUL,WUL,W(1,      
     &     83))                                                          
      CALL JSSXXX(W(1,83),W(1,23),GC,ZERO,ZERO,W(1,84))     
      CALL IOVXXX(W(1,2),W(1,68),W(1,84),GG,AMP(69))             
      CALL HIOCXX(W(1,67),W(1,3),GURNIP,MUR,WUR,W(1,      
     &     85))                                                          
     ...
     &             -AMP( 108)+AMP( 117)+AMP( 118)+AMP( 119)+AMP( 120)
      MATRIX_UU_NINJUU = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_UU_NINJUU =MATRIX_UU_NINJUU+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
