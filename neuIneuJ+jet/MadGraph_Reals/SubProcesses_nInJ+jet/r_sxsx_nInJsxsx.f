...
C ----------
     ...
     &     122))                                                          
      ...
      CALL HIOCXX(W(1,118),W(1,43),GQLGOP,MSL,WSL,W(1,      
     &     125))                                                          
      CALL IOSXXX(W(1,6),W(1,68),W(1,125),GDLNJM,AMP(109))         
      CALL HIOCXX(W(1,118),W(1,43),GQRGOP,MSR,WSR,W(1,      
     &     126))                                                          
      CALL IOSXXX(W(1,6),W(1,68),W(1,126),GDRNJM,AMP(110))         
      CALL HIOCXX(W(1,118),W(1,44),GQLGOP,MSL,WSL,W(1,      
     &     127))                                                          
      CALL IOSXXX(W(1,6),W(1,68),W(1,127),GDLNJM,AMP(111))         
      CALL HIOCXX(W(1,118),W(1,44),GQRGOP,MSR,WSR,W(1,      
     &     128))                                                          
      CALL IOSXXX(W(1,6),W(1,68),W(1,128),GDRNJM,AMP(112))         
      CALL HIOCXX(W(1,118),W(1,79),GQLGOP,MSL,WSL,W(1,      
     &     129))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,129),GDLNIM,AMP(113))         
      CALL HIOCXX(W(1,118),W(1,79),GQRGOP,MSR,WSR,W(1,      
     &     130))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,130),GDRNIM,AMP(114))         
      CALL HIOCXX(W(1,118),W(1,80),GQLGOP,MSL,WSL,W(1,      
     &     131))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,131),GDLNIM,AMP(115))         
      CALL HIOCXX(W(1,118),W(1,80),GQRGOP,MSR,WSR,W(1,      
     &     132))                                                          
