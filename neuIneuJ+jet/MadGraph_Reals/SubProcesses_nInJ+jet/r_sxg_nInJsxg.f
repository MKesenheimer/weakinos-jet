      SUBROUTINE SMATRIX_SXG_NINJSXG(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_sxg_nInJsxg/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_SXG_NINJSXG(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_SXG_NINJSXG(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,4),W(1,1),GDRNJP,MSR,WSR,W(1,15))                                                          
      ...
      CALL HIOXXX(W(1,5),W(1,3),GDRNIM,MSR,WSR,W(1,23))                                                          
      ...
      CALL HIOXXX(W(1,52),W(1,1),GDRNIP,MSR,WSR,W(1,61))                                                          
      ...
      CALL HVSXXX(W(1,2),W(1,66),-GC,MSL,WSL,W(1,67))    
      CALL FSIXXX(W(1,52),W(1,67),GDLNIP,ZERO,ZERO,W(1,68))                                                          
      CALL IOVXXX(W(1,68),W(1,1),W(1,6),GG,AMP(51))             
      CALL HIOXXX(W(1,5),W(1,53),GDRNJM,MSR,WSR,W(1,69))                                                          
      CALL HVSXXX(W(1,2),W(1,69),-GC,MSR,WSR,W(1,70))    
     ...
     &             +AMP(  68)+AMP(  69)+AMP(  70)+AMP(  71)+AMP(  72)
      MATRIX_SXG_NINJSXG = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_SXG_NINJSXG =MATRIX_SXG_NINJSXG+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
