      SUBROUTINE SB_CL_004_002(P1,ANS)
C  
...
C  
C FOR PROCESS : d g -> n1 n1 d g  
C  
C BORN AMPLITUDE IS d g -> n1 n1 d  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_004/  amp2,       jamp2

      integer j,jj
      integer max_bhel
      parameter( max_bhel =          32)
      double complex saveamp(ngraphs,max_bhel)
      common/to_saveamp_004/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_004/savemom
...
C          write(*,*) "momenta not the same in Born"
     ...
     &       nhel(2,ihel).eq.-1) THEN
                 T=B_CL_004_002(P1,NHEL(1,IHEL),IHEL,JC(1),T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_004_002(P,NHEL,HELL,IC,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,1),W(1,3),GDLN1M,MDL,WDL,W(1,       
     &     6))                                                          
      CALL FSIXXX(W(1,4),W(1,6),GDLN1P,ZERO,ZERO,W(1,       
     &     7))                                                          
      CALL IOVXXX(W(1,7),W(1,5),W(1,2),GG,AMP(1))             
      CALL HIOXXX(W(1,1),W(1,3),GDRN1M,MDR,WDR,W(1,       
     &     8))                                                          
     ...
     &     9))                                                          
      ...
      CALL HIOXXX(W(1,12),W(1,3),GDLN1M,MDL,WDL,W(1,       
     &     13))                                                          
      CALL IOSXXX(W(1,4),W(1,5),W(1,13),GDLN1P,AMP(5))         
      CALL HIOXXX(W(1,12),W(1,3),GDRN1M,MDR,WDR,W(1,       
     &     14))                                                          
     ...
     &     15))                                                          
      ...
      CALL HIOXXX(W(1,1),W(1,18),GDLN1M,MDL,WDL,W(1,       
     &     19))                                                          
      CALL IOSXXX(W(1,17),W(1,16),W(1,19),GDLN1P,AMP(9))         
      CALL HIOXXX(W(1,1),W(1,18),GDRN1M,MDR,WDR,W(1,       
     &     20))                                                          
      CALL IOSXXX(W(1,17),W(1,16),W(1,20),GDRN1P,AMP(10))         
      CALL HIOXXX(W(1,17),W(1,5),GDLN1P,MDL,WDL,W(1,       
     &     21))                                                          
      CALL VSSXXX(W(1,2),W(1,21),W(1,19),GC,AMP(11))             
      CALL HIOXXX(W(1,17),W(1,5),GDRN1P,MDR,WDR,W(1,       
     &     22))                                                          
      CALL VSSXXX(W(1,2),W(1,22),W(1,20),GC,AMP(12))             
      CALL HIOXXX(W(1,12),W(1,18),GDLN1M,MDL,WDL,W(1,       
     &     23))                                                          
      CALL IOSXXX(W(1,17),W(1,5),W(1,23),GDLN1P,AMP(13))         
      CALL HIOXXX(W(1,12),W(1,18),GDRN1M,MDR,WDR,W(1,       
     &     24))                                                          
     ...
     &             -AMP(  11)-AMP(  12)-AMP(  13)-AMP(  14)
      DO I = 1, NCOLOR
          ...
          if(ihel.eq.-1) then
             B_CL_004_002=B_CL_004_002 +RTEMP
          elseif(ihel.eq.1) then
             B_CL_004_002=B_CL_004_002 +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
