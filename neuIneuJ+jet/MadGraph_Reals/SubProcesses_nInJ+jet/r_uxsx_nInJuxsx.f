      SUBROUTINE SMATRIX_UXSX_NINJUXSX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_uxsx_nInJuxsx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_UXSX_NINJUXSX(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_UXSX_NINJUXSX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOCXX(W(1,78),W(1,56),GQLGOP,MSL,WSL,W(1,      
     &     79))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,79),GDLNIM,AMP(53))         
      CALL HIOCXX(W(1,78),W(1,56),GQRGOP,MSR,WSR,W(1,      
     &     80))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,80),GDRNIM,AMP(54))         
      CALL HIOCXX(W(1,78),W(1,58),GQLGOP,MSL,WSL,W(1,      
     &     81))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,81),GDLNIM,AMP(55))         
      CALL HIOCXX(W(1,78),W(1,58),GQRGOP,MSR,WSR,W(1,      
     &     82))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,82),GDRNIM,AMP(56))         
      CALL HIOCXX(W(1,78),W(1,37),GQLGOP,MSL,WSL,W(1,      
     &     83))                                                          
      CALL IOSXXX(W(1,6),W(1,46),W(1,83),GDLNJM,AMP(57))         
      CALL HIOCXX(W(1,78),W(1,37),GQRGOP,MSR,WSR,W(1,      
     &     84))                                                          
      CALL IOSXXX(W(1,6),W(1,46),W(1,84),GDRNJM,AMP(58))         
      CALL HIOCXX(W(1,78),W(1,38),GQLGOP,MSL,WSL,W(1,      
     &     85))                                                          
      CALL IOSXXX(W(1,6),W(1,46),W(1,85),GDLNJM,AMP(59))         
      CALL HIOCXX(W(1,78),W(1,38),GQRGOP,MSR,WSR,W(1,      
     &     86))                                                          
     ...
     &             -AMP(  56)+AMP(  57)+AMP(  58)+AMP(  59)+AMP(  60)
      MATRIX_UXSX_NINJUXSX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_UXSX_NINJUXSX =MATRIX_UXSX_NINJUXSX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
