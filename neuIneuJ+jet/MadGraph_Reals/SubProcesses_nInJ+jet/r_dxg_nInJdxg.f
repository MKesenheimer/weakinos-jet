      SUBROUTINE SMATRIX_DXG_NINJDXG(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_dxg_nInJdxg/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_DXG_NINJDXG(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_DXG_NINJDXG(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,7),W(1,3),GDLNIM,MDL,WDL,W(1,8))                                                          
      CALL FSIXXX(W(1,4),W(1,8),GDLNJP,ZERO,ZERO,W(1,9))                                                          
      CALL IOVXXX(W(1,9),W(1,1),W(1,6),GG,AMP(1))             
      CALL HIOXXX(W(1,7),W(1,3),GDRNIM,MDR,WDR,W(1,10))                                                          
      CALL FSIXXX(W(1,4),W(1,10),GDRNJP,ZERO,ZERO,W(1,11))                                                          
      CALL IOVXXX(W(1,11),W(1,1),W(1,6),GG,AMP(2))             
      CALL HIOXXX(W(1,4),W(1,1),GDLNJP,MDL,WDL,W(1,12))                                                          
      ...
      CALL HIOXXX(W(1,4),W(1,1),GDRNJP,MDR,WDR,W(1,15))                                                          
      CALL FSOXXX(W(1,3),W(1,15),GDRNIM,ZERO,ZERO,W(1,16))                                                          
      ...
      CALL HIOXXX(W(1,5),W(1,3),GDLNIM,MDL,WDL,W(1,20))                                                          
      ...
      CALL HIOXXX(W(1,5),W(1,3),GDRNIM,MDR,WDR,W(1,23))                                                          
      CALL HVSXXX(W(1,2),W(1,23),-GC,MDR,WDR,W(1,24))    
      CALL FSIXXX(W(1,4),W(1,24),GDRNJP,ZERO,ZERO,W(1,25))                                                          
      ...
      CALL FSIXXX(W(1,4),W(1,23),GDRNJP,ZERO,ZERO,W(1,34))                                                          
      ...
      CALL HIOXXX(W(1,4),W(1,38),GDLNJP,MDL,WDL,W(1,39))                                                          
      CALL FSOXXX(W(1,3),W(1,39),GDLNIM,ZERO,ZERO,W(1,40))                                                          
      CALL IOVXXX(W(1,5),W(1,40),W(1,6),GG,AMP(27))             
      CALL HIOXXX(W(1,4),W(1,38),GDRNJP,MDR,WDR,W(1,41))                                                          
      ...
      CALL FVIXXX(W(1,7),W(1,43),GZD,ZERO,ZERO,W(1,44))    
      CALL IOVXXX(W(1,44),W(1,1),W(1,6),GG,AMP(33))             
      CALL FVOXXX(W(1,1),W(1,43),GZD,ZERO,ZERO,W(1,45))    
      ...
      CALL HIOXXX(W(1,7),W(1,53),GDLNJM,MDL,WDL,W(1,54))                                                          
      CALL FSIXXX(W(1,52),W(1,54),GDLNIP,ZERO,ZERO,W(1,55))                                                          
      CALL IOVXXX(W(1,55),W(1,1),W(1,6),GG,AMP(41))             
      CALL HIOXXX(W(1,7),W(1,53),GDRNJM,MDR,WDR,W(1,56))                                                          
      CALL FSIXXX(W(1,52),W(1,56),GDRNIP,ZERO,ZERO,W(1,57))                                                          
      CALL IOVXXX(W(1,57),W(1,1),W(1,6),GG,AMP(42))             
      CALL HIOXXX(W(1,52),W(1,1),GDLNIP,MDL,WDL,W(1,58))                                                          
      CALL FSOXXX(W(1,53),W(1,58),GDLNJM,ZERO,ZERO,W(1,59))                                                          
      CALL JIOXXX(W(1,5),W(1,59),GG,ZERO,ZERO,W(1,60))     
      CALL VVVXXX(W(1,6),W(1,2),W(1,60),G,AMP(43))              
      CALL HIOXXX(W(1,52),W(1,1),GDRNIP,MDR,WDR,W(1,61))                                                          
      CALL FSOXXX(W(1,53),W(1,61),GDRNJM,ZERO,ZERO,W(1,62))                                                          
      ...
      CALL HIOXXX(W(1,5),W(1,53),GDLNJM,MDL,WDL,W(1,66))                                                          
      CALL HVSXXX(W(1,2),W(1,66),-GC,MDL,WDL,W(1,67))    
      CALL FSIXXX(W(1,52),W(1,67),GDLNIP,ZERO,ZERO,W(1,68))                                                          
      CALL IOVXXX(W(1,68),W(1,1),W(1,6),GG,AMP(51))             
      CALL HIOXXX(W(1,5),W(1,53),GDRNJM,MDR,WDR,W(1,69))                                                          
      CALL HVSXXX(W(1,2),W(1,69),-GC,MDR,WDR,W(1,70))    
      CALL FSIXXX(W(1,52),W(1,70),GDRNIP,ZERO,ZERO,W(1,71))                                                          
      ...
      CALL FSIXXX(W(1,52),W(1,69),GDRNIP,ZERO,ZERO,W(1,80))                                                          
      ...
      CALL HIOXXX(W(1,52),W(1,38),GDLNIP,MDL,WDL,W(1,84))                                                          
      CALL FSOXXX(W(1,53),W(1,84),GDLNJM,ZERO,ZERO,W(1,85))                                                          
      CALL IOVXXX(W(1,5),W(1,85),W(1,6),GG,AMP(67))             
      CALL HIOXXX(W(1,52),W(1,38),GDRNIP,MDR,WDR,W(1,86))                                                          
     ...
     &             +AMP(  68)+AMP(  69)+AMP(  70)+AMP(  71)+AMP(  72)
      MATRIX_DXG_NINJDXG = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_DXG_NINJDXG =MATRIX_DXG_NINJDXG+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
