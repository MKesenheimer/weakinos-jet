      SUBROUTINE SMATRIX_GUX_NINJUXG(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_gux_nInJuxg/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_GUX_NINJUXG(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_GUX_NINJUXG(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,4),W(1,2),GULNJP,MUL,WUL,W(1,7))                                                          
      ...
      CALL HIOXXX(W(1,4),W(1,2),GURNJP,MUR,WUR,W(1,10))                                                          
      ...
      CALL HIOXXX(W(1,13),W(1,3),GULNIM,MUL,WUL,W(1,14))                                                          
      CALL FSIXXX(W(1,4),W(1,14),GULNJP,ZERO,ZERO,W(1,15))                                                          
      CALL IOVXXX(W(1,15),W(1,2),W(1,6),GG,AMP(3))             
      CALL HIOXXX(W(1,13),W(1,3),GURNIM,MUR,WUR,W(1,16))                                                          
      ...
      CALL HIOXXX(W(1,5),W(1,3),GURNIM,MUR,WUR,W(1,22))                                                          
      ...
      CALL HIOXXX(W(1,52),W(1,2),GULNIP,MUL,WUL,W(1,54))                                                          
      ...
      CALL HIOXXX(W(1,52),W(1,2),GURNIP,MUR,WUR,W(1,57))                                                          
      ...
      CALL HIOXXX(W(1,13),W(1,53),GULNJM,MUL,WUL,W(1,60))                                                          
      CALL FSIXXX(W(1,52),W(1,60),GULNIP,ZERO,ZERO,W(1,61))                                                          
      CALL IOVXXX(W(1,61),W(1,2),W(1,6),GG,AMP(43))             
      CALL HIOXXX(W(1,13),W(1,53),GURNJM,MUR,WUR,W(1,62))                                                          
     ...
     &             +AMP(  60)+AMP(  63)+AMP(  64)+AMP(  65)+AMP(  66)
      MATRIX_GUX_NINJUXG = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_GUX_NINJUXG =MATRIX_GUX_NINJUXG+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
