      SUBROUTINE SMATRIX_SS_NINJSS(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_ss_nInJss/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_SS_NINJSS(P,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_SS_NINJSS(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     13))                                                          
      ...
      CALL HIOXXX(W(1,1),W(1,17),GQLGOM,MSL,WSL,W(1,18))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,18),GDLNJP,AMP(7))        
      CALL HIOXXX(W(1,1),W(1,17),GQRGOM,MSR,WSR,W(1,19))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,19),GDRNJP,AMP(8))        
      CALL FVIXXX(W(1,2),W(1,8),GG,ZERO,ZERO,W(1,20))     
      CALL HIOXXX(W(1,20),W(1,3),GDLNIM,MSL,WSL,W(1,21))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,21),GDLNJP,AMP(9))        
      CALL HIOXXX(W(1,20),W(1,3),GDRNIM,MSR,WSR,W(1,22))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,22),GDRNJP,AMP(10))        
      CALL HIOXXX(W(1,1),W(1,4),GDLNJM,MSL,WSL,W(1,23))                                                          
      CALL JIOXXX(W(1,2),W(1,5),GG,ZERO,ZERO,W(1,24))     
      CALL HVSXXX(W(1,24),W(1,23),-GC,MSL,WSL,W(1,25))    
      CALL IOSCXX(W(1,6),W(1,3),W(1,25),GDLNIP,AMP(11))        
      CALL HIOXXX(W(1,1),W(1,4),GDRNJM,MSR,WSR,W(1,26))                                                          
      CALL HVSXXX(W(1,24),W(1,26),-GC,MSR,WSR,W(1,27))    
      CALL IOSCXX(W(1,6),W(1,3),W(1,27),GDRNIP,AMP(12))        
      CALL FSOCXX(W(1,3),W(1,23),GDLNIP,ZERO,ZERO,W(1,      
     &     28))                                                          
      CALL IOVCXX(W(1,6),W(1,28),W(1,24),GG,AMP(13))            
      CALL FSOCXX(W(1,3),W(1,26),GDRNIP,ZERO,ZERO,W(1,      
     &     29))                                                          
      CALL IOVCXX(W(1,6),W(1,29),W(1,24),GG,AMP(14))            
      CALL FSOXXX(W(1,5),W(1,23),GQLGOP,MGO,WGO,W(1,30))                                                          
      CALL HIOXXX(W(1,2),W(1,30),GQLGOM,MSL,WSL,W(1,31))                                                          
      CALL IOSCXX(W(1,6),W(1,3),W(1,31),GDLNIP,AMP(15))        
      CALL HIOXXX(W(1,2),W(1,30),GQRGOM,MSR,WSR,W(1,32))                                                          
      ...
      CALL HIOXXX(W(1,36),W(1,4),GDLNJM,MSL,WSL,W(1,37))                                                          
      CALL IOSCXX(W(1,6),W(1,3),W(1,37),GDLNIP,AMP(19))        
      CALL HIOXXX(W(1,36),W(1,4),GDRNJM,MSR,WSR,W(1,38))                                                          
      ...
      CALL HIOXXX(W(1,2),W(1,4),GDLNJM,MSL,WSL,W(1,39))                                                          
      CALL HVSXXX(W(1,8),W(1,39),-GC,MSL,WSL,W(1,40))    
      CALL IOSCXX(W(1,6),W(1,3),W(1,40),GDLNIP,AMP(29))        
      CALL HIOXXX(W(1,2),W(1,4),GDRNJM,MSR,WSR,W(1,41))                                                          
      CALL HVSXXX(W(1,8),W(1,41),-GC,MSR,WSR,W(1,42))    
     ...
     &     44))                                                          
      ...
      CALL HIOXXX(W(1,1),W(1,45),GQLGOM,MSL,WSL,W(1,46))                                                          
      CALL IOSCXX(W(1,6),W(1,3),W(1,46),GDLNIP,AMP(33))        
      CALL HIOXXX(W(1,1),W(1,45),GQRGOM,MSR,WSR,W(1,47))                                                          
      CALL IOSCXX(W(1,6),W(1,3),W(1,47),GDRNIP,AMP(34))        
      CALL FSOXXX(W(1,5),W(1,41),GQRGOP,MGO,WGO,W(1,48))                                                          
      CALL HIOXXX(W(1,1),W(1,48),GQLGOM,MSL,WSL,W(1,49))                                                          
      CALL IOSCXX(W(1,6),W(1,3),W(1,49),GDLNIP,AMP(35))        
      CALL HIOXXX(W(1,1),W(1,48),GQRGOM,MSR,WSR,W(1,50))                                                          
      CALL IOSCXX(W(1,6),W(1,3),W(1,50),GDRNIP,AMP(36))        
      CALL HIOXXX(W(1,20),W(1,4),GDLNJM,MSL,WSL,W(1,51))                                                          
      CALL IOSCXX(W(1,6),W(1,3),W(1,51),GDLNIP,AMP(37))        
      CALL HIOXXX(W(1,20),W(1,4),GDRNJM,MSR,WSR,W(1,52))                                                          
      CALL IOSCXX(W(1,6),W(1,3),W(1,52),GDRNIP,AMP(38))        
      CALL HIOXXX(W(1,1),W(1,3),GDLNIM,MSL,WSL,W(1,53))                                                          
      CALL HVSXXX(W(1,24),W(1,53),-GC,MSL,WSL,W(1,54))    
      CALL IOSCXX(W(1,6),W(1,4),W(1,54),GDLNJP,AMP(39))        
      CALL HIOXXX(W(1,1),W(1,3),GDRNIM,MSR,WSR,W(1,55))                                                          
      CALL HVSXXX(W(1,24),W(1,55),-GC,MSR,WSR,W(1,56))    
      CALL IOSCXX(W(1,6),W(1,4),W(1,56),GDRNJP,AMP(40))        
      CALL FSOCXX(W(1,4),W(1,53),GDLNJP,ZERO,ZERO,W(1,      
     &     57))                                                          
      CALL IOVCXX(W(1,6),W(1,57),W(1,24),GG,AMP(41))            
      CALL FSOCXX(W(1,4),W(1,55),GDRNJP,ZERO,ZERO,W(1,      
     &     58))                                                          
      CALL IOVCXX(W(1,6),W(1,58),W(1,24),GG,AMP(42))            
      CALL FSOXXX(W(1,5),W(1,53),GQLGOP,MGO,WGO,W(1,59))                                                          
      CALL HIOXXX(W(1,2),W(1,59),GQLGOM,MSL,WSL,W(1,60))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,60),GDLNJP,AMP(43))        
      CALL HIOXXX(W(1,2),W(1,59),GQRGOM,MSR,WSR,W(1,61))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,61),GDRNJP,AMP(44))        
      CALL FSOXXX(W(1,5),W(1,55),GQRGOP,MGO,WGO,W(1,62))                                                          
      CALL HIOXXX(W(1,2),W(1,62),GQLGOM,MSL,WSL,W(1,63))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,63),GDLNJP,AMP(45))        
      CALL HIOXXX(W(1,2),W(1,62),GQRGOM,MSR,WSR,W(1,64))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,64),GDRNJP,AMP(46))        
      CALL HIOXXX(W(1,36),W(1,3),GDLNIM,MSL,WSL,W(1,65))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,65),GDLNJP,AMP(47))        
      CALL HIOXXX(W(1,36),W(1,3),GDRNIM,MSR,WSR,W(1,66))                                                          
      ...
      CALL HIOCXX(W(1,67),W(1,4),GDLNJP,MSL,WSL,W(1,      
     &     71))                                                          
      CALL JSSXXX(W(1,71),W(1,7),GC,ZERO,ZERO,W(1,72))     
      CALL IOVXXX(W(1,1),W(1,68),W(1,72),GG,AMP(59))             
      CALL HIOCXX(W(1,67),W(1,4),GDRNJP,MSR,WSR,W(1,      
     &     73))                                                          
      ...
      CALL HIOCXX(W(1,67),W(1,3),GDLNIP,MSL,WSL,W(1,      
     &     83))                                                          
      CALL JSSXXX(W(1,83),W(1,23),GC,ZERO,ZERO,W(1,84))     
      CALL IOVXXX(W(1,2),W(1,68),W(1,84),GG,AMP(69))             
      CALL HIOCXX(W(1,67),W(1,3),GDRNIP,MSR,WSR,W(1,      
     &     85))                                                          
     ...
     &             -AMP( 108)+AMP( 117)+AMP( 118)+AMP( 119)+AMP( 120)
      MATRIX_SS_NINJSS = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_SS_NINJSS =MATRIX_SS_NINJSS+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
