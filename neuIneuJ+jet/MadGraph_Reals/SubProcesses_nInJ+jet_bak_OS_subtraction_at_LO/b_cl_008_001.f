      SUBROUTINE SB_CL_008_001(P1,ANS)
C  
...
C          write(*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_CL_008_001(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_CL_008_001(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
#ifdef DEBUGQ
      do i=1,14
        if(i.ne.0) then ! resonant: 3,4,5,6,11,12,13,14
          Amp(i) = 0D0
        endif
      enddo
#endif
...
c delete resonant diagrams (diagram removal type I)
     ...
     &             -AMP(  11)-AMP(  12)-AMP(  13)-AMP(  14)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_CL_008_001 =B_CL_008_001+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
...
c (diagram removal type II)
     ...
     &            -AMP(13)-AMP(14)
      ...
      ENDDO
      B_CL_008_001 = B_CL_008_001 - MATRIX_RES
#endif
      END
