...
C ----------
      ...
      CALL HIOXXX(W(1,5),W(1,3),GDLNIM,MDL,WDL,W(1,9))                                                          
      ...
      CALL HIOXXX(W(1,4),W(1,11),GDLNJP,MDL,WDL,W(1,12))                                                          
      CALL IOSXXX(W(1,5),W(1,3),W(1,12),GDLNIM,AMP(5))         
      CALL HIOXXX(W(1,4),W(1,11),GDRNJP,MDR,WDR,W(1,13))                                                          
      ...
      CALL HIOXXX(W(1,15),W(1,11),GDLNIP,MDL,WDL,W(1,23))                                                          
      CALL IOSXXX(W(1,5),W(1,16),W(1,23),GDLNJM,AMP(13))         
      CALL HIOXXX(W(1,15),W(1,11),GDRNIP,MDR,WDR,W(1,24))                                                          
      CALL IOSXXX(W(1,5),W(1,16),W(1,24),GDRNJM,AMP(14))

#ifdef DEBUQ
      do i=1,14
        if(i.ne.14) then ! resonant: 3,4,5,6,11,12,13,14
          Amp(i) = 0D0
        endif
      enddo
#endif
...
c (diagram removal type II)
     ...
     &                    ZTEMP*DCONJG(JAMPHR(-1,I))/DENOM(I)
      ENDDO
      B_CL_021_001 = B_CL_021_001 - CMATRIX_RES
