      SUBROUTINE SB_CL_006_002(P1,ANS)
C  
...
C  
      ...
      common/to_saveamp_006/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_006/savemom
...
C          write(*,*) "momenta not the same in Born"
     ...
     &       nhel(2,ihel).eq.-1) THEN
                 T=B_CL_006_002(P1,NHEL(1,IHEL),IHEL,JC(1),T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_006_002(P,NHEL,HELL,IC,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IXXXXX(P(0,4),MNI,NHEL(4),-1*IC(4),W(1,4))         
      CALL IXXXXX(P(0,5),ZERO,NHEL(5),-1*IC(5),W(1,5))        
      CALL HIOXXX(W(1,4),W(1,1),GULNIP,MUL,WUL,W(1,6))                                                          
      CALL FVIXXX(W(1,5),W(1,2),GG,ZERO,ZERO,W(1,7))     
      CALL IOSXXX(W(1,7),W(1,3),W(1,6),GULNIM,AMP(1))         
      CALL HIOXXX(W(1,4),W(1,1),GURNIP,MUR,WUR,W(1,8))                                                          
      CALL IOSXXX(W(1,7),W(1,3),W(1,8),GURNIM,AMP(2))         
      CALL HIOXXX(W(1,5),W(1,3),GULNIM,MUL,WUL,W(1,9))                                                          
      ...
      CALL HIOXXX(W(1,4),W(1,11),GULNIP,MUL,WUL,W(1,12))                                                          
      CALL IOSXXX(W(1,5),W(1,3),W(1,12),GULNIM,AMP(5))         
      CALL HIOXXX(W(1,4),W(1,11),GURNIP,MUR,WUR,W(1,13))                                                          
      CALL IOSXXX(W(1,5),W(1,3),W(1,13),GURNIM,AMP(6))         
      CALL JIOXXX(W(1,4),W(1,3),GZN11,ZMASS,ZWIDTH,W(1, 14))                                                          
      ...
      CALL OXXXXX(P(0,4),MNI,NHEL(4),+1*IC(4),W(1,16))         
      CALL HIOXXX(W(1,15),W(1,1),GULNIP,MUL,WUL,W(1,17))                                                          
      CALL FSOXXX(W(1,16),W(1,17),GULNIM,ZERO,ZERO,W(1,18))                                                          
      CALL IOVXXX(W(1,5),W(1,18),W(1,2),GG,AMP(9))             
      CALL HIOXXX(W(1,15),W(1,1),GURNIP,MUR,WUR,W(1,19))                                                          
      CALL FSOXXX(W(1,16),W(1,19),GURNIM,ZERO,ZERO,W(1,20))                                                          
      CALL IOVXXX(W(1,5),W(1,20),W(1,2),GG,AMP(10))             
      CALL HVSXXX(W(1,2),W(1,17),GC,MUL,WUL,W(1,21))     
      CALL IOSXXX(W(1,5),W(1,16),W(1,21),GULNIM,AMP(11))         
      CALL HVSXXX(W(1,2),W(1,19),GC,MUR,WUR,W(1,22))     
      CALL IOSXXX(W(1,5),W(1,16),W(1,22),GURNIM,AMP(12))         
      CALL HIOXXX(W(1,15),W(1,11),GULNIP,MUL,WUL,W(1,23))                                                          
      CALL IOSXXX(W(1,5),W(1,16),W(1,23),GULNIM,AMP(13))         
      CALL HIOXXX(W(1,15),W(1,11),GURNIP,MUR,WUR,W(1,24))                                                          
      CALL IOSXXX(W(1,5),W(1,16),W(1,24),GURNIM,AMP(14))
...
c delete resonant diagrams (diagram removal type I)
     ...
     &             +AMP(  11)+AMP(  12)+AMP(  13)+AMP(  14)
      DO I = 1, NCOLOR
          ...
          if(ihel.eq.-1) then
             B_CL_006_002=B_CL_006_002 +RTEMP
          elseif(ihel.eq.1) then
             B_CL_006_002=B_CL_006_002 +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
...
c (diagram removal type II)
     ...
     &                    ZTEMP*DCONJG(JAMPHR(-1,I))/DENOM(I)
      ENDDO
      B_CL_006_002 = B_CL_006_002 - CMATRIX_RES
...
#ifdef DEBUGQ
      print*,jamp2(0:NCOLOR)
      print*,amp2(1:NGRAPHS)
      !stop
#endif
      END
