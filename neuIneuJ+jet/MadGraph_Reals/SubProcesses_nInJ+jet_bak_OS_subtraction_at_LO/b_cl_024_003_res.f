      SUBROUTINE SB_CL_024_003_RES(P1,CHAN,ANS)
C  
...
C          write(*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_CL_024_003_RES(P1,NHEL(1,IHEL),IHEL,JC(1),CHAN)              
      ...
      REAL*8 FUNCTION B_CL_024_003_RES(P,NHEL,HELL,IC,CHAN)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &            -AMP(11)-AMP(13)-AMP(12)-AMP(14)
      ...
      B_CL_024_003_RES = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          B_CL_024_003_RES =B_CL_024_003_RES+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
