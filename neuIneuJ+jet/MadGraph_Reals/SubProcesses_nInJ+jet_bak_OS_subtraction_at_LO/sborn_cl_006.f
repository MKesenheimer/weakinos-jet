      subroutine sborn_cl_006(p_born,wgtmunu,wgt)
      implicit none
     ...
     &    wgtmunu(0:3,0:3,nexternal-1)
      ...
      !double complex tmpwgt1(2) ! MK: added
      integer i,j,leg
...
#define DEBUG1
      ...
      ! MK: added
      !call sb_cl_006_002(p_born,tmpwgt1)
      
      if( leg.eq.           1) then
         call sb_cl_006_001(p_born,wgt1)
#ifdef DEBUG1
      print*,"start"
      print*,jamp2(0:1)
      print*,amp2(1:14)
#endif
         !wgt1 = tmpwgt1 ! MK: added
      ...
      elseif( leg.eq.           2) then
         ...
         call sb_cl_006_002(p_born,wgt1)
#ifdef DEBUG1
      print*,jamp2(0:1)
      print*,amp2(1:14)
#endif
      ...
      elseif( leg.eq.           5) then
         call sb_cl_006_003(p_born,wgt1)
#ifdef DEBUG1
      print*,jamp2(0:1)
      print*,amp2(1:14)
      print*,"stop"
     ...
     &                      dconjg(wgt1(2))*wm(i+1)*wps(j+1)
      ...
      !           write(*,*) "ERROR in sborn_cl_006: Bmunu is complex"
      !           stop
      !         endif
      !      endif
      ...
      do leg=1,nexternal-1
        do i=1,nexternal-1
          if(wgt(leg).ne.0D0 .and. wgt(i).ne.0D0 .and.
     &       abs((wgt(leg)-wgt(i))/wgt(leg)).gt.1d-10) then
            print*,leg,wgt
            stop
          endif
        enddo
