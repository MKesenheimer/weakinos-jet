...
C ----------
      ...
      CALL HIOXXX(W(1,1),W(1,3),GDRNIM,MDR,WDR,W(1,8))                                                          
      ...
      CALL HIOXXX(W(1,1),W(1,18),GDLNJM,MDL,WDL,W(1,19))                                                          
      CALL IOSXXX(W(1,17),W(1,16),W(1,19),GDLNIP,AMP(9))         
      CALL HIOXXX(W(1,1),W(1,18),GDRNJM,MDR,WDR,W(1,20))                                                          
...
c (diagram removal type II)
     ...
     &                    ZTEMP*DCONJG(JAMPHR(-1,I))/DENOM(I)
      ENDDO
      B_CL_004_002 = B_CL_004_002 - CMATRIX_RES
