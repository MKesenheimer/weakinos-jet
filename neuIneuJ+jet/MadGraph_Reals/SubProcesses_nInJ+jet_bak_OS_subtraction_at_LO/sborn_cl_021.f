      subroutine sborn_cl_021(p_born,wgtmunu,wgt)
      implicit none
     ...
     &    wgtmunu(0:3,0:3,nexternal-1)
      ...
      ! MK: added
      !call sb_cl_021_001(p_born,tmpwgt1)
     ...
     &                      dconjg(wgt1(2))*wm(i+1)*wps(j+1)
      ...
      !           write(*,*) "ERROR in sborn_cl_021: Bmunu is complex"
      !           stop
      !         endif
      !      endif
