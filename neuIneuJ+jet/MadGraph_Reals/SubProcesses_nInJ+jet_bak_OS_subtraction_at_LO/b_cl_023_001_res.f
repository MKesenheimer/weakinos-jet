      SUBROUTINE SB_CL_023_001_RES(P1,CHAN,ANS)
C  
...
C  
      ...
      common/to_amps_023_res/  amp2,       jamp2

      integer j,jj
      integer max_bhel
      parameter( max_bhel =          32)
      double complex saveamp(ngraphs,max_bhel)
      common/to_saveamp_023_res/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_023_res/savemom
...
C          write(*,*) "momenta not the same in Born"
     ...
     &       nhel(1,ihel).eq.-1) THEN
                 T=B_CL_023_001_RES(P1,NHEL(1,IHEL),IHEL,JC(1),CHAN,T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_023_001_RES(P,NHEL,HELL,IC,CHAN,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
c delete resonant diagrams (diagram removal type I)
     ...
     &            +AMP(11)+AMP(13)+AMP(12)+AMP(14)
      ...
      DO I = 1, NCOLOR
          ...
          if(ihel.eq.-1) then
             B_CL_023_001_RES=B_CL_023_001_RES +RTEMP
          elseif(ihel.eq.1) then
             B_CL_023_001_RES=B_CL_023_001_RES +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
