      SUBROUTINE SMATRIX_DXUX_NINJDXUX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_dxux_nInJdxux/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_DXUX_NINJDXUX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_DXUX_NINJDXUX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,21),W(1,2),GQRGOP,MUR,WUR,W(1,23))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,23),GURNIM,AMP(8))         
      CALL FSIXXX(W(1,5),W(1,10),GQRGOM,MGO,WGO,W(1,24))                                                          
      CALL HIOXXX(W(1,24),W(1,2),GQLGOP,MUL,WUL,W(1,25))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,25),GULNIM,AMP(9))         
      CALL HIOXXX(W(1,24),W(1,2),GQRGOP,MUR,WUR,W(1,26))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,26),GURNIM,AMP(10))         
      CALL HIOXXX(W(1,4),W(1,2),GULNJP,MUL,WUL,W(1,27))                                                          
      CALL JIOXXX(W(1,5),W(1,1),GG,ZERO,ZERO,W(1,28))     
      CALL HVSXXX(W(1,28),W(1,27),GC,MUL,WUL,W(1,29))     
      CALL IOSXXX(W(1,6),W(1,3),W(1,29),GULNIM,AMP(11))         
      CALL HIOXXX(W(1,4),W(1,2),GURNJP,MUR,WUR,W(1,30))                                                          
      CALL HVSXXX(W(1,28),W(1,30),GC,MUR,WUR,W(1,31))     
      ...
      CALL HIOXXX(W(1,4),W(1,34),GULNJP,MUL,WUL,W(1,35))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,35),GULNIM,AMP(15))         
      CALL HIOXXX(W(1,4),W(1,34),GURNJP,MUR,WUR,W(1,36))                                                          
      ...
      CALL HVSXXX(W(1,28),W(1,47),GC,MUL,WUL,W(1,48))     
      CALL IOSXXX(W(1,6),W(1,46),W(1,48),GULNJM,AMP(25))         
      CALL HIOXXX(W(1,45),W(1,2),GURNIP,MUR,WUR,W(1,49))                                                          
      CALL HVSXXX(W(1,28),W(1,49),GC,MUR,WUR,W(1,50))     
      ...
      CALL HIOXXX(W(1,45),W(1,34),GULNIP,MUL,WUL,W(1,53))                                                          
      CALL IOSXXX(W(1,6),W(1,46),W(1,53),GULNJM,AMP(29))         
      CALL HIOXXX(W(1,45),W(1,34),GURNIP,MUR,WUR,W(1,54))                                                          
      ...
      CALL HIOXXX(W(1,71),W(1,2),GQLGOP,MUL,WUL,W(1,72))                                                          
      CALL IOSXXX(W(1,6),W(1,46),W(1,72),GULNJM,AMP(41))         
      CALL HIOXXX(W(1,71),W(1,2),GQRGOP,MUR,WUR,W(1,73))                                                          
      CALL IOSXXX(W(1,6),W(1,46),W(1,73),GURNJM,AMP(42))         
      CALL FSIXXX(W(1,5),W(1,62),GQRGOM,MGO,WGO,W(1,74))                                                          
      CALL HIOXXX(W(1,74),W(1,2),GQLGOP,MUL,WUL,W(1,75))                                                          
      CALL IOSXXX(W(1,6),W(1,46),W(1,75),GULNJM,AMP(43))         
      CALL HIOXXX(W(1,74),W(1,2),GQRGOP,MUR,WUR,W(1,76))                                                          
      ...
      CALL HIOCXX(W(1,78),W(1,56),GQLGOP,MUL,WUL,W(1,79))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,79),GULNIM,AMP(53))         
      CALL HIOCXX(W(1,78),W(1,56),GQRGOP,MUR,WUR,W(1,80))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,80),GURNIM,AMP(54))         
      CALL HIOCXX(W(1,78),W(1,58),GQLGOP,MUL,WUL,W(1,81))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,81),GULNIM,AMP(55))         
      CALL HIOCXX(W(1,78),W(1,58),GQRGOP,MUR,WUR,W(1,82))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,82),GURNIM,AMP(56))         
      CALL HIOCXX(W(1,78),W(1,37),GQLGOP,MUL,WUL,W(1,83))                                                          
      CALL IOSXXX(W(1,6),W(1,46),W(1,83),GULNJM,AMP(57))         
      CALL HIOCXX(W(1,78),W(1,37),GQRGOP,MUR,WUR,W(1,84))                                                          
      CALL IOSXXX(W(1,6),W(1,46),W(1,84),GURNJM,AMP(58))         
      CALL HIOCXX(W(1,78),W(1,38),GQLGOP,MUL,WUL,W(1,85))                                                          
      CALL IOSXXX(W(1,6),W(1,46),W(1,85),GULNJM,AMP(59))         
      CALL HIOCXX(W(1,78),W(1,38),GQRGOP,MUR,WUR,W(1,86))                                                          
     ...
     &             -AMP(  56)+AMP(  57)+AMP(  58)+AMP(  59)+AMP(  60)
      MATRIX_DXUX_NINJDXUX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_DXUX_NINJDXUX =MATRIX_DXUX_NINJDXUX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
