      SUBROUTINE SMATRIX_BXCX_NINJCXBX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_bxcx_nInJcxbx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_BXCX_NINJCXBX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_BXCX_NINJCXBX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOSXXX(W(1,6),W(1,3),W(1,11),GB2NIM,AMP(2))         
      CALL FSOXXX(W(1,3),W(1,7),GB1NIM,BMASS,ZERO,W(1,12))                                                          
      CALL IOVXXX(W(1,6),W(1,12),W(1,8),GG,AMP(3))             
      CALL FSOXXX(W(1,3),W(1,10),GB2NIM,BMASS,ZERO,W(1,13))                                                          
      CALL IOVXXX(W(1,6),W(1,13),W(1,8),GG,AMP(4))             
      CALL FVOXXX(W(1,1),W(1,8),GG,BMASS,ZERO,W(1,14))     
      CALL HIOXXX(W(1,4),W(1,14),GB1NJP,MBL,WBL,W(1,15))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,15),GB1NIM,AMP(5))         
      CALL HIOXXX(W(1,4),W(1,14),GB2NJP,MBR,WBR,W(1,16))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,16),GB2NIM,AMP(6))         
      ...
      CALL HIOXXX(W(1,5),W(1,3),GURNIM,MCR,WCR,W(1,19))                                                          
      ...
      CALL HIOXXX(W(1,4),W(1,2),GULNJP,MCL,WCL,W(1,21))                                                          
      ...
      CALL HIOXXX(W(1,4),W(1,2),GURNJP,MCR,WCR,W(1,24))                                                          
      ...
      CALL HIOXXX(W(1,33),W(1,1),GB1GOP,MBL,WBL,W(1,34))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,34),GB1NIM,AMP(17))         
      CALL HIOXXX(W(1,33),W(1,1),GB2GOP,MBR,WBR,W(1,35))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,35),GB2NIM,AMP(18))         
      CALL FSIXXX(W(1,5),W(1,24),GQRGOM,MGO,WGO,W(1,36))                                                          
      CALL HIOXXX(W(1,36),W(1,1),GB1GOP,MBL,WBL,W(1,37))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,37),GB1NIM,AMP(19))         
      CALL HIOXXX(W(1,36),W(1,1),GB2GOP,MBR,WBR,W(1,38))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,38),GB2NIM,AMP(20))         
      ...
      CALL HIOCXX(W(1,4),W(1,3),GH1NIJ,MH1,WH1,W(1,42))                                                          
      CALL IOSXXX(W(1,6),W(1,14),W(1,42),GH1BB,AMP(23))          
      CALL HIOCXX(W(1,4),W(1,3),GH2NIJ,MH2,WH2,W(1,43))                                                          
      CALL IOSXXX(W(1,6),W(1,14),W(1,43),GH2BB,AMP(24))          
      CALL HIOCXX(W(1,4),W(1,3),GH3NIJ,MH3,WH3,W(1,44))                                                          
      ...
      CALL HIOXXX(W(1,67),W(1,1),GB1GOP,MBL,WBL,W(1,68))                                                          
      CALL IOSXXX(W(1,6),W(1,52),W(1,68),GB1NJM,AMP(37))         
      CALL HIOXXX(W(1,67),W(1,1),GB2GOP,MBR,WBR,W(1,69))                                                          
      CALL IOSXXX(W(1,6),W(1,52),W(1,69),GB2NJM,AMP(38))         
      CALL FSIXXX(W(1,5),W(1,56),GQRGOM,MGO,WGO,W(1,70))                                                          
      CALL HIOXXX(W(1,70),W(1,1),GB1GOP,MBL,WBL,W(1,71))                                                          
      CALL IOSXXX(W(1,6),W(1,52),W(1,71),GB1NJM,AMP(39))         
      CALL HIOXXX(W(1,70),W(1,1),GB2GOP,MBR,WBR,W(1,72))                                                          
      CALL IOSXXX(W(1,6),W(1,52),W(1,72),GB2NJM,AMP(40))         
      CALL HIOXXX(W(1,51),W(1,1),GB1NIP,MBL,WBL,W(1,73))                                                          
      CALL HVSXXX(W(1,8),W(1,73),GC,MBL,WBL,W(1,74))     
      CALL IOSXXX(W(1,6),W(1,52),W(1,74),GB1NJM,AMP(41))         
      CALL HIOXXX(W(1,51),W(1,1),GB2NIP,MBR,WBR,W(1,75))                                                          
      CALL HVSXXX(W(1,8),W(1,75),GC,MBR,WBR,W(1,76))     
      CALL IOSXXX(W(1,6),W(1,52),W(1,76),GB2NJM,AMP(42))         
      CALL FSOXXX(W(1,52),W(1,73),GB1NJM,BMASS,ZERO,W(1,77))                                                          
      CALL IOVXXX(W(1,6),W(1,77),W(1,8),GG,AMP(43))             
      CALL FSOXXX(W(1,52),W(1,75),GB2NJM,BMASS,ZERO,W(1,78))                                                          
      CALL IOVXXX(W(1,6),W(1,78),W(1,8),GG,AMP(44))             
      CALL HIOXXX(W(1,51),W(1,14),GB1NIP,MBL,WBL,W(1,79))                                                          
      CALL IOSXXX(W(1,6),W(1,52),W(1,79),GB1NJM,AMP(45))         
      CALL HIOXXX(W(1,51),W(1,14),GB2NIP,MBR,WBR,W(1,80))                                                          
      CALL IOSXXX(W(1,6),W(1,52),W(1,80),GB2NJM,AMP(46))         
      ...
      CALL FSICXX(W(1,84),W(1,17),GQLGOP,MGO,WGO,W(1,85))                                                          
      CALL HIOXXX(W(1,85),W(1,1),GB1GOP,MBL,WBL,W(1,86))                                                          
      CALL IOSXXX(W(1,6),W(1,52),W(1,86),GB1NJM,AMP(59))         
      CALL HIOXXX(W(1,85),W(1,1),GB2GOP,MBR,WBR,W(1,87))                                                          
      CALL IOSXXX(W(1,6),W(1,52),W(1,87),GB2NJM,AMP(60))         
      CALL FSICXX(W(1,84),W(1,19),GQRGOP,MGO,WGO,W(1,88))                                                          
      CALL HIOXXX(W(1,88),W(1,1),GB1GOP,MBL,WBL,W(1,89))                                                          
      CALL IOSXXX(W(1,6),W(1,52),W(1,89),GB1NJM,AMP(61))         
      CALL HIOXXX(W(1,88),W(1,1),GB2GOP,MBR,WBR,W(1,90))                                                          
      CALL IOSXXX(W(1,6),W(1,52),W(1,90),GB2NJM,AMP(62))         
      CALL FSICXX(W(1,84),W(1,59),GQLGOP,MGO,WGO,W(1,91))                                                          
      CALL HIOXXX(W(1,91),W(1,1),GB1GOP,MBL,WBL,W(1,92))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,92),GB1NIM,AMP(63))         
      CALL HIOXXX(W(1,91),W(1,1),GB2GOP,MBR,WBR,W(1,93))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,93),GB2NIM,AMP(64))         
      CALL FSICXX(W(1,84),W(1,61),GQRGOP,MGO,WGO,W(1,94))                                                          
      CALL HIOXXX(W(1,94),W(1,1),GB1GOP,MBL,WBL,W(1,95))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,95),GB1NIM,AMP(65))         
      CALL HIOXXX(W(1,94),W(1,1),GB2GOP,MBR,WBR,W(1,96))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,96),GB2NIM,AMP(66))         
     ...
     &             -AMP(  66)
      MATRIX_BXCX_NINJCXBX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_BXCX_NINJCXBX =MATRIX_BXCX_NINJCXBX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
