      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_SS_NINJSS(P1,NHEL(1,IHEL),JC(1))            
...
C ----------
      ...
      CALL HIOCXX(W(1,67),W(1,4),GDLNJP,MSL,WSL,W(1,71))                                                          
      CALL JSSXXX(W(1,71),W(1,7),GC,ZERO,ZERO,W(1,72))     
      CALL IOVXXX(W(1,1),W(1,68),W(1,72),GG,AMP(59))             
      CALL HIOCXX(W(1,67),W(1,4),GDRNJP,MSR,WSR,W(1,73))                                                          
      ...
      CALL HIOCXX(W(1,67),W(1,3),GDLNIP,MSL,WSL,W(1,83))                                                          
      CALL JSSXXX(W(1,83),W(1,23),GC,ZERO,ZERO,W(1,84))     
      CALL IOVXXX(W(1,2),W(1,68),W(1,84),GG,AMP(69))             
      CALL HIOCXX(W(1,67),W(1,3),GDRNIP,MSR,WSR,W(1,85))                                                          
      ...
      CALL HIOCXX(W(1,97),W(1,118),GQLGOM,MSL,WSL,W(1,125))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,125),GDLNJP,AMP(109))        
      CALL HIOCXX(W(1,97),W(1,118),GQRGOM,MSR,WSR,W(1,126))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,126),GDRNJP,AMP(110))        
      CALL HIOCXX(W(1,98),W(1,118),GQLGOM,MSL,WSL,W(1,127))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,127),GDLNJP,AMP(111))        
      CALL HIOCXX(W(1,98),W(1,118),GQRGOM,MSR,WSR,W(1,128))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,128),GDRNJP,AMP(112))        
      CALL HIOCXX(W(1,75),W(1,118),GQLGOM,MSL,WSL,W(1,129))                                                          
      CALL IOSCXX(W(1,6),W(1,3),W(1,129),GDLNIP,AMP(113))        
      CALL HIOCXX(W(1,75),W(1,118),GQRGOM,MSR,WSR,W(1,130))                                                          
      CALL IOSCXX(W(1,6),W(1,3),W(1,130),GDRNIP,AMP(114))        
      CALL HIOCXX(W(1,76),W(1,118),GQLGOM,MSL,WSL,W(1,131))                                                          
      CALL IOSCXX(W(1,6),W(1,3),W(1,131),GDLNIP,AMP(115))        
      CALL HIOCXX(W(1,76),W(1,118),GQRGOM,MSR,WSR,W(1,132))                                                          
