      SUBROUTINE SMATRIX_DSX_NINJDSX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_dsx_nInJdsx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_DSX_NINJDSX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_DSX_NINJDSX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOCXX(W(1,5),W(1,4),GDLNJP,MDL,WDL,W(1,21))                                                          
      ...
      CALL HIOCXX(W(1,5),W(1,4),GDRNJP,MDR,WDR,W(1,25))                                                          
      ...
      CALL FSOCXX(W(1,4),W(1,35),GDLNJP,ZERO,ZERO,W(1,36))                                                          
      ...
      CALL FSOCXX(W(1,4),W(1,38),GDRNJP,ZERO,ZERO,W(1,39))                                                          
     ...
     &             +AMP(  56)+AMP(  57)+AMP(  58)+AMP(  59)+AMP(  60)
      MATRIX_DSX_NINJDSX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_DSX_NINJDSX =MATRIX_DSX_NINJDSX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
