      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_CXCX_NINJCXCX(P1,NHEL(1,IHEL),JC(1))            
...
C ----------
      ...
      CALL HIOCXX(W(1,118),W(1,43),GQLGOP,MCL,WCL,W(1,125))                                                          
      CALL IOSXXX(W(1,6),W(1,68),W(1,125),GULNJM,AMP(109))         
      CALL HIOCXX(W(1,118),W(1,43),GQRGOP,MCR,WCR,W(1,126))                                                          
      CALL IOSXXX(W(1,6),W(1,68),W(1,126),GURNJM,AMP(110))         
      CALL HIOCXX(W(1,118),W(1,44),GQLGOP,MCL,WCL,W(1,127))                                                          
      CALL IOSXXX(W(1,6),W(1,68),W(1,127),GULNJM,AMP(111))         
      CALL HIOCXX(W(1,118),W(1,44),GQRGOP,MCR,WCR,W(1,128))                                                          
      CALL IOSXXX(W(1,6),W(1,68),W(1,128),GURNJM,AMP(112))         
      CALL HIOCXX(W(1,118),W(1,79),GQLGOP,MCL,WCL,W(1,129))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,129),GULNIM,AMP(113))         
      CALL HIOCXX(W(1,118),W(1,79),GQRGOP,MCR,WCR,W(1,130))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,130),GURNIM,AMP(114))         
      CALL HIOCXX(W(1,118),W(1,80),GQLGOP,MCL,WCL,W(1,131))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,131),GULNIM,AMP(115))         
      CALL HIOCXX(W(1,118),W(1,80),GQRGOP,MCR,WCR,W(1,132))                                                          
