      SUBROUTINE SMATRIX_BXDX_NINJDXBX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_bxdx_nInJdxbx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_BXDX_NINJDXBX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_BXDX_NINJDXBX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,51),W(1,2),GDLNIP,MDL,WDL,W(1,53))                                                          
      ...
      CALL HIOXXX(W(1,51),W(1,2),GDRNIP,MDR,WDR,W(1,56))                                                          
      ...
      CALL HIOXXX(W(1,5),W(1,52),GDLNJM,MDL,WDL,W(1,59))                                                          
      CALL JSSXXX(W(1,53),W(1,59),GC,ZERO,ZERO,W(1,60))     
      CALL IOVXXX(W(1,6),W(1,1),W(1,60),GG,AMP(33))             
      CALL HIOXXX(W(1,5),W(1,52),GDRNJM,MDR,WDR,W(1,61))                                                          
     ...
     &             -AMP(  66)
      MATRIX_BXDX_NINJDXBX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_BXDX_NINJDXBX =MATRIX_BXDX_NINJDXBX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
