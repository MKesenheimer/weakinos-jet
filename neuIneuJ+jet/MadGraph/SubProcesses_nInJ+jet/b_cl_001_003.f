...
C  
C BORN AMPLITUDE IS d~ d -> n1 n2 g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      CALL HIOXXX(W(1,4),W(1,1),GDLNJP,MDL,WDL,W(1,10))                                                          
      CALL FVIXXX(W(1,2),W(1,5),GG,ZERO,ZERO,W(1,11))     
      CALL IOSXXX(W(1,11),W(1,3),W(1,10),GDLNIM,AMP(3))         
      CALL HIOXXX(W(1,4),W(1,1),GDRNJP,MDR,WDR,W(1,12))                                                          
      CALL IOSXXX(W(1,11),W(1,3),W(1,12),GDRNIM,AMP(4))         
      ...
      CALL HIOXXX(W(1,2),W(1,16),GDLNJM,MDL,WDL,W(1,17))                                                          
      CALL IOSXXX(W(1,15),W(1,14),W(1,17),GDLNIP,AMP(9))         
      CALL HIOXXX(W(1,2),W(1,16),GDRNJM,MDR,WDR,W(1,18))                                                          
      CALL IOSXXX(W(1,15),W(1,14),W(1,18),GDRNIP,AMP(10))         
      CALL HIOXXX(W(1,15),W(1,1),GDLNIP,MDL,WDL,W(1,19))                                                          
      CALL FSOXXX(W(1,16),W(1,19),GDLNJM,ZERO,ZERO,W(1,20))                                                          
      CALL IOVXXX(W(1,2),W(1,20),W(1,5),GG,AMP(11))             
      CALL HIOXXX(W(1,15),W(1,1),GDRNIP,MDR,WDR,W(1,21))                                                          
      CALL FSOXXX(W(1,16),W(1,21),GDRNJM,ZERO,ZERO,W(1,22))                                                          
