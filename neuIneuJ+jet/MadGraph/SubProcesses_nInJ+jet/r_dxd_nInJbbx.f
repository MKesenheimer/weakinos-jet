      SUBROUTINE SMATRIX_DXD_NINJBBX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_dxd_nInJbbx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_DXD_NINJBBX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_DXD_NINJBBX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,75),W(1,1),GDLNIP,MDL,WDL,W(1,80))                                                          
      ...
      CALL HIOXXX(W(1,75),W(1,1),GDRNIP,MDR,WDR,W(1,83))                                                          
     ...
     &             -AMP(  66)
      MATRIX_DXD_NINJBBX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_DXD_NINJBBX =MATRIX_DXD_NINJBBX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
