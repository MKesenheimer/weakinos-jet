      SUBROUTINE SMATRIX_SSX_NINJSSX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_ssx_nInJssx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_SSX_NINJSSX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_SSX_NINJSSX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FSOCXX(W(1,3),W(1,7),GDLNIP,ZERO,ZERO,W(1,8))                                                          
      ...
      CALL FSOXXX(W(1,4),W(1,13),GDLNJM,ZERO,ZERO,W(1,19))                                                          
      CALL JIOXXX(W(1,1),W(1,19),GG,ZERO,ZERO,W(1,20))     
      CALL IOVXXX(W(1,6),W(1,2),W(1,20),GG,AMP(9))             
      CALL FSOXXX(W(1,4),W(1,15),GDRNJM,ZERO,ZERO,W(1,21))                                                          
      CALL JIOXXX(W(1,1),W(1,21),GG,ZERO,ZERO,W(1,22))     
      CALL IOVXXX(W(1,6),W(1,2),W(1,22),GG,AMP(10))             
      CALL HIOCXX(W(1,5),W(1,17),GQLGOP,MSL,WSL,W(1,23))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,23),GDLNIM,AMP(11))         
      CALL HIOCXX(W(1,5),W(1,17),GQRGOP,MSR,WSR,W(1,24))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,24),GDRNIM,AMP(12))         
      CALL HIOCXX(W(1,5),W(1,18),GQLGOP,MSL,WSL,W(1,25))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,25),GDLNIM,AMP(13))         
      CALL HIOCXX(W(1,5),W(1,18),GQRGOP,MSR,WSR,W(1,26))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,26),GDRNIM,AMP(14))         
      CALL FSICXX(W(1,5),W(1,7),GQLGOP,MGO,WGO,W(1,27))                                                          
      CALL HIOXXX(W(1,27),W(1,2),GQLGOP,MSL,WSL,W(1,28))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,28),GDLNIM,AMP(15))         
      CALL HIOXXX(W(1,27),W(1,2),GQRGOP,MSR,WSR,W(1,29))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,29),GDRNIM,AMP(16))         
      CALL FSICXX(W(1,5),W(1,10),GQRGOP,MGO,WGO,W(1,30))                                                          
      CALL HIOXXX(W(1,30),W(1,2),GQLGOP,MSL,WSL,W(1,31))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,31),GDLNIM,AMP(17))         
      CALL HIOXXX(W(1,30),W(1,2),GQRGOP,MSR,WSR,W(1,32))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,32),GDRNIM,AMP(18))         
      CALL HIOCXX(W(1,5),W(1,4),GDLNJP,MSL,WSL,W(1,33))                                                          
      CALL FSIXXX(W(1,1),W(1,33),GQLGOM,MGO,WGO,W(1,34))                                                          
      CALL HIOXXX(W(1,34),W(1,2),GQLGOP,MSL,WSL,W(1,35))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,35),GDLNIM,AMP(19))         
      CALL HIOXXX(W(1,34),W(1,2),GQRGOP,MSR,WSR,W(1,36))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,36),GDRNIM,AMP(20))         
      CALL HIOCXX(W(1,5),W(1,4),GDRNJP,MSR,WSR,W(1,37))                                                          
      CALL FSIXXX(W(1,1),W(1,37),GQRGOM,MGO,WGO,W(1,38))                                                          
      CALL HIOXXX(W(1,38),W(1,2),GQLGOP,MSL,WSL,W(1,39))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,39),GDLNIM,AMP(21))         
      CALL HIOXXX(W(1,38),W(1,2),GQRGOP,MSR,WSR,W(1,40))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,40),GDRNIM,AMP(22))         
      CALL JIOXXX(W(1,1),W(1,2),GG,ZERO,ZERO,W(1,41))     
      CALL HVSXXX(W(1,41),W(1,33),GC,MSL,WSL,W(1,42))     
      CALL IOSXXX(W(1,6),W(1,3),W(1,42),GDLNIM,AMP(23))         
      CALL HVSXXX(W(1,41),W(1,37),GC,MSR,WSR,W(1,43))     
      CALL IOSXXX(W(1,6),W(1,3),W(1,43),GDRNIM,AMP(24))         
      CALL FSOXXX(W(1,3),W(1,33),GDLNIM,ZERO,ZERO,W(1,44))                                                          
      CALL IOVXXX(W(1,6),W(1,44),W(1,41),GG,AMP(25))             
      CALL FSOXXX(W(1,3),W(1,37),GDRNIM,ZERO,ZERO,W(1,45))                                                          
      CALL IOVXXX(W(1,6),W(1,45),W(1,41),GG,AMP(26))             
      CALL FVICXX(W(1,5),W(1,41),GG,ZERO,ZERO,W(1,46))    
      CALL HIOCXX(W(1,46),W(1,4),GDLNJP,MSL,WSL,W(1,47))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,47),GDLNIM,AMP(27))         
      CALL HIOCXX(W(1,46),W(1,4),GDRNJP,MSR,WSR,W(1,48))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,48),GDRNIM,AMP(28))         
      CALL HIOXXX(W(1,1),W(1,3),GDLNIM,MSL,WSL,W(1,49))                                                          
      CALL FSOCXX(W(1,4),W(1,49),GDLNJP,ZERO,ZERO,W(1,50))                                                          
      CALL JIOCXX(W(1,5),W(1,50),GG,ZERO,ZERO,W(1,51))    
      CALL IOVXXX(W(1,6),W(1,2),W(1,51),GG,AMP(29))             
      CALL HIOXXX(W(1,1),W(1,3),GDRNIM,MSR,WSR,W(1,52))                                                          
      CALL FSOCXX(W(1,4),W(1,52),GDRNJP,ZERO,ZERO,W(1,53))                                                          
      ...
      CALL HIOXXX(W(1,61),W(1,2),GQLGOP,MSL,WSL,W(1,62))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,62),GDLNJM,AMP(39))         
      CALL HIOXXX(W(1,61),W(1,2),GQRGOP,MSR,WSR,W(1,63))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,63),GDRNJM,AMP(40))         
      CALL FSIXXX(W(1,1),W(1,15),GQRGOM,MGO,WGO,W(1,64))                                                          
      CALL HIOXXX(W(1,64),W(1,2),GQLGOP,MSL,WSL,W(1,65))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,65),GDLNJM,AMP(41))         
      CALL HIOXXX(W(1,64),W(1,2),GQRGOP,MSR,WSR,W(1,66))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,66),GDRNJM,AMP(42))         
      CALL HVSXXX(W(1,41),W(1,13),GC,MSL,WSL,W(1,67))     
      CALL IOSXXX(W(1,6),W(1,4),W(1,67),GDLNJM,AMP(43))         
      CALL HVSXXX(W(1,41),W(1,15),GC,MSR,WSR,W(1,68))     
      CALL IOSXXX(W(1,6),W(1,4),W(1,68),GDRNJM,AMP(44))         
      CALL IOVXXX(W(1,6),W(1,19),W(1,41),GG,AMP(45))             
      CALL IOVXXX(W(1,6),W(1,21),W(1,41),GG,AMP(46))             
      CALL HIOCXX(W(1,46),W(1,3),GDLNIP,MSL,WSL,W(1,69))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,69),GDLNJM,AMP(47))         
      CALL HIOCXX(W(1,46),W(1,3),GDRNIP,MSR,WSR,W(1,70))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,70),GDRNJM,AMP(48))         
      CALL HIOCXX(W(1,5),W(1,57),GQLGOP,MSL,WSL,W(1,71))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,71),GDLNJM,AMP(49))         
      CALL HIOCXX(W(1,5),W(1,57),GQRGOP,MSR,WSR,W(1,72))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,72),GDRNJM,AMP(50))         
      CALL HIOCXX(W(1,5),W(1,58),GQLGOP,MSL,WSL,W(1,73))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,73),GDLNJM,AMP(51))         
      CALL HIOCXX(W(1,5),W(1,58),GQRGOP,MSR,WSR,W(1,74))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,74),GDRNJM,AMP(52))         
      CALL FSICXX(W(1,5),W(1,49),GQLGOP,MGO,WGO,W(1,75))                                                          
      CALL HIOXXX(W(1,75),W(1,2),GQLGOP,MSL,WSL,W(1,76))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,76),GDLNJM,AMP(53))         
      CALL HIOXXX(W(1,75),W(1,2),GQRGOP,MSR,WSR,W(1,77))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,77),GDRNJM,AMP(54))         
      CALL FSICXX(W(1,5),W(1,52),GQRGOP,MGO,WGO,W(1,78))                                                          
      CALL HIOXXX(W(1,78),W(1,2),GQLGOP,MSL,WSL,W(1,79))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,79),GDLNJM,AMP(55))         
      CALL HIOXXX(W(1,78),W(1,2),GQRGOP,MSR,WSR,W(1,80))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,80),GDRNJM,AMP(56))         
      CALL IXXXXX(P(0,4),MNJ,NHEL(4),-1*IC(4),W(1,81))         
      CALL OXXXXX(P(0,5),ZERO,NHEL(5),+1*IC(5),W(1,82))        
      CALL HIOXXX(W(1,81),W(1,2),GDLNJP,MSL,WSL,W(1,83))                                                          
      CALL JIOXXX(W(1,1),W(1,82),GG,ZERO,ZERO,W(1,84))     
      CALL HVSXXX(W(1,84),W(1,83),GC,MSL,WSL,W(1,85))     
      CALL IOSXXX(W(1,6),W(1,3),W(1,85),GDLNIM,AMP(57))         
      CALL HIOXXX(W(1,81),W(1,2),GDRNJP,MSR,WSR,W(1,86))                                                          
      CALL HVSXXX(W(1,84),W(1,86),GC,MSR,WSR,W(1,87))     
      CALL IOSXXX(W(1,6),W(1,3),W(1,87),GDRNIM,AMP(58))         
      CALL FSOXXX(W(1,3),W(1,83),GDLNIM,ZERO,ZERO,W(1,88))                                                          
      CALL IOVXXX(W(1,6),W(1,88),W(1,84),GG,AMP(59))             
      CALL FSOXXX(W(1,3),W(1,86),GDRNIM,ZERO,ZERO,W(1,89))                                                          
      CALL IOVXXX(W(1,6),W(1,89),W(1,84),GG,AMP(60))             
      CALL FSIXXX(W(1,1),W(1,83),GQLGOM,MGO,WGO,W(1,90))                                                          
      CALL HIOXXX(W(1,90),W(1,82),GQLGOP,MSL,WSL,W(1,91))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,91),GDLNIM,AMP(61))         
      CALL HIOXXX(W(1,90),W(1,82),GQRGOP,MSR,WSR,W(1,92))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,92),GDRNIM,AMP(62))         
      CALL FSIXXX(W(1,1),W(1,86),GQRGOM,MGO,WGO,W(1,93))                                                          
      CALL HIOXXX(W(1,93),W(1,82),GQLGOP,MSL,WSL,W(1,94))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,94),GDLNIM,AMP(63))         
      CALL HIOXXX(W(1,93),W(1,82),GQRGOP,MSR,WSR,W(1,95))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,95),GDRNIM,AMP(64))         
      CALL FVOXXX(W(1,2),W(1,84),GG,ZERO,ZERO,W(1,96))     
      CALL HIOXXX(W(1,81),W(1,96),GDLNJP,MSL,WSL,W(1,97))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,97),GDLNIM,AMP(65))         
      CALL HIOXXX(W(1,81),W(1,96),GDRNJP,MSR,WSR,W(1,98))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,98),GDRNIM,AMP(66))         
      ...
      CALL FSIXXX(W(1,81),W(1,49),GDLNJP,ZERO,ZERO,W(1,101))                                                          
      CALL JIOXXX(W(1,101),W(1,2),GG,ZERO,ZERO,W(1,102))     
      CALL IOVXXX(W(1,6),W(1,82),W(1,102),GG,AMP(69))             
      CALL FSIXXX(W(1,81),W(1,52),GDRNJP,ZERO,ZERO,W(1,103))                                                          
      ...
      CALL HIOXXX(W(1,119),W(1,2),GDLNIP,MSL,WSL,W(1,120))                                                          
      CALL HVSXXX(W(1,84),W(1,120),GC,MSL,WSL,W(1,121))     
      CALL IOSXXX(W(1,6),W(1,4),W(1,121),GDLNJM,AMP(93))         
      CALL HIOXXX(W(1,119),W(1,2),GDRNIP,MSR,WSR,W(1,122))                                                          
      CALL HVSXXX(W(1,84),W(1,122),GC,MSR,WSR,W(1,123))     
      CALL IOSXXX(W(1,6),W(1,4),W(1,123),GDRNJM,AMP(94))         
      CALL FSOXXX(W(1,4),W(1,120),GDLNJM,ZERO,ZERO,W(1,124))                                                          
      CALL IOVXXX(W(1,6),W(1,124),W(1,84),GG,AMP(95))             
      CALL FSOXXX(W(1,4),W(1,122),GDRNJM,ZERO,ZERO,W(1,125))                                                          
      CALL IOVXXX(W(1,6),W(1,125),W(1,84),GG,AMP(96))             
      CALL FSIXXX(W(1,1),W(1,120),GQLGOM,MGO,WGO,W(1,126))                                                          
      CALL HIOXXX(W(1,126),W(1,82),GQLGOP,MSL,WSL,W(1,127))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,127),GDLNJM,AMP(97))         
      CALL HIOXXX(W(1,126),W(1,82),GQRGOP,MSR,WSR,W(1,128))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,128),GDRNJM,AMP(98))         
      CALL FSIXXX(W(1,1),W(1,122),GQRGOM,MGO,WGO,W(1,129))                                                          
      CALL HIOXXX(W(1,129),W(1,82),GQLGOP,MSL,WSL,W(1,130))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,130),GDLNJM,AMP(99))         
      CALL HIOXXX(W(1,129),W(1,82),GQRGOP,MSR,WSR,W(1,131))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,131),GDRNJM,AMP(100))         
      CALL HIOXXX(W(1,119),W(1,96),GDLNIP,MSL,WSL,W(1,132))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,132),GDLNJM,AMP(101))         
      CALL HIOXXX(W(1,119),W(1,96),GDRNIP,MSR,WSR,W(1,133))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,133),GDRNJM,AMP(102))         
      ...
      CALL FSIXXX(W(1,119),W(1,7),GDLNIP,ZERO,ZERO,W(1,136))                                                          
      CALL JIOXXX(W(1,136),W(1,2),GG,ZERO,ZERO,W(1,137))     
      CALL IOVXXX(W(1,6),W(1,82),W(1,137),GG,AMP(105))             
      CALL FSIXXX(W(1,119),W(1,10),GDRNIP,ZERO,ZERO,W(1,138))                                                          
     ...
     &             +AMP( 108)+AMP( 117)+AMP( 118)+AMP( 119)+AMP( 120)
      MATRIX_SSX_NINJSSX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_SSX_NINJSSX =MATRIX_SSX_NINJSSX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
