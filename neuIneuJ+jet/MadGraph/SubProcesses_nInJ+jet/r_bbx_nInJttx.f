      SUBROUTINE SMATRIX_BBX_NINJTTX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_bbx_nInJttx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_BBX_NINJTTX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_BBX_NINJTTX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOSCXX(W(1,55),W(1,86),W(1,15),GT1GOM,AMP(55))        
      CALL IOSCXX(W(1,55),W(1,86),W(1,16),GT2GOM,AMP(56))        
      CALL IOSCXX(W(1,58),W(1,86),W(1,15),GT1GOM,AMP(57))        
      CALL IOSCXX(W(1,58),W(1,86),W(1,16),GT2GOM,AMP(58))        
      CALL IXXXXX(P(0,3),MNI,NHEL(3),-1*IC(3),W(1,87))         
      CALL HIOXXX(W(1,87),W(1,2),GB1NIP,MBL,WBL,W(1,88))                                                          
      CALL FSOXXX(W(1,4),W(1,88),GB1NJM,BMASS,ZERO,W(1,89))                                                          
      CALL JIOXXX(W(1,1),W(1,89),GG,ZERO,ZERO,W(1,90))     
      CALL IOVXXX(W(1,6),W(1,42),W(1,90),GG,AMP(59))             
      CALL HIOXXX(W(1,87),W(1,2),GB2NIP,MBR,WBR,W(1,91))                                                          
      CALL FSOXXX(W(1,4),W(1,91),GB2NJM,BMASS,ZERO,W(1,92))                                                          
      CALL JIOXXX(W(1,1),W(1,92),GG,ZERO,ZERO,W(1,93))     
      CALL IOVXXX(W(1,6),W(1,42),W(1,93),GG,AMP(60))             
      CALL FSIXXX(W(1,87),W(1,7),GB1NIP,BMASS,ZERO,W(1,94))                                                          
      CALL JIOXXX(W(1,94),W(1,2),GG,ZERO,ZERO,W(1,95))     
      CALL IOVXXX(W(1,6),W(1,42),W(1,95),GG,AMP(61))             
      CALL FSIXXX(W(1,87),W(1,11),GB2NIP,BMASS,ZERO,W(1,96))                                                          
      CALL JIOXXX(W(1,96),W(1,2),GG,ZERO,ZERO,W(1,97))     
      CALL IOVXXX(W(1,6),W(1,42),W(1,97),GG,AMP(62))             
      CALL JSSXXX(W(1,88),W(1,7),GC,ZERO,ZERO,W(1,98))     
      CALL IOVXXX(W(1,6),W(1,42),W(1,98),GG,AMP(63))             
      CALL JSSXXX(W(1,91),W(1,11),GC,ZERO,ZERO,W(1,99))     
      CALL IOVXXX(W(1,6),W(1,42),W(1,99),GG,AMP(64))             
      CALL FSIXXX(W(1,1),W(1,88),GB1GOM,MGO,WGO,W(1,100))                                                          
      ...
      CALL FSIXXX(W(1,1),W(1,91),GB2GOM,MGO,WGO,W(1,103))                                                          
      ...
      CALL IOSCXX(W(1,100),W(1,86),W(1,25),GT1GOM,AMP(69))        
      CALL IOSCXX(W(1,100),W(1,86),W(1,26),GT2GOM,AMP(70))        
      CALL IOSCXX(W(1,103),W(1,86),W(1,25),GT1GOM,AMP(71))        
      CALL IOSCXX(W(1,103),W(1,86),W(1,26),GT2GOM,AMP(72))        
     ...
     &             +AMP(  71)+AMP(  72)
      MATRIX_BBX_NINJTTX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_BBX_NINJTTX =MATRIX_BBX_NINJTTX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
