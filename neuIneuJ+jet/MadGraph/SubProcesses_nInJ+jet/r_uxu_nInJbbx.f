      SUBROUTINE SMATRIX_UXU_NINJBBX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_uxu_nInJbbx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_UXU_NINJBBX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_UXU_NINJBBX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,2),W(1,3),GURNIM,MUR,WUR,W(1,11))                                                          
      ...
      CALL HIOXXX(W(1,2),W(1,4),GULNJM,MUL,WUL,W(1,17))                                                          
      ...
      CALL HIOXXX(W(1,2),W(1,4),GURNJM,MUR,WUR,W(1,21))                                                          
      ...
      CALL HIOXXX(W(1,41),W(1,1),GULNJP,MUL,WUL,W(1,47))                                                          
      ...
      CALL HIOXXX(W(1,41),W(1,1),GURNJP,MUR,WUR,W(1,50))                                                          
      ...
      CALL HIOXXX(W(1,75),W(1,1),GULNIP,MUL,WUL,W(1,80))                                                          
      ...
      CALL HIOXXX(W(1,75),W(1,1),GURNIP,MUR,WUR,W(1,83))                                                          
     ...
     &             -AMP(  66)
      MATRIX_UXU_NINJBBX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_UXU_NINJBBX =MATRIX_UXU_NINJBBX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
