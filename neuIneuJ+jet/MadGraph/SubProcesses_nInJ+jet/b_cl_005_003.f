...
C  
C BORN AMPLITUDE IS u~ u -> n1 n2 g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      CALL HIOXXX(W(1,4),W(1,1),GULNJP,MUL,WUL,W(1,10))                                                          
      CALL FVIXXX(W(1,2),W(1,5),GG,ZERO,ZERO,W(1,11))     
      CALL IOSXXX(W(1,11),W(1,3),W(1,10),GULNIM,AMP(3))         
      CALL HIOXXX(W(1,4),W(1,1),GURNJP,MUR,WUR,W(1,12))                                                          
      CALL IOSXXX(W(1,11),W(1,3),W(1,12),GURNIM,AMP(4))         
      CALL VSSXXX(W(1,5),W(1,10),W(1,6),GC,AMP(5))             
      CALL VSSXXX(W(1,5),W(1,12),W(1,8),GC,AMP(6))             
      CALL JIOCXX(W(1,4),W(1,3),GZNIJ,ZMASS,ZWIDTH,W(1,13))                                                          
      ...
      CALL HIOXXX(W(1,2),W(1,16),GULNJM,MUL,WUL,W(1,17))                                                          
      CALL IOSXXX(W(1,15),W(1,14),W(1,17),GULNIP,AMP(9))         
      CALL HIOXXX(W(1,2),W(1,16),GURNJM,MUR,WUR,W(1,18))                                                          
      CALL IOSXXX(W(1,15),W(1,14),W(1,18),GURNIP,AMP(10))         
      CALL HIOXXX(W(1,15),W(1,1),GULNIP,MUL,WUL,W(1,19))                                                          
      CALL FSOXXX(W(1,16),W(1,19),GULNJM,ZERO,ZERO,W(1,20))                                                          
      CALL IOVXXX(W(1,2),W(1,20),W(1,5),GG,AMP(11))             
      CALL HIOXXX(W(1,15),W(1,1),GURNIP,MUR,WUR,W(1,21))                                                          
      CALL FSOXXX(W(1,16),W(1,21),GURNJM,ZERO,ZERO,W(1,22))                                                          
