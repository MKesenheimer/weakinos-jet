      SUBROUTINE SMATRIX_DUX_NINJDUX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_dux_nInJdux/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_DUX_NINJDUX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_DUX_NINJDUX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,32),W(1,2),GQLGOP,MUL,WUL,W(1,33))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,33),GULNIM,AMP(13))         
      CALL HIOXXX(W(1,32),W(1,2),GQRGOP,MUR,WUR,W(1,34))                                                          
      ...
      CALL HIOXXX(W(1,59),W(1,2),GULNJP,MUL,WUL,W(1,61))                                                          
      ...
      CALL HIOXXX(W(1,59),W(1,2),GURNJP,MUR,WUR,W(1,64))                                                          
      ...
      CALL HIOXXX(W(1,80),W(1,2),GULNIP,MUL,WUL,W(1,81))                                                          
      CALL HVSXXX(W(1,62),W(1,81),GC,MUL,WUL,W(1,82))     
      CALL IOSXXX(W(1,6),W(1,4),W(1,82),GULNJM,AMP(47))         
      CALL HIOXXX(W(1,80),W(1,2),GURNIP,MUR,WUR,W(1,83))                                                          
     ...
     &             +AMP(  56)+AMP(  57)+AMP(  58)+AMP(  59)+AMP(  60)
      MATRIX_DUX_NINJDUX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_DUX_NINJDUX =MATRIX_DUX_NINJDUX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
