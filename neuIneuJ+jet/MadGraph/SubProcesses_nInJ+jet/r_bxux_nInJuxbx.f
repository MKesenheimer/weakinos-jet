      SUBROUTINE SMATRIX_BXUX_NINJUXBX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_bxux_nInJuxbx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_BXUX_NINJUXBX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_BXUX_NINJUXBX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,51),W(1,2),GULNIP,MUL,WUL,W(1,53))                                                          
      ...
      CALL HIOXXX(W(1,51),W(1,2),GURNIP,MUR,WUR,W(1,56))                                                          
      ...
      CALL HIOXXX(W(1,5),W(1,52),GULNJM,MUL,WUL,W(1,59))                                                          
      CALL JSSXXX(W(1,53),W(1,59),GC,ZERO,ZERO,W(1,60))     
      CALL IOVXXX(W(1,6),W(1,1),W(1,60),GG,AMP(33))             
      CALL HIOXXX(W(1,5),W(1,52),GURNJM,MUR,WUR,W(1,61))                                                          
     ...
     &             -AMP(  66)
      MATRIX_BXUX_NINJUXBX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_BXUX_NINJUXBX =MATRIX_BXUX_NINJUXBX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
