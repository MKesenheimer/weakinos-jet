...
C ----------
      ...
      CALL HIOXXX(W(1,4),W(1,2),GDLNJP,MDL,WDL,W(1,6))                                                          
      CALL FVIXXX(W(1,1),W(1,5),GG,ZERO,ZERO,W(1,7))     
      CALL IOSXXX(W(1,7),W(1,3),W(1,6),GDLNIM,AMP(1))         
      CALL HIOXXX(W(1,4),W(1,2),GDRNJP,MDR,WDR,W(1,8))                                                          
      CALL IOSXXX(W(1,7),W(1,3),W(1,8),GDRNIM,AMP(2))         
      CALL HIOXXX(W(1,1),W(1,3),GDLNIM,MDL,WDL,W(1,9))                                                          
      CALL FSIXXX(W(1,4),W(1,9),GDLNJP,ZERO,ZERO,W(1,10))                                                          
      CALL IOVXXX(W(1,10),W(1,2),W(1,5),GG,AMP(3))             
      CALL HIOXXX(W(1,1),W(1,3),GDRNIM,MDR,WDR,W(1,11))                                                          
      CALL FSIXXX(W(1,4),W(1,11),GDRNJP,ZERO,ZERO,W(1,12))                                                          
      ...
      CALL HIOXXX(W(1,15),W(1,2),GDLNIP,MDL,WDL,W(1,17))                                                          
      CALL FSOXXX(W(1,16),W(1,17),GDLNJM,ZERO,ZERO,W(1,18))                                                          
      CALL IOVXXX(W(1,1),W(1,18),W(1,5),GG,AMP(9))             
      CALL HIOXXX(W(1,15),W(1,2),GDRNIP,MDR,WDR,W(1,19))                                                          
      CALL FSOXXX(W(1,16),W(1,19),GDRNJM,ZERO,ZERO,W(1,20))                                                          
      CALL IOVXXX(W(1,1),W(1,20),W(1,5),GG,AMP(10))             
      CALL HIOXXX(W(1,1),W(1,16),GDLNJM,MDL,WDL,W(1,21))                                                          
      CALL IOSXXX(W(1,15),W(1,14),W(1,21),GDLNIP,AMP(11))         
      CALL HIOXXX(W(1,1),W(1,16),GDRNJM,MDR,WDR,W(1,22))                                                          
      CALL IOSXXX(W(1,15),W(1,14),W(1,22),GDRNIP,AMP(12))         
