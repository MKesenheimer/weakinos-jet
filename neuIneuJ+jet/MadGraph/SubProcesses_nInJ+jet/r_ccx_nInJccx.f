      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_CCX_NINJCCX(P1,NHEL(1,IHEL),JC(1))            
...
C ----------
      ...
      CALL HIOCXX(W(1,5),W(1,17),GQLGOP,MCL,WCL,W(1,23))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,23),GULNIM,AMP(11))         
      CALL HIOCXX(W(1,5),W(1,17),GQRGOP,MCR,WCR,W(1,24))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,24),GURNIM,AMP(12))         
      CALL HIOCXX(W(1,5),W(1,18),GQLGOP,MCL,WCL,W(1,25))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,25),GULNIM,AMP(13))         
      CALL HIOCXX(W(1,5),W(1,18),GQRGOP,MCR,WCR,W(1,26))                                                          
      ...
      CALL HIOCXX(W(1,5),W(1,4),GULNJP,MCL,WCL,W(1,33))                                                          
      ...
      CALL HIOCXX(W(1,5),W(1,4),GURNJP,MCR,WCR,W(1,37))                                                          
      ...
      CALL HIOCXX(W(1,46),W(1,4),GULNJP,MCL,WCL,W(1,47))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,47),GULNIM,AMP(27))         
      CALL HIOCXX(W(1,46),W(1,4),GURNJP,MCR,WCR,W(1,48))                                                          
      ...
      CALL HIOCXX(W(1,46),W(1,3),GULNIP,MCL,WCL,W(1,69))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,69),GULNJM,AMP(47))         
      CALL HIOCXX(W(1,46),W(1,3),GURNIP,MCR,WCR,W(1,70))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,70),GURNJM,AMP(48))         
      CALL HIOCXX(W(1,5),W(1,57),GQLGOP,MCL,WCL,W(1,71))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,71),GULNJM,AMP(49))         
      CALL HIOCXX(W(1,5),W(1,57),GQRGOP,MCR,WCR,W(1,72))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,72),GURNJM,AMP(50))         
      CALL HIOCXX(W(1,5),W(1,58),GQLGOP,MCL,WCL,W(1,73))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,73),GULNJM,AMP(51))         
      CALL HIOCXX(W(1,5),W(1,58),GQRGOP,MCR,WCR,W(1,74))                                                          
