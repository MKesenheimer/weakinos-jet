      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_CXC_NINJCCX(P1,NHEL(1,IHEL),JC(1))            
...
C ----------
      ...
      CALL HIOCXX(W(1,5),W(1,4),GULNJP,MCL,WCL,W(1,13))                                                          
      CALL JSSXXX(W(1,13),W(1,7),GC,ZERO,ZERO,W(1,14))     
      CALL IOVXXX(W(1,6),W(1,1),W(1,14),GG,AMP(3))             
      CALL HIOCXX(W(1,5),W(1,4),GURNJP,MCR,WCR,W(1,15))                                                          
      ...
      CALL HIOCXX(W(1,5),W(1,3),GULNIP,MCL,WCL,W(1,23))                                                          
      ...
      CALL HIOCXX(W(1,5),W(1,3),GURNIP,MCR,WCR,W(1,27))                                                          
      ...
      CALL HIOCXX(W(1,36),W(1,3),GULNIP,MCL,WCL,W(1,37))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,37),GULNJM,AMP(19))         
      CALL HIOCXX(W(1,36),W(1,3),GURNIP,MCR,WCR,W(1,38))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,38),GURNJM,AMP(20))         
      CALL HIOCXX(W(1,5),W(1,17),GQLGOP,MCL,WCL,W(1,39))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,39),GULNJM,AMP(21))         
      CALL HIOCXX(W(1,5),W(1,17),GQRGOP,MCR,WCR,W(1,40))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,40),GURNJM,AMP(22))         
      CALL HIOCXX(W(1,5),W(1,18),GQLGOP,MCL,WCL,W(1,41))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,41),GULNJM,AMP(23))         
      CALL HIOCXX(W(1,5),W(1,18),GQRGOP,MCR,WCR,W(1,42))                                                          
      ...
      CALL FSOCXX(W(1,3),W(1,49),GULNIP,ZERO,ZERO,W(1,50))                                                          
      ...
      CALL FSOCXX(W(1,3),W(1,52),GURNIP,ZERO,ZERO,W(1,53))                                                          
      ...
      CALL HIOCXX(W(1,5),W(1,57),GQLGOP,MCL,WCL,W(1,61))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,61),GULNIM,AMP(39))         
      CALL HIOCXX(W(1,5),W(1,57),GQRGOP,MCR,WCR,W(1,62))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,62),GURNIM,AMP(40))         
      CALL HIOCXX(W(1,5),W(1,58),GQLGOP,MCL,WCL,W(1,63))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,63),GULNIM,AMP(41))         
      CALL HIOCXX(W(1,5),W(1,58),GQRGOP,MCR,WCR,W(1,64))                                                          
      ...
      CALL HIOCXX(W(1,36),W(1,4),GULNJP,MCL,WCL,W(1,79))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,79),GULNIM,AMP(55))         
      CALL HIOCXX(W(1,36),W(1,4),GURNJP,MCR,WCR,W(1,80))                                                          
