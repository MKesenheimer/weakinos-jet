      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_BXB_NINJDDX(P1,NHEL(1,IHEL),JC(1))            
...
C ----------
      ...
      CALL HIOCXX(W(1,5),W(1,4),GDLNJP,MDL,WDL,W(1,15))                                                          
      CALL IOSXXX(W(1,6),W(1,8),W(1,15),GQLGOM,AMP(5))         
      CALL HIOCXX(W(1,5),W(1,4),GDRNJP,MDR,WDR,W(1,16))                                                          
      ...
      CALL HIOCXX(W(1,5),W(1,3),GDLNIP,MDL,WDL,W(1,25))                                                          
      CALL IOSXXX(W(1,6),W(1,18),W(1,25),GQLGOM,AMP(13))         
      CALL HIOCXX(W(1,5),W(1,3),GDRNIP,MDR,WDR,W(1,26))                                                          
