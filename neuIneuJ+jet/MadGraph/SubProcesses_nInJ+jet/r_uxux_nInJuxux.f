      SUBROUTINE SMATRIX_UXUX_NINJUXUX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_uxux_nInJuxux/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_UXUX_NINJUXUX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_UXUX_NINJUXUX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HVSXXX(W(1,23),W(1,7),GC,MUL,WUL,W(1,24))     
      CALL IOSXXX(W(1,6),W(1,3),W(1,24),GULNIM,AMP(11))         
      CALL HVSXXX(W(1,23),W(1,10),GC,MUR,WUR,W(1,25))     
      ...
      CALL HIOXXX(W(1,4),W(1,2),GURNJP,MUR,WUR,W(1,38))                                                          
      ...
      CALL HVSXXX(W(1,47),W(1,35),GC,MUL,WUL,W(1,48))     
      CALL IOSXXX(W(1,6),W(1,3),W(1,48),GULNIM,AMP(31))         
      CALL HVSXXX(W(1,47),W(1,38),GC,MUR,WUR,W(1,49))     
      ...
      CALL HIOXXX(W(1,4),W(1,56),GULNJP,MUL,WUL,W(1,57))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,57),GULNIM,AMP(39))         
      CALL HIOXXX(W(1,4),W(1,56),GURNJP,MUR,WUR,W(1,58))                                                          
      ...
      CALL HIOXXX(W(1,67),W(1,2),GULNIP,MUL,WUL,W(1,69))                                                          
      ...
      CALL HIOXXX(W(1,67),W(1,2),GURNIP,MUR,WUR,W(1,72))                                                          
      ...
      CALL HIOXXX(W(1,5),W(1,68),GULNJM,MUL,WUL,W(1,75))                                                          
      CALL JSSXXX(W(1,69),W(1,75),GC,ZERO,ZERO,W(1,76))     
      CALL IOVXXX(W(1,6),W(1,1),W(1,76),GG,AMP(51))             
      CALL HIOXXX(W(1,5),W(1,68),GURNJM,MUR,WUR,W(1,77))                                                          
      ...
      CALL HVSXXX(W(1,47),W(1,69),GC,MUL,WUL,W(1,85))     
      CALL IOSXXX(W(1,6),W(1,68),W(1,85),GULNJM,AMP(59))         
      CALL HVSXXX(W(1,47),W(1,72),GC,MUR,WUR,W(1,86))     
      ...
      CALL HIOXXX(W(1,87),W(1,1),GQLGOP,MUL,WUL,W(1,88))                                                          
      CALL IOSXXX(W(1,6),W(1,68),W(1,88),GULNJM,AMP(63))         
      CALL HIOXXX(W(1,87),W(1,1),GQRGOP,MUR,WUR,W(1,89))                                                          
      CALL IOSXXX(W(1,6),W(1,68),W(1,89),GURNJM,AMP(64))         
      CALL FSIXXX(W(1,5),W(1,72),GQRGOM,MGO,WGO,W(1,90))                                                          
      CALL HIOXXX(W(1,90),W(1,1),GQLGOP,MUL,WUL,W(1,91))                                                          
      CALL IOSXXX(W(1,6),W(1,68),W(1,91),GULNJM,AMP(65))         
      CALL HIOXXX(W(1,90),W(1,1),GQRGOP,MUR,WUR,W(1,92))                                                          
      CALL IOSXXX(W(1,6),W(1,68),W(1,92),GURNJM,AMP(66))         
      CALL HIOXXX(W(1,67),W(1,56),GULNIP,MUL,WUL,W(1,93))                                                          
      CALL IOSXXX(W(1,6),W(1,68),W(1,93),GULNJM,AMP(67))         
      CALL HIOXXX(W(1,67),W(1,56),GURNIP,MUR,WUR,W(1,94))                                                          
      CALL IOSXXX(W(1,6),W(1,68),W(1,94),GURNJM,AMP(68))         
      CALL HIOXXX(W(1,67),W(1,1),GULNIP,MUL,WUL,W(1,95))                                                          
      ...
      CALL HIOXXX(W(1,67),W(1,1),GURNIP,MUR,WUR,W(1,98))                                                          
      ...
      CALL HVSXXX(W(1,23),W(1,95),GC,MUL,WUL,W(1,107))     
      CALL IOSXXX(W(1,6),W(1,68),W(1,107),GULNJM,AMP(79))         
      CALL HVSXXX(W(1,23),W(1,98),GC,MUR,WUR,W(1,108))     
      ...
      CALL HIOXXX(W(1,109),W(1,2),GQLGOP,MUL,WUL,W(1,110))                                                          
      CALL IOSXXX(W(1,6),W(1,68),W(1,110),GULNJM,AMP(83))         
      CALL HIOXXX(W(1,109),W(1,2),GQRGOP,MUR,WUR,W(1,111))                                                          
      CALL IOSXXX(W(1,6),W(1,68),W(1,111),GURNJM,AMP(84))         
      CALL FSIXXX(W(1,5),W(1,98),GQRGOM,MGO,WGO,W(1,112))                                                          
      CALL HIOXXX(W(1,112),W(1,2),GQLGOP,MUL,WUL,W(1,113))                                                          
      CALL IOSXXX(W(1,6),W(1,68),W(1,113),GULNJM,AMP(85))         
      CALL HIOXXX(W(1,112),W(1,2),GQRGOP,MUR,WUR,W(1,114))                                                          
      CALL IOSXXX(W(1,6),W(1,68),W(1,114),GURNJM,AMP(86))         
      CALL HIOXXX(W(1,67),W(1,32),GULNIP,MUL,WUL,W(1,115))                                                          
      CALL IOSXXX(W(1,6),W(1,68),W(1,115),GULNJM,AMP(87))         
      CALL HIOXXX(W(1,67),W(1,32),GURNIP,MUR,WUR,W(1,116))                                                          
     ...
     &             +AMP( 108)-AMP( 117)-AMP( 118)-AMP( 119)-AMP( 120)
      MATRIX_UXUX_NINJUXUX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_UXUX_NINJUXUX =MATRIX_UXUX_NINJUXUX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
