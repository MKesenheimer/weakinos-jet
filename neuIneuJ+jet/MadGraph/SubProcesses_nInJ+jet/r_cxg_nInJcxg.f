      SUBROUTINE SMATRIX_CXG_NINJCXG(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_cxg_nInJcxg/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_CXG_NINJCXG(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_CXG_NINJCXG(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,52),W(1,1),GURNIP,MCR,WCR,W(1,61))                                                          
      ...
      CALL HVSXXX(W(1,2),W(1,66),-GC,MCL,WCL,W(1,67))    
      CALL FSIXXX(W(1,52),W(1,67),GULNIP,ZERO,ZERO,W(1,68))                                                          
      CALL IOVXXX(W(1,68),W(1,1),W(1,6),GG,AMP(51))             
      CALL HIOXXX(W(1,5),W(1,53),GURNJM,MCR,WCR,W(1,69))                                                          
      CALL HVSXXX(W(1,2),W(1,69),-GC,MCR,WCR,W(1,70))    
