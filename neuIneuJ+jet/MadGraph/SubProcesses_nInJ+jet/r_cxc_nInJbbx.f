      SUBROUTINE SMATRIX_CXC_NINJBBX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_cxc_nInJbbx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_CXC_NINJBBX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_CXC_NINJBBX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOSXXX(W(1,6),W(1,4),W(1,9),GB1NJM,AMP(1))         
      CALL HIOCXX(W(1,5),W(1,8),GB2GOP,MBR,WBR,W(1,10))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,10),GB2NJM,AMP(2))         
      CALL HIOXXX(W(1,2),W(1,3),GURNIM,MCR,WCR,W(1,11))                                                          
      CALL FSOXXX(W(1,1),W(1,11),GQRGOP,MGO,WGO,W(1,12))                                                          
      CALL HIOCXX(W(1,5),W(1,12),GB1GOP,MBL,WBL,W(1,13))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,13),GB1NJM,AMP(3))         
      CALL HIOCXX(W(1,5),W(1,12),GB2GOP,MBR,WBR,W(1,14))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,14),GB2NJM,AMP(4))         
      CALL HIOCXX(W(1,5),W(1,4),GB1NJP,MBL,WBL,W(1,15))                                                          
      CALL IOSXXX(W(1,6),W(1,8),W(1,15),GB1GOM,AMP(5))         
      CALL HIOCXX(W(1,5),W(1,4),GB2NJP,MBR,WBR,W(1,16))                                                          
      ...
      CALL HIOXXX(W(1,2),W(1,4),GULNJM,MCL,WCL,W(1,17))                                                          
      CALL FSOXXX(W(1,1),W(1,17),GQLGOP,MGO,WGO,W(1,18))                                                          
      CALL HIOCXX(W(1,5),W(1,18),GB1GOP,MBL,WBL,W(1,19))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,19),GB1NIM,AMP(9))         
      CALL HIOCXX(W(1,5),W(1,18),GB2GOP,MBR,WBR,W(1,20))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,20),GB2NIM,AMP(10))         
      CALL HIOXXX(W(1,2),W(1,4),GURNJM,MCR,WCR,W(1,21))                                                          
      ...
      CALL HIOCXX(W(1,5),W(1,3),GB1NIP,MBL,WBL,W(1,25))                                                          
      CALL IOSXXX(W(1,6),W(1,18),W(1,25),GB1GOM,AMP(13))         
      CALL HIOCXX(W(1,5),W(1,3),GB2NIP,MBR,WBR,W(1,26))                                                          
      ...
      CALL HVSXXX(W(1,27),W(1,25),GC,MBL,WBL,W(1,28))     
      CALL IOSXXX(W(1,6),W(1,4),W(1,28),GB1NJM,AMP(17))         
      CALL HVSXXX(W(1,27),W(1,26),GC,MBR,WBR,W(1,29))     
      CALL IOSXXX(W(1,6),W(1,4),W(1,29),GB2NJM,AMP(18))         
      CALL FSOXXX(W(1,4),W(1,25),GB1NJM,BMASS,ZERO,W(1,30))                                                          
      CALL IOVXXX(W(1,6),W(1,30),W(1,27),GG,AMP(19))             
      CALL FSOXXX(W(1,4),W(1,26),GB2NJM,BMASS,ZERO,W(1,31))                                                          
      ...
      CALL HVSXXX(W(1,27),W(1,15),GC,MBL,WBL,W(1,35))     
      CALL IOSXXX(W(1,6),W(1,3),W(1,35),GB1NIM,AMP(23))         
      CALL HVSXXX(W(1,27),W(1,16),GC,MBR,WBR,W(1,36))     
      CALL IOSXXX(W(1,6),W(1,3),W(1,36),GB2NIM,AMP(24))         
      CALL FSOXXX(W(1,3),W(1,15),GB1NIM,BMASS,ZERO,W(1,37))                                                          
      CALL IOVXXX(W(1,6),W(1,37),W(1,27),GG,AMP(25))             
      CALL FSOXXX(W(1,3),W(1,16),GB2NIM,BMASS,ZERO,W(1,38))                                                          
      ...
      CALL FSIXXX(W(1,41),W(1,7),GULNJP,ZERO,ZERO,W(1,43))                                                          
      CALL JIOXXX(W(1,43),W(1,1),GG,ZERO,ZERO,W(1,44))     
      CALL IOVXXX(W(1,6),W(1,42),W(1,44),GG,AMP(29))             
      CALL FSIXXX(W(1,41),W(1,11),GURNJP,ZERO,ZERO,W(1,45))                                                          
      CALL JIOXXX(W(1,45),W(1,1),GG,ZERO,ZERO,W(1,46))     
      CALL IOVXXX(W(1,6),W(1,42),W(1,46),GG,AMP(30))             
      CALL HIOXXX(W(1,41),W(1,1),GULNJP,MCL,WCL,W(1,47))                                                          
      CALL FSOXXX(W(1,3),W(1,47),GULNIM,ZERO,ZERO,W(1,48))                                                          
      CALL JIOXXX(W(1,2),W(1,48),GG,ZERO,ZERO,W(1,49))     
      CALL IOVXXX(W(1,6),W(1,42),W(1,49),GG,AMP(31))             
      CALL HIOXXX(W(1,41),W(1,1),GURNJP,MCR,WCR,W(1,50))                                                          
      CALL FSOXXX(W(1,3),W(1,50),GURNIM,ZERO,ZERO,W(1,51))                                                          
      ...
      CALL FVIXXX(W(1,2),W(1,61),GZU,ZERO,ZERO,W(1,62))    
      CALL JIOXXX(W(1,62),W(1,1),GG,ZERO,ZERO,W(1,63))     
      CALL IOVXXX(W(1,6),W(1,42),W(1,63),GG,AMP(39))             
      CALL FVOXXX(W(1,1),W(1,61),GZU,ZERO,ZERO,W(1,64))    
      ...
      CALL FSIXXX(W(1,75),W(1,17),GULNIP,ZERO,ZERO,W(1,76))                                                          
      CALL JIOXXX(W(1,76),W(1,1),GG,ZERO,ZERO,W(1,77))     
      CALL IOVXXX(W(1,6),W(1,42),W(1,77),GG,AMP(53))             
      CALL FSIXXX(W(1,75),W(1,21),GURNIP,ZERO,ZERO,W(1,78))                                                          
      CALL JIOXXX(W(1,78),W(1,1),GG,ZERO,ZERO,W(1,79))     
      CALL IOVXXX(W(1,6),W(1,42),W(1,79),GG,AMP(54))             
      CALL HIOXXX(W(1,75),W(1,1),GULNIP,MCL,WCL,W(1,80))                                                          
      CALL FSOXXX(W(1,4),W(1,80),GULNJM,ZERO,ZERO,W(1,81))                                                          
      CALL JIOXXX(W(1,2),W(1,81),GG,ZERO,ZERO,W(1,82))     
      CALL IOVXXX(W(1,6),W(1,42),W(1,82),GG,AMP(55))             
      CALL HIOXXX(W(1,75),W(1,1),GURNIP,MCR,WCR,W(1,83))                                                          
      CALL FSOXXX(W(1,4),W(1,83),GURNJM,ZERO,ZERO,W(1,84))                                                          
     ...
     &             -AMP(  66)
      MATRIX_CXC_NINJBBX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_CXC_NINJBBX =MATRIX_CXC_NINJBBX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
