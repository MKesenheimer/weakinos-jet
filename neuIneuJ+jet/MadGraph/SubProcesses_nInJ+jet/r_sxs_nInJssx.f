      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_SXS_NINJSSX(P1,NHEL(1,IHEL),JC(1))            
...
C ----------
      ...
      CALL HIOCXX(W(1,5),W(1,3),GDLNIP,MSL,WSL,W(1,23))                                                          
      ...
      CALL HIOCXX(W(1,5),W(1,3),GDRNIP,MSR,WSR,W(1,27))                                                          
      ...
      CALL HIOCXX(W(1,36),W(1,3),GDLNIP,MSL,WSL,W(1,37))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,37),GDLNJM,AMP(19))         
      CALL HIOCXX(W(1,36),W(1,3),GDRNIP,MSR,WSR,W(1,38))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,38),GDRNJM,AMP(20))         
      CALL HIOCXX(W(1,5),W(1,17),GQLGOP,MSL,WSL,W(1,39))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,39),GDLNJM,AMP(21))         
      CALL HIOCXX(W(1,5),W(1,17),GQRGOP,MSR,WSR,W(1,40))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,40),GDRNJM,AMP(22))         
      CALL HIOCXX(W(1,5),W(1,18),GQLGOP,MSL,WSL,W(1,41))                                                          
      CALL IOSXXX(W(1,6),W(1,4),W(1,41),GDLNJM,AMP(23))         
      CALL HIOCXX(W(1,5),W(1,18),GQRGOP,MSR,WSR,W(1,42))                                                          
      ...
      CALL HIOCXX(W(1,5),W(1,57),GQLGOP,MSL,WSL,W(1,61))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,61),GDLNIM,AMP(39))         
      CALL HIOCXX(W(1,5),W(1,57),GQRGOP,MSR,WSR,W(1,62))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,62),GDRNIM,AMP(40))         
      CALL HIOCXX(W(1,5),W(1,58),GQLGOP,MSL,WSL,W(1,63))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,63),GDLNIM,AMP(41))         
      CALL HIOCXX(W(1,5),W(1,58),GQRGOP,MSR,WSR,W(1,64))                                                          
      ...
      CALL HIOCXX(W(1,36),W(1,4),GDLNJP,MSL,WSL,W(1,79))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,79),GDLNIM,AMP(55))         
      CALL HIOCXX(W(1,36),W(1,4),GDRNJP,MSR,WSR,W(1,80))                                                          
