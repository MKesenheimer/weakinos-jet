      SUBROUTINE SMATRIX_CXC_NINJTTX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_cxc_nInJttx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_CXC_NINJTTX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_CXC_NINJTTX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOSCXX(W(1,55),W(1,74),W(1,25),GT1GOM,AMP(49))        
      CALL IOSCXX(W(1,55),W(1,74),W(1,26),GT2GOM,AMP(50))        
      CALL IOSCXX(W(1,58),W(1,74),W(1,25),GT1GOM,AMP(51))        
      CALL IOSCXX(W(1,58),W(1,74),W(1,26),GT2GOM,AMP(52))        
      ...
      CALL IOSCXX(W(1,88),W(1,74),W(1,15),GT1GOM,AMP(63))        
      CALL IOSCXX(W(1,88),W(1,74),W(1,16),GT2GOM,AMP(64))        
      CALL IOSCXX(W(1,91),W(1,74),W(1,15),GT1GOM,AMP(65))        
      CALL IOSCXX(W(1,91),W(1,74),W(1,16),GT2GOM,AMP(66))        
     ...
     &             -AMP(  66)
      MATRIX_CXC_NINJTTX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_CXC_NINJTTX =MATRIX_CXC_NINJTTX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
