...
#undef PROCNAME
#define PROCNAME "F4iiFb4iiF11iF11iF3iiFb3ii"
...
#undef Mass
#define Mass(f,c) Compose(f,c,Mf(4,Gen(1)),Mf(4,Gen(2)),MNeu(Neu(3)),MNeu(Neu(4)),Mf(3,Gen(5)),Mf(3,Gen(6)))

#undef Charge
#define Charge(f,c) Compose(f,c,-1/3.D0,1/3.D0,0,0,2/3.D0,-2/3.D0)
