...
#undef PROCNAME
#define PROCNAME "Fb4iiFb3iiF11iF12iFb4iiFb4ii"
...
#undef Mass
#define Mass(f,c) Compose(f,c,Mf(4,Gen(1)),Mf(3,Gen(2)),MNeu(Neu(3)),MCha(Cha(4)),Mf(4,Gen(5)),Mf(4,Gen(6)))

#undef Charge
#define Charge(f,c) Compose(f,c,1/3.D0,-2/3.D0,0,-1,1/3.D0,1/3.D0)
