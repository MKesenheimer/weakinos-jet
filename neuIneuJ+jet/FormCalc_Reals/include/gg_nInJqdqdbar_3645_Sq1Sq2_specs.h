...
#undef PROCNAME
#define PROCNAME "V5iV5iF11iF11iF4iiFb4ii"
...
#undef Mass
#define Mass(f,c) Compose(f,c,0,0,MNeu(Neu(3)),MNeu(Neu(4)),Mf(4,Gen(5)),Mf(4,Gen(6)))

#undef Charge
#define Charge(f,c) Compose(f,c,0,0,0,0,-1/3.D0,1/3.D0)
