...
#undef PROCNAME
#define PROCNAME "V5iFb4iiF11iFb12iFb3iiV5i"
...
#undef Mass
#define Mass(f,c) Compose(f,c,0,Mf(4,Gen(2)),MNeu(Neu(3)),MCha(Cha(4)),Mf(3,Gen(5)),0)

#undef Charge
#define Charge(f,c) Compose(f,c,0,1/3.D0,0,1,-2/3.D0,0)
