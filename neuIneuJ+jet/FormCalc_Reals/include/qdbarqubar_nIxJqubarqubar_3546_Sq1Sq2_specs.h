...
#undef PROCNAME
#define PROCNAME "Fb4iiFb3iiF11iFb12iFb3iiFb3ii"
...
#undef Mass
#define Mass(f,c) Compose(f,c,Mf(4,Gen(1)),Mf(3,Gen(2)),MNeu(Neu(3)),MCha(Cha(4)),Mf(3,Gen(5)),Mf(3,Gen(6)))

#undef Charge
#define Charge(f,c) Compose(f,c,1/3.D0,-2/3.D0,0,1,-2/3.D0,-2/3.D0)
