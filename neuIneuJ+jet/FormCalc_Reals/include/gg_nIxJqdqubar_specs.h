...
#undef PROCNAME
#define PROCNAME "V5iV5iF11iFb12iF4iiFb3ii"
...
#undef Mass
#define Mass(f,c) Compose(f,c,0,0,MNeu(Neu(3)),MCha(Cha(4)),Mf(4,Gen(5)),Mf(3,Gen(6)))

#undef Charge
#define Charge(f,c) Compose(f,c,0,0,0,1,-1/3.D0,-2/3.D0)
