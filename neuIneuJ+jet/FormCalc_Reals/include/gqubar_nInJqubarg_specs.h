...
#undef PROCNAME
#define PROCNAME "V5iFb3iiF11iF11iFb3iiV5i"
...
#undef Mass
#define Mass(f,c) Compose(f,c,0,Mf(3,Gen(2)),MNeu(Neu(3)),MNeu(Neu(4)),Mf(3,Gen(5)),0)

#undef Charge
#define Charge(f,c) Compose(f,c,0,-2/3.D0,0,0,-2/3.D0,0)
