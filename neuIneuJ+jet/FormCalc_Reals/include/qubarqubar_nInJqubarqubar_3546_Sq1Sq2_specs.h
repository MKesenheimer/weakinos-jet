...
#undef PROCNAME
#define PROCNAME "Fb3iiFb3iiF11iF11iFb3iiFb3ii"
...
#undef Mass
#define Mass(f,c) Compose(f,c,Mf(3,Gen(1)),Mf(3,Gen(2)),MNeu(Neu(3)),MNeu(Neu(4)),Mf(3,Gen(5)),Mf(3,Gen(6)))

#undef Charge
#define Charge(f,c) Compose(f,c,-2/3.D0,-2/3.D0,0,0,-2/3.D0,-2/3.D0)
