...
C  
C FOR PROCESS : d d~ -> x1+ x1- g  
C  
C Crossing   1 is d d~ -> x1+ x1- g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      CALL HIOXXX(W(1,3   ),W(1,2   ),GULX1P ,MUL     ,WUL     ,W(1,       
     &     6   ))                                                          
      CALL FSOXXX(W(1,4   ),W(1,6   ),GULX1M ,ZERO    ,ZERO    ,W(1,       
     &     7   ))                                                          
      CALL IOVXXX(W(1,1   ),W(1,7   ),W(1,5   ),GG ,AMP(1   ))             
      CALL HIOXXX(W(1,1   ),W(1,4   ),GULX1M ,MUL     ,WUL     ,W(1,       
     &     8   ))                                                          
      CALL FVOXXX(W(1,2   ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,9   ))     
      CALL IOSXXX(W(1,3   ),W(1,9   ),W(1,8   ),GULX1P ,AMP(2   ))         
