...
C  
C FOR PROCESS : b b~ -> x1+ x1- g  
C  
C Crossing   1 is b b~ -> x1+ x1- g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
     ...
     &     9   ))                                                          
      ...
      CALL HIOXXX(W(1,1   ),W(1,4   ),GT1X1M ,MT1     ,WT1     ,W(1,       
     &     10  ))                                                          
      CALL FVOXXX(W(1,2   ),W(1,5   ),GG ,BMASS   ,ZERO    ,W(1,11  ))     
      CALL IOSXXX(W(1,3   ),W(1,11  ),W(1,10  ),GT1X1P ,AMP(3   ))         
      CALL HIOXXX(W(1,1   ),W(1,4   ),GT2X1M ,MT2     ,WT2     ,W(1,       
     &     12  ))                                                          
      CALL IOSXXX(W(1,3   ),W(1,11  ),W(1,12  ),GT2X1P ,AMP(4   ))         
      ...
      CALL IOVXXX(W(1,14  ),W(1,2   ),W(1,13  ),GAD ,AMP(7   ))            
      CALL JIOXXX(W(1,3   ),W(1,4   ),GZX11 ,ZMASS   ,ZWIDTH  ,W(1,        
     &     15  ))                                                          
      CALL IOVXXX(W(1,14  ),W(1,2   ),W(1,15  ),GZD ,AMP(8   ))            
      CALL HIOXXX(W(1,3   ),W(1,4   ),GH1X11 ,MH1     ,WH1     ,W(1,       
     &     16  ))                                                          
      CALL IOSXXX(W(1,14  ),W(1,2   ),W(1,16  ),GH1BB ,AMP(9   ))          
      CALL HIOXXX(W(1,3   ),W(1,4   ),GH2X11 ,MH2     ,WH2     ,W(1,       
     &     17  ))                                                          
      CALL IOSXXX(W(1,14  ),W(1,2   ),W(1,17  ),GH2BB ,AMP(10  ))          
      CALL HIOXXX(W(1,3   ),W(1,4   ),GH3X11 ,MH3     ,WH3     ,W(1,       
     &     18  ))                                                          
      CALL IOSXXX(W(1,14  ),W(1,2   ),W(1,18  ),GH3BB ,AMP(11  ))          
      CALL IOVXXX(W(1,1   ),W(1,11  ),W(1,13  ),GAD ,AMP(12  ))            
      CALL IOVXXX(W(1,1   ),W(1,11  ),W(1,15  ),GZD ,AMP(13  ))            
      CALL IOSXXX(W(1,1   ),W(1,11  ),W(1,16  ),GH1BB ,AMP(14  ))          
      CALL IOSXXX(W(1,1   ),W(1,11  ),W(1,17  ),GH2BB ,AMP(15  ))          
      CALL IOSXXX(W(1,1   ),W(1,11  ),W(1,18  ),GH3BB ,AMP(16  ))          
