...
C ----------
     ...
     &     9   ))                                                          
      CALL FSOXXX(W(1,4   ),W(1,9   ),GT1X1M ,BMASS   ,ZERO    ,W(1,       
     &     10  ))                                                          
      CALL IOVXXX(W(1,2   ),W(1,10  ),W(1,5   ),GG ,AMP(3   ))             
      CALL HIOXXX(W(1,3   ),W(1,1   ),GT2X1P ,MT2     ,WT2     ,W(1,       
     &     11  ))                                                          
      CALL FSOXXX(W(1,4   ),W(1,11  ),GT2X1M ,BMASS   ,ZERO    ,W(1,       
     &     12  ))                                                          
      ...
      CALL IOVXXX(W(1,2   ),W(1,7   ),W(1,13  ),GAD ,AMP(7   ))            
      CALL JIOXXX(W(1,3   ),W(1,4   ),GZX11 ,ZMASS   ,ZWIDTH  ,W(1,        
     &     14  ))                                                          
      CALL IOVXXX(W(1,2   ),W(1,7   ),W(1,14  ),GZD ,AMP(8   ))            
      CALL HIOXXX(W(1,3   ),W(1,4   ),GH1X11 ,MH1     ,WH1     ,W(1,       
     &     15  ))                                                          
      CALL IOSXXX(W(1,2   ),W(1,7   ),W(1,15  ),GH1BB ,AMP(9   ))          
      CALL HIOXXX(W(1,3   ),W(1,4   ),GH2X11 ,MH2     ,WH2     ,W(1,       
     &     16  ))                                                          
      CALL IOSXXX(W(1,2   ),W(1,7   ),W(1,16  ),GH2BB ,AMP(10  ))          
      CALL HIOXXX(W(1,3   ),W(1,4   ),GH3X11 ,MH3     ,WH3     ,W(1,       
     &     17  ))                                                          
      CALL IOSXXX(W(1,2   ),W(1,7   ),W(1,17  ),GH3BB ,AMP(11  ))          
      CALL FVIXXX(W(1,2   ),W(1,5   ),GG ,BMASS   ,ZERO    ,W(1,18  ))     
      CALL IOVXXX(W(1,18  ),W(1,1   ),W(1,13  ),GAD ,AMP(12  ))            
      CALL IOVXXX(W(1,18  ),W(1,1   ),W(1,14  ),GZD ,AMP(13  ))            
      CALL IOSXXX(W(1,18  ),W(1,1   ),W(1,15  ),GH1BB ,AMP(14  ))          
      CALL IOSXXX(W(1,18  ),W(1,1   ),W(1,16  ),GH2BB ,AMP(15  ))          
      CALL IOSXXX(W(1,18  ),W(1,1   ),W(1,17  ),GH3BB ,AMP(16  ))          
