...
C ----------
     ...
     &     8   ))                                                          
      ...
      CALL HIOXXX(W(1,11  ),W(1,2   ),GDLX1P ,MSL     ,WSL     ,W(1,       
     &     12  ))                                                          
      CALL IOSXXX(W(1,7   ),W(1,10  ),W(1,12  ),GDLX1M ,AMP(5   ))         
      CALL HIOXXX(W(1,1   ),W(1,10  ),GDLX1M ,MSL     ,WSL     ,W(1,       
     &     13  ))                                                          
      CALL FSIXXX(W(1,11  ),W(1,13  ),GDLX1P ,ZERO    ,ZERO    ,W(1,       
     &     14  ))                                                          
