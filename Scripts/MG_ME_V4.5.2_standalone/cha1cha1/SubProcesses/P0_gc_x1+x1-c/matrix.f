...
C  
C FOR PROCESS : g c -> x1+ x1- c  
C  
C Crossing   1 is g c -> x1+ x1- c  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
     ...
     &     12  ))                                                          
      CALL FSOCXX(W(1,4   ),W(1,12  ),GDLX1P  ,ZERO    ,ZERO    ,W(1,      
     &     13  ))                                                          
      CALL IOVCXX(W(1,11  ),W(1,13  ),W(1,1   ),GG  ,AMP(5   ))            
      CALL HVSXXX(W(1,1   ),W(1,12  ),-GC ,MSL     ,WSL     ,W(1,14  ))    
      CALL IOSCXX(W(1,11  ),W(1,4   ),W(1,14  ),GDLX1P  ,AMP(6   ))        
      CALL HIOXXX(W(1,9   ),W(1,10  ),GDLX1M ,MSL     ,WSL     ,W(1,       
     &     15  ))                                                          
      CALL IOSCXX(W(1,11  ),W(1,4   ),W(1,15  ),GDLX1P  ,AMP(7   ))        
