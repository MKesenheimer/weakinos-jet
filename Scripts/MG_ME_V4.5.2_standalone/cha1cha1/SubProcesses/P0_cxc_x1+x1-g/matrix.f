...
C  
C FOR PROCESS : c~ c -> x1+ x1- g  
C  
C Crossing   1 is c~ c -> x1+ x1- g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
     ...
     &     8   ))                                                          
      ...
      CALL OXXXXX(P(0,3   ),MX1 ,NHEL(3   ),+1*IC(3   ),W(1,10  ))         
      CALL IXXXXX(P(0,4   ),MX1 ,NHEL(4   ),-1*IC(4   ),W(1,11  ))         
      CALL HIOXXX(W(1,2   ),W(1,10  ),GDLX1M ,MSL     ,WSL     ,W(1,       
     &     12  ))                                                          
      CALL FSIXXX(W(1,11  ),W(1,12  ),GDLX1P ,ZERO    ,ZERO    ,W(1,       
     &     13  ))                                                          
      CALL IOVXXX(W(1,13  ),W(1,1   ),W(1,5   ),GG ,AMP(5   ))             
      CALL HIOXXX(W(1,11  ),W(1,1   ),GDLX1P ,MSL     ,WSL     ,W(1,       
     &     14  ))                                                          
      CALL IOSXXX(W(1,9   ),W(1,10  ),W(1,14  ),GDLX1M ,AMP(6   ))         
