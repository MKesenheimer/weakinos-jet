...
C  
C FOR PROCESS : b~ g -> x1+ x1- b~  
C  
C Crossing   1 is b~ g -> x1+ x1- b~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      CALL HIOXXX(W(1,3   ),W(1,1   ),GT1X1P ,MT1     ,WT1     ,W(1,       
     &     6   ))                                                          
      CALL FSOXXX(W(1,4   ),W(1,6   ),GT1X1M ,BMASS   ,ZERO    ,W(1,       
     &     7   ))                                                          
      CALL IOVXXX(W(1,5   ),W(1,7   ),W(1,2   ),GG ,AMP(1   ))             
      CALL HIOXXX(W(1,3   ),W(1,1   ),GT2X1P ,MT2     ,WT2     ,W(1,       
     &     8   ))                                                          
      CALL FSOXXX(W(1,4   ),W(1,8   ),GT2X1M ,BMASS   ,ZERO    ,W(1,       
     &     9   ))                                                          
      CALL IOVXXX(W(1,5   ),W(1,9   ),W(1,2   ),GG ,AMP(2   ))             
      CALL HVSXXX(W(1,2   ),W(1,6   ),GC ,MT1     ,WT1     ,W(1,10  ))     
      CALL IOSXXX(W(1,5   ),W(1,4   ),W(1,10  ),GT1X1M ,AMP(3   ))         
      CALL HVSXXX(W(1,2   ),W(1,8   ),GC ,MT2     ,WT2     ,W(1,11  ))     
      CALL IOSXXX(W(1,5   ),W(1,4   ),W(1,11  ),GT2X1M ,AMP(4   ))         
      CALL FVOXXX(W(1,1   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,12  ))     
      CALL HIOXXX(W(1,3   ),W(1,12  ),GT1X1P ,MT1     ,WT1     ,W(1,       
     &     13  ))                                                          
      CALL IOSXXX(W(1,5   ),W(1,4   ),W(1,13  ),GT1X1M ,AMP(5   ))         
      CALL HIOXXX(W(1,3   ),W(1,12  ),GT2X1P ,MT2     ,WT2     ,W(1,       
     &     14  ))                                                          
      CALL IOSXXX(W(1,5   ),W(1,4   ),W(1,14  ),GT2X1M ,AMP(6   ))         
      CALL JIOXXX(W(1,3   ),W(1,4   ),GAX ,ZERO    ,AWIDTH  ,W(1,15  ))    
      CALL FVIXXX(W(1,5   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,16  ))     
      CALL IOVXXX(W(1,16  ),W(1,1   ),W(1,15  ),GAD ,AMP(7   ))            
      CALL JIOXXX(W(1,3   ),W(1,4   ),GZX11 ,ZMASS   ,ZWIDTH  ,W(1,        
     &     17  ))                                                          
      CALL IOVXXX(W(1,16  ),W(1,1   ),W(1,17  ),GZD ,AMP(8   ))            
      CALL HIOXXX(W(1,3   ),W(1,4   ),GH1X11 ,MH1     ,WH1     ,W(1,       
     &     18  ))                                                          
      CALL IOSXXX(W(1,16  ),W(1,1   ),W(1,18  ),GH1BB ,AMP(9   ))          
      CALL HIOXXX(W(1,3   ),W(1,4   ),GH2X11 ,MH2     ,WH2     ,W(1,       
     &     19  ))                                                          
      CALL IOSXXX(W(1,16  ),W(1,1   ),W(1,19  ),GH2BB ,AMP(10  ))          
      CALL HIOXXX(W(1,3   ),W(1,4   ),GH3X11 ,MH3     ,WH3     ,W(1,       
     &     20  ))                                                          
      CALL IOSXXX(W(1,16  ),W(1,1   ),W(1,20  ),GH3BB ,AMP(11  ))          
      CALL IOVXXX(W(1,5   ),W(1,12  ),W(1,15  ),GAD ,AMP(12  ))            
      CALL IOVXXX(W(1,5   ),W(1,12  ),W(1,17  ),GZD ,AMP(13  ))            
      CALL IOSXXX(W(1,5   ),W(1,12  ),W(1,18  ),GH1BB ,AMP(14  ))          
      CALL IOSXXX(W(1,5   ),W(1,12  ),W(1,19  ),GH2BB ,AMP(15  ))          
      CALL IOSXXX(W(1,5   ),W(1,12  ),W(1,20  ),GH3BB ,AMP(16  ))          
