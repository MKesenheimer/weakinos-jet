...
C ----------
     ...
     &     13  ))                                                          
      ...
      CALL IOVXXX(W(1,1   ),W(1,7   ),W(1,14  ),GAD ,AMP(7   ))            
      CALL JIOXXX(W(1,3   ),W(1,4   ),GZX11 ,ZMASS   ,ZWIDTH  ,W(1,        
     &     15  ))                                                          
      CALL IOVXXX(W(1,1   ),W(1,7   ),W(1,15  ),GZD ,AMP(8   ))            
      CALL HIOXXX(W(1,3   ),W(1,4   ),GH1X11 ,MH1     ,WH1     ,W(1,       
     &     16  ))                                                          
      CALL IOSXXX(W(1,1   ),W(1,7   ),W(1,16  ),GH1BB ,AMP(9   ))          
      CALL HIOXXX(W(1,3   ),W(1,4   ),GH2X11 ,MH2     ,WH2     ,W(1,       
     &     17  ))                                                          
      CALL IOSXXX(W(1,1   ),W(1,7   ),W(1,17  ),GH2BB ,AMP(10  ))          
      CALL HIOXXX(W(1,3   ),W(1,4   ),GH3X11 ,MH3     ,WH3     ,W(1,       
     &     18  ))                                                          
      CALL IOSXXX(W(1,1   ),W(1,7   ),W(1,18  ),GH3BB ,AMP(11  ))          
