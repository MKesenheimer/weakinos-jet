...
C ----------
     ...
     &     8   ))                                                          
      ...
      CALL IXXXXX(P(0,4   ),MX1 ,NHEL(4   ),-1*IC(4   ),W(1,10  ))         
      CALL OXXXXX(P(0,5   ),ZERO ,NHEL(5   ),+1*IC(5   ),W(1,11  ))        
      CALL HIOXXX(W(1,10  ),W(1,2   ),GDLX1P ,MDL     ,WDL     ,W(1,       
     &     12  ))                                                          
      CALL FVOCXX(W(1,11  ),W(1,1   ),GG  ,ZERO    ,ZERO    ,W(1,13  ))    
      CALL IOSCXX(W(1,3   ),W(1,13  ),W(1,12  ),GDLX1M  ,AMP(5   ))        
      CALL HIOCXX(W(1,3   ),W(1,11  ),GDLX1M  ,MDL     ,WDL     ,W(1,      
     &     14  ))                                                          
      CALL VSSXXX(W(1,1   ),W(1,12  ),W(1,14  ),GC ,AMP(6   ))             
      CALL HIOXXX(W(1,10  ),W(1,9   ),GDLX1P ,MDL     ,WDL     ,W(1,       
     &     15  ))                                                          
      CALL IOSCXX(W(1,3   ),W(1,11  ),W(1,15  ),GDLX1M  ,AMP(7   ))        
