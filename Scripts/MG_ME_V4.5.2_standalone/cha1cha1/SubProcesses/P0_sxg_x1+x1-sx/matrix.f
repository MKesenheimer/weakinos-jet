...
C  
C FOR PROCESS : s~ g -> x1+ x1- s~  
C  
C Crossing   1 is s~ g -> x1+ x1- s~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      CALL HIOXXX(W(1,3   ),W(1,1   ),GULX1P ,MCL     ,WCL     ,W(1,       
     &     6   ))                                                          
      CALL FSOXXX(W(1,4   ),W(1,6   ),GULX1M ,ZERO    ,ZERO    ,W(1,       
     &     7   ))                                                          
      CALL IOVXXX(W(1,5   ),W(1,7   ),W(1,2   ),GG ,AMP(1   ))             
      CALL HVSXXX(W(1,2   ),W(1,6   ),GC ,MCL     ,WCL     ,W(1,8   ))     
      CALL IOSXXX(W(1,5   ),W(1,4   ),W(1,8   ),GULX1M ,AMP(2   ))         
      CALL FVOXXX(W(1,1   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,9   ))     
      CALL HIOXXX(W(1,3   ),W(1,9   ),GULX1P ,MCL     ,WCL     ,W(1,       
     &     10  ))                                                          
      CALL IOSXXX(W(1,5   ),W(1,4   ),W(1,10  ),GULX1M ,AMP(3   ))         
