...
(*You can now load the script with the command $ MathKernel -script xIxJjj_os.m "g" "g" "xI+" "xJ-" "qd" "qdbar"*)
Print[$CommandLine]
...
(*d ubar or dbar u in the initial state*)
...
$ISGluinoRes3 = And[P[1] =!= -P[2], P[5] =!= -P[6]];
$IsGluinoRes = And[Or[$IsGluinoRes1, $IsGluinoRes2], $ISGluinoRes3];
...
$IsSquarkRes1 = And[Not[P[5] === V[5]], Not[P[6] === V[5]], Not[$IsGluinoRes]];
