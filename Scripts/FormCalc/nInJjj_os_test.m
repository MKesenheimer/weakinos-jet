...
(*  (*On-shell topologies built by hand*)
  ...
  (*DEBUG*)
  DoPaint[top356,"top356",FieldNumbers->True];
  DoPaint[top365,"top365",FieldNumbers->True];
  DoPaint[top456,"top456",FieldNumbers->True];
  DoPaint[top465,"top465",FieldNumbers->True];

  ins356 = InsertFields[top356, process];
  DoPaint[ins356, "realOS_356_Gl",FieldNumbers->True];
  ins365 = InsertFields[top365, process];
  DoPaint[ins365, "realOS_365_Gl",FieldNumbers->True];
  ins456 = InsertFields[top456, process];
  DoPaint[ins456, "realOS_456_Gl",FieldNumbers->True];
  ins465 = InsertFields[top465, process];
  DoPaint[ins465, "realOS_465_Gl",FieldNumbers->True ];
