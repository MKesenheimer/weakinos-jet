...
(*ins = DiagramExtract[ins,4,10](*ddbar, MadGraph 1,2,9,10*)*)
(*ins = DiagramExtract[ins,8,12](*ddbar, MadGraph 3,4,11,12*)*)
ins = DiagramExtract[ins,2,6](*ddbar, MadGraph 5,6,13,14*)
DoPaint[ins, "born"];
...
dir = SetupCodeDir[name<>".born" <> ".fortran", Drivers -> name <> ".drivers"];
