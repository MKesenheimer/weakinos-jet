      SUBROUTINE SB_CL_017_003(P1,ANS)
C  
...
C  
C FOR PROCESS : b~ b -> n1 n1 g g  
C  
C BORN AMPLITUDE IS b~ b -> n1 n1 g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_017/  amp2,       jamp2

      integer j,jj
      integer max_bhel
      parameter ( max_bhel =          32 )
      double complex saveamp(ngraphs,max_bhel)
      common/to_saveamp_017/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_017/savemom
...
C          write (*,*) "momenta not the same in Born"
     ...
     &       nhel(5,ihel).eq.-1) THEN
                 T=B_CL_017_003(P1,NHEL(1,IHEL),IHEL,JC(1),T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_017_003(P,NHEL,HELL,IC,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     10  ))                                                          
      CALL FVIXXX(W(1,2   ),W(1,5   ),GG ,BMASS   ,ZERO    ,W(1,11  ))     
      CALL IOSXXX(W(1,11  ),W(1,3   ),W(1,10  ),GB1N1M ,AMP(3   ))         
      CALL HIOXXX(W(1,4   ),W(1,1   ),GB2N1P ,MBR     ,WB2     ,W(1,       
     &     12  ))                                                          
      CALL IOSXXX(W(1,11  ),W(1,3   ),W(1,12  ),GB2N1M ,AMP(4   ))         
     ...
     &     13  ))                                                          
      CALL FVOXXX(W(1,1   ),W(1,5   ),GG ,BMASS   ,ZERO    ,W(1,14  ))     
      CALL IOVXXX(W(1,2   ),W(1,14  ),W(1,13  ),GZD ,AMP(7   ))            
      CALL HIOXXX(W(1,4   ),W(1,3   ),GH1N11 ,MH1     ,WH1     ,W(1,       
     &     15  ))                                                          
      CALL IOSXXX(W(1,2   ),W(1,14  ),W(1,15  ),GH1BB ,AMP(8   ))          
      CALL HIOXXX(W(1,4   ),W(1,3   ),GH2N11 ,MH2     ,WH2     ,W(1,       
     &     16  ))                                                          
      CALL IOSXXX(W(1,2   ),W(1,14  ),W(1,16  ),GH2BB ,AMP(9   ))          
      CALL HIOXXX(W(1,4   ),W(1,3   ),GH3N11 ,MH3     ,WH3     ,W(1,       
     &     17  ))                                                          
      CALL IOSXXX(W(1,2   ),W(1,14  ),W(1,17  ),GH3BB ,AMP(10  ))          
      CALL IOVXXX(W(1,11  ),W(1,1   ),W(1,13  ),GZD ,AMP(11  ))            
      CALL IOSXXX(W(1,11  ),W(1,1   ),W(1,15  ),GH1BB ,AMP(12  ))          
      CALL IOSXXX(W(1,11  ),W(1,1   ),W(1,16  ),GH2BB ,AMP(13  ))          
      CALL IOSXXX(W(1,11  ),W(1,1   ),W(1,17  ),GH3BB ,AMP(14  ))          
      CALL IXXXXX(P(0,3   ),MN1 ,NHEL(3   ),-1*IC(3   ),W(1,18  ))         
      CALL OXXXXX(P(0,4   ),MN1 ,NHEL(4   ),+1*IC(4   ),W(1,19  ))         
      CALL HIOXXX(W(1,2   ),W(1,19  ),GB1N1M ,MBL     ,WB1     ,W(1,       
     &     20  ))                                                          
      CALL IOSXXX(W(1,18  ),W(1,14  ),W(1,20  ),GB1N1P ,AMP(15  ))         
      CALL HIOXXX(W(1,2   ),W(1,19  ),GB2N1M ,MBR     ,WB2     ,W(1,       
     &     21  ))                                                          
      CALL IOSXXX(W(1,18  ),W(1,14  ),W(1,21  ),GB2N1P ,AMP(16  ))         
      CALL HIOXXX(W(1,18  ),W(1,1   ),GB1N1P ,MBL     ,WB1     ,W(1,       
     &     22  ))                                                          
      CALL FSOXXX(W(1,19  ),W(1,22  ),GB1N1M ,BMASS   ,ZERO    ,W(1,       
     &     23  ))                                                          
      CALL IOVXXX(W(1,2   ),W(1,23  ),W(1,5   ),GG ,AMP(17  ))             
      CALL HIOXXX(W(1,18  ),W(1,1   ),GB2N1P ,MBR     ,WB2     ,W(1,       
     &     24  ))                                                          
      CALL FSOXXX(W(1,19  ),W(1,24  ),GB2N1M ,BMASS   ,ZERO    ,W(1,       
     &     25  ))                                                          
      CALL IOVXXX(W(1,2   ),W(1,25  ),W(1,5   ),GG ,AMP(18  ))             
      CALL VSSXXX(W(1,5   ),W(1,22  ),W(1,20  ),GC ,AMP(19  ))             
      CALL VSSXXX(W(1,5   ),W(1,24  ),W(1,21  ),GC ,AMP(20  ))             
      do i=1,ngraphs
         if(ihel.eq.-1)then
     ...
     &             +AMP(  16)+AMP(  17)+AMP(  18)+AMP(  19)+AMP(  20)
      DO I = 1, NCOLOR
          ...
          if (ihel.eq.-1) then
             B_CL_017_003=B_CL_017_003 +RTEMP
          elseif (ihel.eq.1) then
             B_CL_017_003=B_CL_017_003 +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
