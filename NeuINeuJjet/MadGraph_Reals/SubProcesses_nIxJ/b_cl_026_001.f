      SUBROUTINE SB_CL_026_001(P1,ANS)
C  
...
C  
C FOR PROCESS : g c -> n1 n1 c g  
C  
C BORN AMPLITUDE IS g c -> n1 n1 c  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_026/  amp2,       jamp2

      integer j,jj
      integer max_bhel
      parameter ( max_bhel =          32 )
      double complex saveamp(ngraphs,max_bhel)
      common/to_saveamp_026/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_026/savemom
...
C          write (*,*) "momenta not the same in Born"
     ...
     &       nhel(1,ihel).eq.-1) THEN
                 T=B_CL_026_001(P1,NHEL(1,IHEL),IHEL,JC(1),T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_026_001(P,NHEL,HELL,IC,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     9   ))                                                          
      ...
      CALL HVSXXX(W(1,1   ),W(1,6   ),-GC ,MCL     ,WCL     ,W(1,10  ))    
      CALL IOSXXX(W(1,4   ),W(1,5   ),W(1,10  ),GULN1P ,AMP(3   ))         
      CALL HVSXXX(W(1,1   ),W(1,8   ),-GC ,MCR     ,WCR     ,W(1,11  ))    
     ...
     &     15  ))                                                          
      ...
      CALL HIOXXX(W(1,2   ),W(1,18  ),GULN1M ,MCL     ,WCL     ,W(1,       
     &     19  ))                                                          
      CALL IOSXXX(W(1,17  ),W(1,16  ),W(1,19  ),GULN1P ,AMP(9   ))         
      CALL HIOXXX(W(1,2   ),W(1,18  ),GURN1M ,MCR     ,WCR     ,W(1,       
     &     20  ))                                                          
     ...
     &             -AMP(  11)-AMP(  12)-AMP(  13)-AMP(  14)
      DO I = 1, NCOLOR
          ...
          if (ihel.eq.-1) then
             B_CL_026_001=B_CL_026_001 +RTEMP
          elseif (ihel.eq.1) then
             B_CL_026_001=B_CL_026_001 +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
