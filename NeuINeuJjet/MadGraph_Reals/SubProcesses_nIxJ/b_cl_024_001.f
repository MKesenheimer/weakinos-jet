...
C ----------
     ...
     &     15  ))                                                          
      ...
      CALL HIOXXX(W(1,2   ),W(1,18  ),GDLN1M ,MSL     ,WSL     ,W(1,       
     &     19  ))                                                          
      CALL IOSXXX(W(1,17  ),W(1,16  ),W(1,19  ),GDLN1P ,AMP(9   ))         
      CALL HIOXXX(W(1,2   ),W(1,18  ),GDRN1M ,MSR     ,WSR     ,W(1,       
     &     20  ))                                                          
