      SUBROUTINE SB_CL_023_001(P1,ANS)
C  
...
C  
C FOR PROCESS : g s~ -> n1 n1 s~ g  
C  
C BORN AMPLITUDE IS g s~ -> n1 n1 s~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_023/  amp2,       jamp2

      integer j,jj
      integer max_bhel
      parameter ( max_bhel =          32 )
      double complex saveamp(ngraphs,max_bhel)
      common/to_saveamp_023/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_023/savemom
...
C          write (*,*) "momenta not the same in Born"
     ...
     &       nhel(1,ihel).eq.-1) THEN
                 T=B_CL_023_001(P1,NHEL(1,IHEL),IHEL,JC(1),T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_023_001(P,NHEL,HELL,IC,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     8   ))                                                          
      ...
      CALL HIOXXX(W(1,5   ),W(1,3   ),GDLN1M ,MSL     ,WSL     ,W(1,       
     &     9   ))                                                          
      CALL VSSXXX(W(1,1   ),W(1,6   ),W(1,9   ),GC ,AMP(3   ))             
      CALL HIOXXX(W(1,5   ),W(1,3   ),GDRN1M ,MSR     ,WSR     ,W(1,       
     &     10  ))                                                          
      CALL VSSXXX(W(1,1   ),W(1,8   ),W(1,10  ),GC ,AMP(4   ))             
      CALL FVOXXX(W(1,2   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
      CALL HIOXXX(W(1,4   ),W(1,11  ),GDLN1P ,MSL     ,WSL     ,W(1,       
     &     12  ))                                                          
      CALL IOSXXX(W(1,5   ),W(1,3   ),W(1,12  ),GDLN1M ,AMP(5   ))         
      CALL HIOXXX(W(1,4   ),W(1,11  ),GDRN1P ,MSR     ,WSR     ,W(1,       
     &     13  ))                                                          
      CALL IOSXXX(W(1,5   ),W(1,3   ),W(1,13  ),GDRN1M ,AMP(6   ))         
      CALL JIOXXX(W(1,4   ),W(1,3   ),GZN11 ,ZMASS   ,ZWIDTH  ,W(1,        
     &     14  ))                                                          
      CALL IOVXXX(W(1,7   ),W(1,2   ),W(1,14  ),GZD ,AMP(7   ))            
     ...
     &     20  ))                                                          
      ...
      CALL HVSXXX(W(1,1   ),W(1,17  ),GC ,MSL     ,WSL     ,W(1,21  ))     
      CALL IOSXXX(W(1,5   ),W(1,16  ),W(1,21  ),GDLN1M ,AMP(11  ))         
      CALL HVSXXX(W(1,1   ),W(1,19  ),GC ,MSR     ,WSR     ,W(1,22  ))     
      CALL IOSXXX(W(1,5   ),W(1,16  ),W(1,22  ),GDRN1M ,AMP(12  ))         
      CALL HIOXXX(W(1,15  ),W(1,11  ),GDLN1P ,MSL     ,WSL     ,W(1,       
     &     23  ))                                                          
      CALL IOSXXX(W(1,5   ),W(1,16  ),W(1,23  ),GDLN1M ,AMP(13  ))         
      CALL HIOXXX(W(1,15  ),W(1,11  ),GDRN1P ,MSR     ,WSR     ,W(1,       
     &     24  ))                                                          
      CALL IOSXXX(W(1,5   ),W(1,16  ),W(1,24  ),GDRN1M ,AMP(14  ))         
      do i=1,ngraphs
         if(ihel.eq.-1)then
     ...
     &             +AMP(  11)+AMP(  12)+AMP(  13)+AMP(  14)
      DO I = 1, NCOLOR
          ...
          if (ihel.eq.-1) then
             B_CL_023_001=B_CL_023_001 +RTEMP
          elseif (ihel.eq.1) then
             B_CL_023_001=B_CL_023_001 +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
