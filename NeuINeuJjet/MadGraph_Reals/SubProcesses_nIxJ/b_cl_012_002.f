      SUBROUTINE SB_CL_012_002(P1,ANS)
C  
...
C  
C FOR PROCESS : c g -> n1 n1 c g  
C  
C BORN AMPLITUDE IS c g -> n1 n1 c  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_012/  amp2,       jamp2

      integer j,jj
      integer max_bhel
      parameter ( max_bhel =          32 )
      double complex saveamp(ngraphs,max_bhel)
      common/to_saveamp_012/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_012/savemom
...
C          write (*,*) "momenta not the same in Born"
     ...
     &       nhel(2,ihel).eq.-1) THEN
                 T=B_CL_012_002(P1,NHEL(1,IHEL),IHEL,JC(1),T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_012_002(P,NHEL,HELL,IC,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     15  ))                                                          
      ...
      CALL HIOXXX(W(1,1   ),W(1,18  ),GULN1M ,MCL     ,WCL     ,W(1,       
     &     19  ))                                                          
      CALL IOSXXX(W(1,17  ),W(1,16  ),W(1,19  ),GULN1P ,AMP(9   ))         
      CALL HIOXXX(W(1,1   ),W(1,18  ),GURN1M ,MCR     ,WCR     ,W(1,       
     &     20  ))                                                          
      CALL IOSXXX(W(1,17  ),W(1,16  ),W(1,20  ),GURN1P ,AMP(10  ))         
      CALL HIOXXX(W(1,17  ),W(1,5   ),GULN1P ,MCL     ,WCL     ,W(1,       
     &     21  ))                                                          
      CALL VSSXXX(W(1,2   ),W(1,21  ),W(1,19  ),GC ,AMP(11  ))             
      CALL HIOXXX(W(1,17  ),W(1,5   ),GURN1P ,MCR     ,WCR     ,W(1,       
     &     22  ))                                                          
      CALL VSSXXX(W(1,2   ),W(1,22  ),W(1,20  ),GC ,AMP(12  ))             
      CALL HIOXXX(W(1,12  ),W(1,18  ),GULN1M ,MCL     ,WCL     ,W(1,       
     &     23  ))                                                          
      CALL IOSXXX(W(1,17  ),W(1,5   ),W(1,23  ),GULN1P ,AMP(13  ))         
      CALL HIOXXX(W(1,12  ),W(1,18  ),GURN1M ,MCR     ,WCR     ,W(1,       
     &     24  ))                                                          
     ...
     &             -AMP(  11)-AMP(  12)-AMP(  13)-AMP(  14)
      DO I = 1, NCOLOR
          ...
          if (ihel.eq.-1) then
             B_CL_012_002=B_CL_012_002 +RTEMP
          elseif (ihel.eq.1) then
             B_CL_012_002=B_CL_012_002 +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
