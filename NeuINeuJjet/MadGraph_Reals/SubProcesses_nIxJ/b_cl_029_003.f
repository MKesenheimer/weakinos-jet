      SUBROUTINE SB_CL_029_003(P1,ANS)
C  
...
C          write (*,*) "momenta not the same in Born"
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=B_CL_029_003(P1,NHEL(1,IHEL),IHEL,JC(1))              
      ...
      REAL*8 FUNCTION B_CL_029_003(P,NHEL,HELL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     10  ))                                                          
      ...
      CALL FVOXXX(W(1,2   ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,11  ))     
     ...
     &     15  ))                                                          
      CALL IOSXXX(W(1,7   ),W(1,2   ),W(1,15  ),GH1BB ,AMP(8   ))          
      CALL HIOXXX(W(1,4   ),W(1,3   ),GH2N11 ,MH2     ,WH2     ,W(1,       
     &     16  ))                                                          
      CALL IOSXXX(W(1,7   ),W(1,2   ),W(1,16  ),GH2BB ,AMP(9   ))          
      CALL HIOXXX(W(1,4   ),W(1,3   ),GH3N11 ,MH3     ,WH3     ,W(1,       
     &     17  ))                                                          
      CALL IOSXXX(W(1,7   ),W(1,2   ),W(1,17  ),GH3BB ,AMP(10  ))          
     ...
     &             +AMP(  16)+AMP(  17)+AMP(  18)+AMP(  19)+AMP(  20)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          B_CL_029_003 =B_CL_029_003+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
