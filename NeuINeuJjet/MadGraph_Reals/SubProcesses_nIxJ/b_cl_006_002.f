...
C ----------
     ...
     &     8   ))                                                          
      ...
      CALL HIOXXX(W(1,5   ),W(1,3   ),GULN1M ,MUL     ,WUL     ,W(1,       
     &     9   ))                                                          
      CALL VSSXXX(W(1,2   ),W(1,6   ),W(1,9   ),GC ,AMP(3   ))             
      CALL HIOXXX(W(1,5   ),W(1,3   ),GURN1M ,MUR     ,WUR     ,W(1,       
     &     10  ))                                                          
      CALL VSSXXX(W(1,2   ),W(1,8   ),W(1,10  ),GC ,AMP(4   ))             
      CALL FVOXXX(W(1,1   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
      CALL HIOXXX(W(1,4   ),W(1,11  ),GULN1P ,MUL     ,WUL     ,W(1,       
     &     12  ))                                                          
      CALL IOSXXX(W(1,5   ),W(1,3   ),W(1,12  ),GULN1M ,AMP(5   ))         
      CALL HIOXXX(W(1,4   ),W(1,11  ),GURN1P ,MUR     ,WUR     ,W(1,       
     &     13  ))                                                          
      CALL IOSXXX(W(1,5   ),W(1,3   ),W(1,13  ),GURN1M ,AMP(6   ))         
     ...
     &     20  ))                                                          
      ...
      CALL IOSXXX(W(1,5   ),W(1,16  ),W(1,21  ),GULN1M ,AMP(11  ))         
      CALL HVSXXX(W(1,2   ),W(1,19  ),GC ,MUR     ,WUR     ,W(1,22  ))     
      CALL IOSXXX(W(1,5   ),W(1,16  ),W(1,22  ),GURN1M ,AMP(12  ))         
      CALL HIOXXX(W(1,15  ),W(1,11  ),GULN1P ,MUL     ,WUL     ,W(1,       
     &     23  ))                                                          
      CALL IOSXXX(W(1,5   ),W(1,16  ),W(1,23  ),GULN1M ,AMP(13  ))         
      CALL HIOXXX(W(1,15  ),W(1,11  ),GURN1P ,MUR     ,WUR     ,W(1,       
     &     24  ))                                                          
      CALL IOSXXX(W(1,5   ),W(1,16  ),W(1,24  ),GURN1M ,AMP(14  ))         
      do i=1,ngraphs
         if(ihel.eq.-1)then
