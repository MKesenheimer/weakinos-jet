      SUBROUTINE SB_CL_019_003(P1,ANS)
C  
...
C  
      ...
      common/to_amps_019/  amp2,       jamp2

      integer j,jj
      integer max_bhel
      parameter ( max_bhel =          32 )
      double complex saveamp(ngraphs,max_bhel)
      common/to_saveamp_019/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_019/savemom
...
C          write (*,*) "momenta not the same in Born"
     ...
     &       nhel(5,ihel).eq.-1) THEN
                 T=B_CL_019_003(P1,NHEL(1,IHEL),IHEL,JC(1),T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_019_003(P,NHEL,HELL,IC,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,4   ),W(1,2   ),GB1N1P ,MBL     ,WB1     ,W(1,       
     &     6   ))                                                          
      CALL FVIXXX(W(1,1   ),W(1,5   ),GG ,BMASS   ,ZERO    ,W(1,7   ))     
      CALL IOSXXX(W(1,7   ),W(1,3   ),W(1,6   ),GB1N1M ,AMP(1   ))         
      CALL HIOXXX(W(1,4   ),W(1,2   ),GB2N1P ,MBR     ,WB2     ,W(1,       
     &     8   ))                                                          
      CALL IOSXXX(W(1,7   ),W(1,3   ),W(1,8   ),GB2N1M ,AMP(2   ))         
      CALL HIOXXX(W(1,1   ),W(1,3   ),GB1N1M ,MBL     ,WB1     ,W(1,       
     &     9   ))                                                          
      CALL FSIXXX(W(1,4   ),W(1,9   ),GB1N1P ,BMASS   ,ZERO    ,W(1,       
     &     10  ))                                                          
      CALL IOVXXX(W(1,10  ),W(1,2   ),W(1,5   ),GG ,AMP(3   ))             
      CALL HIOXXX(W(1,1   ),W(1,3   ),GB2N1M ,MBR     ,WB2     ,W(1,       
     &     11  ))                                                          
      CALL FSIXXX(W(1,4   ),W(1,11  ),GB2N1P ,BMASS   ,ZERO    ,W(1,       
     &     12  ))                                                          
      CALL IOVXXX(W(1,12  ),W(1,2   ),W(1,5   ),GG ,AMP(4   ))             
      CALL VSSXXX(W(1,5   ),W(1,6   ),W(1,9   ),GC ,AMP(5   ))             
      CALL VSSXXX(W(1,5   ),W(1,8   ),W(1,11  ),GC ,AMP(6   ))             
      CALL JIOXXX(W(1,4   ),W(1,3   ),GZN11 ,ZMASS   ,ZWIDTH  ,W(1,        
     &     13  ))                                                          
      CALL IOVXXX(W(1,7   ),W(1,2   ),W(1,13  ),GZD ,AMP(7   ))            
      CALL HIOXXX(W(1,4   ),W(1,3   ),GH1N11 ,MH1     ,WH1     ,W(1,       
     &     14  ))                                                          
      CALL IOSXXX(W(1,7   ),W(1,2   ),W(1,14  ),GH1BB ,AMP(8   ))          
      CALL HIOXXX(W(1,4   ),W(1,3   ),GH2N11 ,MH2     ,WH2     ,W(1,       
     &     15  ))                                                          
      CALL IOSXXX(W(1,7   ),W(1,2   ),W(1,15  ),GH2BB ,AMP(9   ))          
      CALL HIOXXX(W(1,4   ),W(1,3   ),GH3N11 ,MH3     ,WH3     ,W(1,       
     &     16  ))                                                          
      CALL IOSXXX(W(1,7   ),W(1,2   ),W(1,16  ),GH3BB ,AMP(10  ))          
      CALL FVOXXX(W(1,2   ),W(1,5   ),GG ,BMASS   ,ZERO    ,W(1,17  ))     
      CALL IOVXXX(W(1,1   ),W(1,17  ),W(1,13  ),GZD ,AMP(11  ))            
      CALL IOSXXX(W(1,1   ),W(1,17  ),W(1,14  ),GH1BB ,AMP(12  ))          
      CALL IOSXXX(W(1,1   ),W(1,17  ),W(1,15  ),GH2BB ,AMP(13  ))          
      CALL IOSXXX(W(1,1   ),W(1,17  ),W(1,16  ),GH3BB ,AMP(14  ))          
      CALL IXXXXX(P(0,3   ),MN1 ,NHEL(3   ),-1*IC(3   ),W(1,18  ))         
      CALL OXXXXX(P(0,4   ),MN1 ,NHEL(4   ),+1*IC(4   ),W(1,19  ))         
      CALL HIOXXX(W(1,18  ),W(1,2   ),GB1N1P ,MBL     ,WB1     ,W(1,       
     &     20  ))                                                          
      CALL FSOXXX(W(1,19  ),W(1,20  ),GB1N1M ,BMASS   ,ZERO    ,W(1,       
     &     21  ))                                                          
      CALL IOVXXX(W(1,1   ),W(1,21  ),W(1,5   ),GG ,AMP(15  ))             
      CALL HIOXXX(W(1,18  ),W(1,2   ),GB2N1P ,MBR     ,WB2     ,W(1,       
     &     22  ))                                                          
      CALL FSOXXX(W(1,19  ),W(1,22  ),GB2N1M ,BMASS   ,ZERO    ,W(1,       
     &     23  ))                                                          
      CALL IOVXXX(W(1,1   ),W(1,23  ),W(1,5   ),GG ,AMP(16  ))             
      CALL HIOXXX(W(1,1   ),W(1,19  ),GB1N1M ,MBL     ,WB1     ,W(1,       
     &     24  ))                                                          
      CALL IOSXXX(W(1,18  ),W(1,17  ),W(1,24  ),GB1N1P ,AMP(17  ))         
      CALL HIOXXX(W(1,1   ),W(1,19  ),GB2N1M ,MBR     ,WB2     ,W(1,       
     &     25  ))                                                          
      CALL IOSXXX(W(1,18  ),W(1,17  ),W(1,25  ),GB2N1P ,AMP(18  ))         
      CALL VSSXXX(W(1,5   ),W(1,20  ),W(1,24  ),GC ,AMP(19  ))             
      CALL VSSXXX(W(1,5   ),W(1,22  ),W(1,25  ),GC ,AMP(20  ))             
      do i=1,ngraphs
         if(ihel.eq.-1)then
     ...
     &             -AMP(  16)-AMP(  17)-AMP(  18)-AMP(  19)-AMP(  20)
      DO I = 1, NCOLOR
          ...
          if (ihel.eq.-1) then
             B_CL_019_003=B_CL_019_003 +RTEMP
          elseif (ihel.eq.1) then
             B_CL_019_003=B_CL_019_003 +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
