      SUBROUTINE SB_CL_009_003(P1,ANS)
C  
...
C  
C FOR PROCESS : c~ c -> n1 n1 g g  
C  
C BORN AMPLITUDE IS c~ c -> n1 n1 g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_009/  amp2,       jamp2

      integer j,jj
      integer max_bhel
      parameter ( max_bhel =          32 )
      double complex saveamp(ngraphs,max_bhel)
      common/to_saveamp_009/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_009/savemom
...
C          write (*,*) "momenta not the same in Born"
     ...
     &       nhel(5,ihel).eq.-1) THEN
                 T=B_CL_009_003(P1,NHEL(1,IHEL),IHEL,JC(1),T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_009_003(P,NHEL,HELL,IC,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,2   ),W(1,3   ),GULN1M ,MCL     ,WCL     ,W(1,       
     &     6   ))                                                          
      CALL FSIXXX(W(1,4   ),W(1,6   ),GULN1P ,ZERO    ,ZERO    ,W(1,       
     &     7   ))                                                          
      CALL IOVXXX(W(1,7   ),W(1,1   ),W(1,5   ),GG ,AMP(1   ))             
      CALL HIOXXX(W(1,2   ),W(1,3   ),GURN1M ,MCR     ,WCR     ,W(1,       
     &     8   ))                                                          
      CALL FSIXXX(W(1,4   ),W(1,8   ),GURN1P ,ZERO    ,ZERO    ,W(1,       
     &     9   ))                                                          
      CALL IOVXXX(W(1,9   ),W(1,1   ),W(1,5   ),GG ,AMP(2   ))             
      CALL HIOXXX(W(1,4   ),W(1,1   ),GULN1P ,MCL     ,WCL     ,W(1,       
     &     10  ))                                                          
      CALL FVIXXX(W(1,2   ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
      CALL IOSXXX(W(1,11  ),W(1,3   ),W(1,10  ),GULN1M ,AMP(3   ))         
      CALL HIOXXX(W(1,4   ),W(1,1   ),GURN1P ,MCR     ,WCR     ,W(1,       
     &     12  ))                                                          
      CALL IOSXXX(W(1,11  ),W(1,3   ),W(1,12  ),GURN1M ,AMP(4   ))         
     ...
     &     13  ))                                                          
      ...
      CALL IOVXXX(W(1,2   ),W(1,14  ),W(1,13  ),GZU ,AMP(7   ))            
      CALL IOVXXX(W(1,11  ),W(1,1   ),W(1,13  ),GZU ,AMP(8   ))            
      CALL IXXXXX(P(0,3   ),MN1 ,NHEL(3   ),-1*IC(3   ),W(1,15  ))         
      CALL OXXXXX(P(0,4   ),MN1 ,NHEL(4   ),+1*IC(4   ),W(1,16  ))         
      CALL HIOXXX(W(1,2   ),W(1,16  ),GULN1M ,MCL     ,WCL     ,W(1,       
     &     17  ))                                                          
      CALL IOSXXX(W(1,15  ),W(1,14  ),W(1,17  ),GULN1P ,AMP(9   ))         
      CALL HIOXXX(W(1,2   ),W(1,16  ),GURN1M ,MCR     ,WCR     ,W(1,       
     &     18  ))                                                          
      CALL IOSXXX(W(1,15  ),W(1,14  ),W(1,18  ),GURN1P ,AMP(10  ))         
      CALL HIOXXX(W(1,15  ),W(1,1   ),GULN1P ,MCL     ,WCL     ,W(1,       
     &     19  ))                                                          
      CALL FSOXXX(W(1,16  ),W(1,19  ),GULN1M ,ZERO    ,ZERO    ,W(1,       
     &     20  ))                                                          
      CALL IOVXXX(W(1,2   ),W(1,20  ),W(1,5   ),GG ,AMP(11  ))             
      CALL HIOXXX(W(1,15  ),W(1,1   ),GURN1P ,MCR     ,WCR     ,W(1,       
     &     21  ))                                                          
      CALL FSOXXX(W(1,16  ),W(1,21  ),GURN1M ,ZERO    ,ZERO    ,W(1,       
     &     22  ))                                                          
     ...
     &             +AMP(  11)+AMP(  12)+AMP(  13)+AMP(  14)
      DO I = 1, NCOLOR
          ...
          if (ihel.eq.-1) then
             B_CL_009_003=B_CL_009_003 +RTEMP
          elseif (ihel.eq.1) then
             B_CL_009_003=B_CL_009_003 +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
