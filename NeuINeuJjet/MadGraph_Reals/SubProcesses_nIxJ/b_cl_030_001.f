      SUBROUTINE SB_CL_030_001(P1,ANS)
C  
...
C  
C FOR PROCESS : g b -> n1 n1 b g  
C  
C BORN AMPLITUDE IS g b -> n1 n1 b  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_030/  amp2,       jamp2

      integer j,jj
      integer max_bhel
      parameter ( max_bhel =          32 )
      double complex saveamp(ngraphs,max_bhel)
      common/to_saveamp_030/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_030/savemom
...
C          write (*,*) "momenta not the same in Born"
     ...
     &       nhel(1,ihel).eq.-1) THEN
                 T=B_CL_030_001(P1,NHEL(1,IHEL),IHEL,JC(1),T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_030_001(P,NHEL,HELL,IC,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     15  ))                                                          
      CALL FVOXXX(W(1,5   ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,16  ))     
      CALL IOVXXX(W(1,2   ),W(1,16  ),W(1,15  ),GZD ,AMP(7   ))            
      CALL HIOXXX(W(1,4   ),W(1,3   ),GH1N11 ,MH1     ,WH1     ,W(1,       
     &     17  ))                                                          
      CALL IOSXXX(W(1,2   ),W(1,16  ),W(1,17  ),GH1BB ,AMP(8   ))          
      CALL HIOXXX(W(1,4   ),W(1,3   ),GH2N11 ,MH2     ,WH2     ,W(1,       
     &     18  ))                                                          
      CALL IOSXXX(W(1,2   ),W(1,16  ),W(1,18  ),GH2BB ,AMP(9   ))          
      CALL HIOXXX(W(1,4   ),W(1,3   ),GH3N11 ,MH3     ,WH3     ,W(1,       
     &     19  ))                                                          
      CALL IOSXXX(W(1,2   ),W(1,16  ),W(1,19  ),GH3BB ,AMP(10  ))          
     ...
     &             -AMP(  16)-AMP(  17)-AMP(  18)-AMP(  19)-AMP(  20)
      DO I = 1, NCOLOR
          ...
          if (ihel.eq.-1) then
             B_CL_030_001=B_CL_030_001 +RTEMP
          elseif (ihel.eq.1) then
             B_CL_030_001=B_CL_030_001 +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
