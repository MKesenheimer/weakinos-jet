      SUBROUTINE SB_CL_011_003(P1,ANS)
C  
...
C  
      ...
      common/to_amps_011/  amp2,       jamp2

      integer j,jj
      integer max_bhel
      parameter ( max_bhel =          32 )
      double complex saveamp(ngraphs,max_bhel)
      common/to_saveamp_011/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_011/savemom
...
C          write (*,*) "momenta not the same in Born"
     ...
     &       nhel(5,ihel).eq.-1) THEN
                 T=B_CL_011_003(P1,NHEL(1,IHEL),IHEL,JC(1),T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_011_003(P,NHEL,HELL,IC,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,4   ),W(1,2   ),GULN1P ,MCL     ,WCL     ,W(1,       
     &     6   ))                                                          
      CALL FVIXXX(W(1,1   ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,7   ))     
      CALL IOSXXX(W(1,7   ),W(1,3   ),W(1,6   ),GULN1M ,AMP(1   ))         
      CALL HIOXXX(W(1,4   ),W(1,2   ),GURN1P ,MCR     ,WCR     ,W(1,       
     &     8   ))                                                          
     ...
     &             -AMP(  11)-AMP(  12)-AMP(  13)-AMP(  14)
      DO I = 1, NCOLOR
          ...
          if (ihel.eq.-1) then
             B_CL_011_003=B_CL_011_003 +RTEMP
          elseif (ihel.eq.1) then
             B_CL_011_003=B_CL_011_003 +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
