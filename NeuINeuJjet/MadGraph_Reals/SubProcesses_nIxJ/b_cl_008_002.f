...
C ----------
      ...
      CALL HIOXXX(W(1,1   ),W(1,3   ),GULN1M ,MUL     ,WUL     ,W(1,       
     &     6   ))                                                          
      CALL FSIXXX(W(1,4   ),W(1,6   ),GULN1P ,ZERO    ,ZERO    ,W(1,       
     &     7   ))                                                          
      CALL IOVXXX(W(1,7   ),W(1,5   ),W(1,2   ),GG ,AMP(1   ))             
      CALL HIOXXX(W(1,1   ),W(1,3   ),GURN1M ,MUR     ,WUR     ,W(1,       
     &     8   ))                                                          
      CALL FSIXXX(W(1,4   ),W(1,8   ),GURN1P ,ZERO    ,ZERO    ,W(1,       
     &     9   ))                                                          
      CALL IOVXXX(W(1,9   ),W(1,5   ),W(1,2   ),GG ,AMP(2   ))             
      CALL HVSXXX(W(1,2   ),W(1,6   ),-GC ,MUL     ,WUL     ,W(1,10  ))    
      CALL IOSXXX(W(1,4   ),W(1,5   ),W(1,10  ),GULN1P ,AMP(3   ))         
      CALL HVSXXX(W(1,2   ),W(1,8   ),-GC ,MUR     ,WUR     ,W(1,11  ))    
      CALL IOSXXX(W(1,4   ),W(1,5   ),W(1,11  ),GURN1P ,AMP(4   ))         
      CALL FVIXXX(W(1,1   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,12  ))     
      CALL HIOXXX(W(1,12  ),W(1,3   ),GULN1M ,MUL     ,WUL     ,W(1,       
     &     13  ))                                                          
      CALL IOSXXX(W(1,4   ),W(1,5   ),W(1,13  ),GULN1P ,AMP(5   ))         
      CALL HIOXXX(W(1,12  ),W(1,3   ),GURN1M ,MUR     ,WUR     ,W(1,       
     &     14  ))                                                          
      CALL IOSXXX(W(1,4   ),W(1,5   ),W(1,14  ),GURN1P ,AMP(6   ))         
     ...
     &     15  ))                                                          
      ...
      CALL IXXXXX(P(0,3   ),MN1 ,NHEL(3   ),-1*IC(3   ),W(1,17  ))         
      CALL OXXXXX(P(0,4   ),MN1 ,NHEL(4   ),+1*IC(4   ),W(1,18  ))         
      CALL HIOXXX(W(1,1   ),W(1,18  ),GULN1M ,MUL     ,WUL     ,W(1,       
     &     19  ))                                                          
      CALL IOSXXX(W(1,17  ),W(1,16  ),W(1,19  ),GULN1P ,AMP(9   ))         
      CALL HIOXXX(W(1,1   ),W(1,18  ),GURN1M ,MUR     ,WUR     ,W(1,       
     &     20  ))                                                          
      CALL IOSXXX(W(1,17  ),W(1,16  ),W(1,20  ),GURN1P ,AMP(10  ))         
      CALL HIOXXX(W(1,17  ),W(1,5   ),GULN1P ,MUL     ,WUL     ,W(1,       
     &     21  ))                                                          
      CALL VSSXXX(W(1,2   ),W(1,21  ),W(1,19  ),GC ,AMP(11  ))             
      CALL HIOXXX(W(1,17  ),W(1,5   ),GURN1P ,MUR     ,WUR     ,W(1,       
     &     22  ))                                                          
      CALL VSSXXX(W(1,2   ),W(1,22  ),W(1,20  ),GC ,AMP(12  ))             
      CALL HIOXXX(W(1,12  ),W(1,18  ),GULN1M ,MUL     ,WUL     ,W(1,       
     &     23  ))                                                          
      CALL IOSXXX(W(1,17  ),W(1,5   ),W(1,23  ),GULN1P ,AMP(13  ))         
      CALL HIOXXX(W(1,12  ),W(1,18  ),GURN1M ,MUR     ,WUR     ,W(1,       
     &     24  ))                                                          
      CALL IOSXXX(W(1,17  ),W(1,5   ),W(1,24  ),GURN1P ,AMP(14  ))         
      do i=1,ngraphs
         if(ihel.eq.-1)then
