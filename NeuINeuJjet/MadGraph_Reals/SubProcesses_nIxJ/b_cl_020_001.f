...
C          write (*,*) "momenta not the same in Born"
     ...
     &       nhel(1,ihel).eq.-1) THEN
                 T=B_CL_020_001(P1,NHEL(1,IHEL),IHEL,JC(1),T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_020_001(P,NHEL,HELL,IC,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,2   ),W(1,3   ),GULN1M ,MUL     ,WUL     ,W(1,       
     &     6   ))                                                          
      CALL FSIXXX(W(1,4   ),W(1,6   ),GULN1P ,ZERO    ,ZERO    ,W(1,       
     &     7   ))                                                          
      CALL IOVXXX(W(1,7   ),W(1,5   ),W(1,1   ),GG ,AMP(1   ))             
      CALL HIOXXX(W(1,2   ),W(1,3   ),GURN1M ,MUR     ,WUR     ,W(1,       
     &     8   ))                                                          
     ...
     &     15  ))                                                          
      ...
      CALL HIOXXX(W(1,2   ),W(1,18  ),GULN1M ,MUL     ,WUL     ,W(1,       
     &     19  ))                                                          
      CALL IOSXXX(W(1,17  ),W(1,16  ),W(1,19  ),GULN1P ,AMP(9   ))         
      CALL HIOXXX(W(1,2   ),W(1,18  ),GURN1M ,MUR     ,WUR     ,W(1,       
     &     20  ))                                                          
     ...
     &             -AMP(  11)-AMP(  12)-AMP(  13)-AMP(  14)
      DO I = 1, NCOLOR
          ...
          if (ihel.eq.-1) then
             B_CL_020_001=B_CL_020_001 +RTEMP
          elseif (ihel.eq.1) then
             B_CL_020_001=B_CL_020_001 +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
