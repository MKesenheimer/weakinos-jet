...
C ----------
     ...
     &     13  ))                                                          
      ...
      CALL HIOXXX(W(1,2   ),W(1,16  ),GDLN1M ,MDL     ,WDL     ,W(1,       
     &     17  ))                                                          
      CALL IOSXXX(W(1,15  ),W(1,14  ),W(1,17  ),GDLN1P ,AMP(9   ))         
      CALL HIOXXX(W(1,2   ),W(1,16  ),GDRN1M ,MDR     ,WDR     ,W(1,       
     &     18  ))                                                          
      CALL IOSXXX(W(1,15  ),W(1,14  ),W(1,18  ),GDRN1P ,AMP(10  ))         
      CALL HIOXXX(W(1,15  ),W(1,1   ),GDLN1P ,MDL     ,WDL     ,W(1,       
     &     19  ))                                                          
      CALL FSOXXX(W(1,16  ),W(1,19  ),GDLN1M ,ZERO    ,ZERO    ,W(1,       
     &     20  ))                                                          
      CALL IOVXXX(W(1,2   ),W(1,20  ),W(1,5   ),GG ,AMP(11  ))             
      CALL HIOXXX(W(1,15  ),W(1,1   ),GDRN1P ,MDR     ,WDR     ,W(1,       
     &     21  ))                                                          
      CALL FSOXXX(W(1,16  ),W(1,21  ),GDRN1M ,ZERO    ,ZERO    ,W(1,       
     &     22  ))                                                          
