      SUBROUTINE SB_CL_010_002(P1,ANS)
C  
...
C  
      ...
      common/to_amps_010/  amp2,       jamp2

      integer j,jj
      integer max_bhel
      parameter ( max_bhel =          32 )
      double complex saveamp(ngraphs,max_bhel)
      common/to_saveamp_010/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_010/savemom
...
C          write (*,*) "momenta not the same in Born"
     ...
     &       nhel(2,ihel).eq.-1) THEN
                 T=B_CL_010_002(P1,NHEL(1,IHEL),IHEL,JC(1),T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_010_002(P,NHEL,HELL,IC,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     8   ))                                                          
      ...
      CALL HIOXXX(W(1,5   ),W(1,3   ),GULN1M ,MCL     ,WCL     ,W(1,       
     &     9   ))                                                          
      CALL VSSXXX(W(1,2   ),W(1,6   ),W(1,9   ),GC ,AMP(3   ))             
      CALL HIOXXX(W(1,5   ),W(1,3   ),GURN1M ,MCR     ,WCR     ,W(1,       
     &     10  ))                                                          
      CALL VSSXXX(W(1,2   ),W(1,8   ),W(1,10  ),GC ,AMP(4   ))             
      CALL FVOXXX(W(1,1   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
      CALL HIOXXX(W(1,4   ),W(1,11  ),GULN1P ,MCL     ,WCL     ,W(1,       
     &     12  ))                                                          
      CALL IOSXXX(W(1,5   ),W(1,3   ),W(1,12  ),GULN1M ,AMP(5   ))         
      CALL HIOXXX(W(1,4   ),W(1,11  ),GURN1P ,MCR     ,WCR     ,W(1,       
     &     13  ))                                                          
     ...
     &     20  ))                                                          
      ...
      CALL HVSXXX(W(1,2   ),W(1,17  ),GC ,MCL     ,WCL     ,W(1,21  ))     
      CALL IOSXXX(W(1,5   ),W(1,16  ),W(1,21  ),GULN1M ,AMP(11  ))         
      CALL HVSXXX(W(1,2   ),W(1,19  ),GC ,MCR     ,WCR     ,W(1,22  ))     
      CALL IOSXXX(W(1,5   ),W(1,16  ),W(1,22  ),GURN1M ,AMP(12  ))         
      CALL HIOXXX(W(1,15  ),W(1,11  ),GULN1P ,MCL     ,WCL     ,W(1,       
     &     23  ))                                                          
      CALL IOSXXX(W(1,5   ),W(1,16  ),W(1,23  ),GULN1M ,AMP(13  ))         
      CALL HIOXXX(W(1,15  ),W(1,11  ),GURN1P ,MCR     ,WCR     ,W(1,       
     &     24  ))                                                          
     ...
     &             +AMP(  11)+AMP(  12)+AMP(  13)+AMP(  14)
      DO I = 1, NCOLOR
          ...
          if (ihel.eq.-1) then
             B_CL_010_002=B_CL_010_002 +RTEMP
          elseif (ihel.eq.1) then
             B_CL_010_002=B_CL_010_002 +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
