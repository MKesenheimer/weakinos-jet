      SUBROUTINE SB_CL_015_003(P1,ANS)
C  
...
C  
C FOR PROCESS : s s~ -> n1 n1 g g  
C  
C BORN AMPLITUDE IS s s~ -> n1 n1 g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_015/  amp2,       jamp2

      integer j,jj
      integer max_bhel
      parameter ( max_bhel =          32 )
      double complex saveamp(ngraphs,max_bhel)
      common/to_saveamp_015/saveamp
      double precision savemom(nexternal-1,2)
      common/to_savemom_015/savemom
...
C          write (*,*) "momenta not the same in Born"
     ...
     &       nhel(5,ihel).eq.-1) THEN
                 T=B_CL_015_003(P1,NHEL(1,IHEL),IHEL,JC(1),T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_015_003(P,NHEL,HELL,IC,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,4   ),W(1,2   ),GDLN1P ,MSL     ,WSL     ,W(1,       
     &     6   ))                                                          
      CALL FVIXXX(W(1,1   ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,7   ))     
      CALL IOSXXX(W(1,7   ),W(1,3   ),W(1,6   ),GDLN1M ,AMP(1   ))         
      CALL HIOXXX(W(1,4   ),W(1,2   ),GDRN1P ,MSR     ,WSR     ,W(1,       
     &     8   ))                                                          
      CALL IOSXXX(W(1,7   ),W(1,3   ),W(1,8   ),GDRN1M ,AMP(2   ))         
      CALL HIOXXX(W(1,1   ),W(1,3   ),GDLN1M ,MSL     ,WSL     ,W(1,       
     &     9   ))                                                          
      CALL FSIXXX(W(1,4   ),W(1,9   ),GDLN1P ,ZERO    ,ZERO    ,W(1,       
     &     10  ))                                                          
      CALL IOVXXX(W(1,10  ),W(1,2   ),W(1,5   ),GG ,AMP(3   ))             
      CALL HIOXXX(W(1,1   ),W(1,3   ),GDRN1M ,MSR     ,WSR     ,W(1,       
     &     11  ))                                                          
      CALL FSIXXX(W(1,4   ),W(1,11  ),GDRN1P ,ZERO    ,ZERO    ,W(1,       
     &     12  ))                                                          
     ...
     &     13  ))                                                          
      ...
      CALL IOVXXX(W(1,1   ),W(1,14  ),W(1,13  ),GZD ,AMP(8   ))            
      CALL IXXXXX(P(0,3   ),MN1 ,NHEL(3   ),-1*IC(3   ),W(1,15  ))         
      CALL OXXXXX(P(0,4   ),MN1 ,NHEL(4   ),+1*IC(4   ),W(1,16  ))         
      CALL HIOXXX(W(1,15  ),W(1,2   ),GDLN1P ,MSL     ,WSL     ,W(1,       
     &     17  ))                                                          
      CALL FSOXXX(W(1,16  ),W(1,17  ),GDLN1M ,ZERO    ,ZERO    ,W(1,       
     &     18  ))                                                          
      CALL IOVXXX(W(1,1   ),W(1,18  ),W(1,5   ),GG ,AMP(9   ))             
      CALL HIOXXX(W(1,15  ),W(1,2   ),GDRN1P ,MSR     ,WSR     ,W(1,       
     &     19  ))                                                          
      CALL FSOXXX(W(1,16  ),W(1,19  ),GDRN1M ,ZERO    ,ZERO    ,W(1,       
     &     20  ))                                                          
      CALL IOVXXX(W(1,1   ),W(1,20  ),W(1,5   ),GG ,AMP(10  ))             
      CALL HIOXXX(W(1,1   ),W(1,16  ),GDLN1M ,MSL     ,WSL     ,W(1,       
     &     21  ))                                                          
      CALL IOSXXX(W(1,15  ),W(1,14  ),W(1,21  ),GDLN1P ,AMP(11  ))         
      CALL HIOXXX(W(1,1   ),W(1,16  ),GDRN1M ,MSR     ,WSR     ,W(1,       
     &     22  ))                                                          
      CALL IOSXXX(W(1,15  ),W(1,14  ),W(1,22  ),GDRN1P ,AMP(12  ))         
      CALL VSSXXX(W(1,5   ),W(1,17  ),W(1,21  ),GC ,AMP(13  ))             
      CALL VSSXXX(W(1,5   ),W(1,19  ),W(1,22  ),GC ,AMP(14  ))             
      do i=1,ngraphs
         if(ihel.eq.-1)then
     ...
     &             -AMP(  11)-AMP(  12)-AMP(  13)-AMP(  14)
      DO I = 1, NCOLOR
          ...
          if (ihel.eq.-1) then
             B_CL_015_003=B_CL_015_003 +RTEMP
          elseif (ihel.eq.1) then
             B_CL_015_003=B_CL_015_003 +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
