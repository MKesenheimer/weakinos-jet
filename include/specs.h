...
* generated by FormCalc 9.4 (7 Jun 2016) on 29-Nov-2016 15:51
#endif
...
#undef PROCNAME
#define PROCNAME "Fb4iiF4iiF11iF11iV5i"
...
#undef Mass
#define Mass(f,c) Compose(f,c,Mf(4,Gen1),Mf(4,Gen2),MNeu(Neu3),MNeu(Neu4),0)
