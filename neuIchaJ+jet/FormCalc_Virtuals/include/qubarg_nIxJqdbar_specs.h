...
* generated by FormCalc 9.4 (7 Jun 2016) on 16-May-2017 20:58
#endif
...
#undef PROCNAME
#define PROCNAME "Fb3iiV5iF11iF12iFb4ii"
...
#undef Mass
#define Mass(f,c) Compose(f,c,Mf(3,Gen(1)),0,MNeu(Neu(3)),MCha(Cha(4)),Mf(4,Gen(5)))

#undef Charge
#define Charge(f,c) Compose(f,c,-2/3.D0,0,0,-1,1/3.D0)
