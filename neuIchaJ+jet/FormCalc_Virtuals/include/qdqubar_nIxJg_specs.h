...
* generated by FormCalc 9.4 (7 Jun 2016) on 16-May-2017 19:14
#endif
...
#undef PROCNAME
#define PROCNAME "F4iiFb3iiF11iF12iV5i"
...
#undef Mass
#define Mass(f,c) Compose(f,c,Mf(4,Gen(1)),Mf(3,Gen(2)),MNeu(Neu(3)),MCha(Cha(4)),0)

#undef Charge
#define Charge(f,c) Compose(f,c,-1/3.D0,-2/3.D0,0,-1,0)
