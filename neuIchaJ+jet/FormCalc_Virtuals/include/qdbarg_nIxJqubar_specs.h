...
* generated by FormCalc 9.4 (7 Jun 2016) on 16-May-2017 19:41
#endif
...
#undef PROCNAME
#define PROCNAME "Fb4iiV5iF11iFb12iFb3ii"
...
#undef Mass
#define Mass(f,c) Compose(f,c,Mf(4,Gen(1)),0,MNeu(Neu(3)),MCha(Cha(4)),Mf(3,Gen(5)))

#undef Charge
#define Charge(f,c) Compose(f,c,1/3.D0,0,0,1,-2/3.D0)
