      SUBROUTINE SMATRIX_CBX_NIXJSBX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_cbx_nIxJsbx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_CBX_NIXJSBX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_CBX_NIXJSBX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,8),W(1,2),GB1GOP,MBL,WBL,W(1,9))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,9),GB1NIM,AMP(1))         
      CALL HIOXXX(W(1,8),W(1,2),GB2GOP,MBR,WBR,W(1,10))                                                          
      ...
      CALL HIOXXX(W(1,31),W(1,2),GB1GOP,MBL,WBL,W(1,32))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,32),GB1NIM,AMP(11))         
      CALL HIOXXX(W(1,31),W(1,2),GB2GOP,MBR,WBR,W(1,33))                                                          
      ...
      CALL HIOXXX(W(1,34),W(1,2),GB1NIP,MBL,WBL,W(1,36))                                                          
      CALL IOSCXX(W(1,8),W(1,35),W(1,36),GB1GOM,AMP(13))        
      CALL HIOXXX(W(1,34),W(1,2),GB2NIP,MBR,WBR,W(1,37))                                                          
      CALL IOSCXX(W(1,8),W(1,35),W(1,37),GB2GOM,AMP(14))        
     ...
     &             +AMP(  16)
      MATRIX_CBX_NIXJSBX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_CBX_NIXJSBX =MATRIX_CBX_NIXJSBX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
