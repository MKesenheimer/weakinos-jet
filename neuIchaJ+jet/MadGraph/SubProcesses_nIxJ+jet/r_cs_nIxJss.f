      SUBROUTINE SMATRIX_CS_NIXJSS(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_cs_nIxJss/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_CS_NIXJSS(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_CS_NIXJSS(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,1),W(1,13),GQLGOM,MCL,WCL,W(1,14))                                                          
      CALL IOSXXX(W(1,4),W(1,6),W(1,14),GULXJP,AMP(4))         
      CALL HIOXXX(W(1,1),W(1,3),GULNIM,MCL,WCL,W(1,15))                                                          
      ...
      CALL HVSXXX(W(1,21),W(1,15),-GC,MCL,WCL,W(1,22))    
      ...
      CALL HIOXXX(W(1,1),W(1,30),GDLXJM,MSL,WSL,W(1,32))                                                          
      CALL HVSXXX(W(1,21),W(1,32),-GC,MSL,WSL,W(1,33))    
      ...
      CALL HIOXXX(W(1,2),W(1,35),GQRGOM,MSR,WSR,W(1,37))                                                          
      CALL IOSCXX(W(1,31),W(1,3),W(1,37),GDRNIP,AMP(18))        
      CALL HIOXXX(W(1,23),W(1,30),GDLXJM,MSL,WSL,W(1,38))                                                          
      ...
      CALL HIOCXX(W(1,9),W(1,48),GQLGOM,MSL,WSL,W(1,49))                                                          
      CALL IOSCXX(W(1,31),W(1,3),W(1,49),GDLNIP,AMP(29))        
      CALL HIOCXX(W(1,9),W(1,48),GQRGOM,MSR,WSR,W(1,50))                                                          
     ...
     &             +AMP(  32)
      MATRIX_CS_NIXJSS = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_CS_NIXJSS =MATRIX_CS_NIXJSS+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
