      SUBROUTINE SMATRIX_UUX_NIXJDXU(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_uux_nIxJdxu/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_UUX_NIXJDXU(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_UUX_NIXJDXU(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,1),W(1,8),GQLGOM,MUL,WUL,W(1,9))                                                          
      CALL IOSCXX(W(1,6),W(1,3),W(1,9),GULNIP,AMP(1))        
      CALL HIOXXX(W(1,1),W(1,8),GQRGOM,MUR,WUR,W(1,10))                                                          
      ...
      CALL HIOXXX(W(1,1),W(1,3),GURNIM,MUR,WUR,W(1,19))                                                          
      ...
      CALL HIOXXX(W(1,1),W(1,41),GQLGOM,MUL,WUL,W(1,42))                                                          
      CALL IOSCXX(W(1,6),W(1,3),W(1,42),GULNIP,AMP(24))        
      CALL HIOXXX(W(1,1),W(1,41),GQRGOM,MUR,WUR,W(1,43))                                                          
      CALL IOSCXX(W(1,6),W(1,3),W(1,43),GURNIP,AMP(25))        
      CALL IXXXXX(P(0,3),MNI,NHEL(3),-1*IC(3),W(1,44))         
      CALL HIOXXX(W(1,44),W(1,2),GULNIP,MUL,WUL,W(1,45))                                                          
      ...
      CALL IOVXXX(W(1,1),W(1,27),W(1,48),GG,AMP(27))             
      CALL FSIXXX(W(1,1),W(1,45),GQLGOM,MGO,WGO,W(1,49))                                                          
      CALL IOSXXX(W(1,49),W(1,27),W(1,7),GQLGOP,AMP(28))         
      CALL HIOXXX(W(1,44),W(1,2),GURNIP,MUR,WUR,W(1,50))                                                          
      ...
      CALL IOVXXX(W(1,1),W(1,27),W(1,53),GG,AMP(30))             
     ...
     &             -AMP(  32)
      MATRIX_UUX_NIXJDXU = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_UUX_NIXJDXU =MATRIX_UUX_NIXJDXU+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
