      SUBROUTINE SMATRIX_SXU_NIXJDSX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_sxu_nIxJdsx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_SXU_NIXJDSX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_SXU_NIXJDSX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,31),W(1,1),GQLGOP,MSL,WSL,W(1,32))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,32),GDLNIM,AMP(11))         
      CALL HIOXXX(W(1,31),W(1,1),GQRGOP,MSR,WSR,W(1,33))                                                          
      ...
      CALL HIOXXX(W(1,34),W(1,1),GDLNIP,MSL,WSL,W(1,36))                                                          
     ...
     &             -AMP(  16)
      MATRIX_SXU_NIXJDSX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_SXU_NIXJDSX =MATRIX_SXU_NIXJDSX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
