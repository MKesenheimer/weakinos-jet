      SUBROUTINE SMATRIX_UXD_NIXJSSX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_uxd_nIxJssx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_UXD_NIXJSSX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_UXD_NIXJSSX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,22),W(1,14),GQLGOP,MSL,WSL,W(1,23))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,23),GDLNIM,AMP(8))         
      CALL HIOXXX(W(1,22),W(1,14),GQRGOP,MSR,WSR,W(1,24))                                                          
     ...
     &             -AMP(  16)
      MATRIX_UXD_NIXJSSX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_UXD_NIXJSSX =MATRIX_UXD_NIXJSSX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
