      SUBROUTINE SMATRIX_SXC_NIXJSSX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_sxc_nIxJssx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_SXC_NIXJSSX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_SXC_NIXJSSX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,4),W(1,1),GULXJP,MCL,WCL,W(1,15))                                                          
      ...
      CALL HIOXXX(W(1,19),W(1,5),GQLGOP,MSL,WSL,W(1,20))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,20),GDLNIM,AMP(7))         
      CALL HIOXXX(W(1,19),W(1,5),GQRGOP,MSR,WSR,W(1,21))                                                          
      ...
      CALL HIOXXX(W(1,2),W(1,37),GDLXJM,MSL,WSL,W(1,38))                                                          
      ...
      CALL HIOXXX(W(1,50),W(1,1),GDLNIP,MSL,WSL,W(1,51))                                                          
      CALL IOSCXX(W(1,22),W(1,34),W(1,51),GQLGOM,AMP(26))        
      CALL HIOXXX(W(1,50),W(1,1),GDRNIP,MSR,WSR,W(1,52))                                                          
     ...
     &             -AMP(  30)
      MATRIX_SXC_NIXJSSX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_SXC_NIXJSSX =MATRIX_SXC_NIXJSSX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
