      SUBROUTINE SMATRIX_BBX_NIXJBTX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_bbx_nIxJbtx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_BBX_NIXJBTX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_BBX_NIXJBTX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,2),W(1,25),GWF,TMASS,TWIDTH,W(1,27))    
      CALL IOVXXX(W(1,6),W(1,27),W(1,8),GG,AMP(17))             
      CALL FSOXXX(W(1,2),W(1,26),GHPQ,TMASS,TWIDTH,W(1,  28))                                                          
      CALL IOVXXX(W(1,6),W(1,28),W(1,8),GG,AMP(18))             
      CALL JIOXXX(W(1,1),W(1,2),GG,ZERO,ZERO,W(1,29))     
      ...
      CALL FSIXXX(W(1,1),W(1,41),GB1GOM,MGO,WGO,W(1,42))                                                          
      CALL HIOXXX(W(1,42),W(1,2),GB1GOP,MBL,WBL,W(1,43))                                                          
      CALL IOSCXX(W(1,4),W(1,40),W(1,43),GB1XJM,AMP(29))        
      CALL HIOXXX(W(1,42),W(1,2),GB2GOP,MBR,WBR,W(1,44))                                                          
      CALL IOSCXX(W(1,4),W(1,40),W(1,44),GB2XJM,AMP(30))        
      CALL HIOCXX(W(1,39),W(1,3),GB2NIP,MBR,WBR,W(1,45))                                                          
      CALL FSIXXX(W(1,1),W(1,45),GB2GOM,MGO,WGO,W(1,46))                                                          
      CALL HIOXXX(W(1,46),W(1,2),GB1GOP,MBL,WBL,W(1,47))                                                          
      CALL IOSCXX(W(1,4),W(1,40),W(1,47),GB1XJM,AMP(31))        
      CALL HIOXXX(W(1,46),W(1,2),GB2GOP,MBR,WBR,W(1,48))                                                          
      ...
      CALL FSIXXX(W(1,1),W(1,67),GB1GOM,MGO,WGO,W(1,73))                                                          
      ...
      CALL FSIXXX(W(1,1),W(1,69),GB2GOM,MGO,WGO,W(1,76))                                                          
     ...
     &             -AMP(  63)-AMP(  64)
      MATRIX_BBX_NIXJBTX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_BBX_NIXJBTX =MATRIX_BBX_NIXJBTX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
