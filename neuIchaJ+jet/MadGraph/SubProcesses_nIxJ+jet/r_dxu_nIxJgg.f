      SUBROUTINE SMATRIX_DXU_NIXJGG(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_dxu_nIxJgg/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_DXU_NIXJGG(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_DXU_NIXJGG(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,4),W(1,1),GULXJP,MUL,WUL,W(1,17))                                                          
      ...
      CALL HIOXXX(W(1,2),W(1,36),GDLXJM,MDL,WDL,W(1,37))                                                          
      ...
      CALL HIOXXX(W(1,35),W(1,10),GDLNIP,MDL,WDL,W(1,40))                                                          
      ...
      CALL HIOXXX(W(1,14),W(1,36),GDLXJM,MDL,WDL,W(1,43))                                                          
      CALL FSIXXX(W(1,35),W(1,43),GDLNIP,ZERO,ZERO,W(1,44))                                                          
      CALL IOVXXX(W(1,44),W(1,1),W(1,6),GG,AMP(30))             
      CALL HIOXXX(W(1,35),W(1,1),GDLNIP,MDL,WDL,W(1,45))                                                          
     ...
     &             -AMP(  32)+AMP(  36)-AMP(  37)+AMP(  38)+AMP(  40)
      MATRIX_DXU_NIXJGG = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_DXU_NIXJGG =MATRIX_DXU_NIXJGG+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
