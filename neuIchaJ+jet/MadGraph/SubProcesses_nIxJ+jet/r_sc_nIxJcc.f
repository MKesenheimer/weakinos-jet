      SUBROUTINE SMATRIX_SC_NIXJCC(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_sc_nIxJcc/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_SC_NIXJCC(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_SC_NIXJCC(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,2),W(1,11),GQRGOM,MCR,WCR,W(1,13))                                                          
      ...
      CALL HIOXXX(W(1,2),W(1,3),GULNIM,MCL,WCL,W(1,16))                                                          
      ...
      CALL HIOXXX(W(1,2),W(1,3),GURNIM,MCR,WCR,W(1,19))                                                          
      CALL FSOXXX(W(1,5),W(1,19),GQRGOP,MGO,WGO,W(1,20))                                                          
      CALL HIOXXX(W(1,1),W(1,20),GQLGOM,MSL,WSL,W(1,21))                                                          
      ...
      CALL HIOXXX(W(1,1),W(1,3),GDLNIM,MSL,WSL,W(1,22))                                                          
      CALL HVSXXX(W(1,8),W(1,22),-GC,MSL,WSL,W(1,23))    
      ...
      CALL HIOXXX(W(1,14),W(1,3),GDLNIM,MSL,WSL,W(1,25))                                                          
      ...
      CALL HIOCXX(W(1,26),W(1,3),GULNIP,MCL,WCL,W(1,29))                                                          
      ...
      CALL HIOCXX(W(1,26),W(1,3),GURNIP,MCR,WCR,W(1,32))                                                          
      ...
      CALL HIOCXX(W(1,26),W(1,4),GDLXJP,MSL,WSL,W(1,36))                                                          
      ...
      CALL HIOXXX(W(1,1),W(1,51),GQLGOM,MSL,WSL,W(1,52))                                                          
      CALL IOSCXX(W(1,6),W(1,4),W(1,52),GDLXJP,AMP(30))        
      CALL HIOCXX(W(1,37),W(1,48),GQLGOM,MCL,WCL,W(1,53))                                                          
      CALL IOSCXX(W(1,6),W(1,3),W(1,53),GULNIP,AMP(31))        
      CALL HIOCXX(W(1,37),W(1,48),GQRGOM,MCR,WCR,W(1,54))                                                          
     ...
     &             +AMP(  32)
      MATRIX_SC_NIXJCC = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_SC_NIXJCC =MATRIX_SC_NIXJCC+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
