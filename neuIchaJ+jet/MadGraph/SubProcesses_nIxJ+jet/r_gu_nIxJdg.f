      SUBROUTINE SMATRIX_GU_NIXJDG(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_gu_nIxJdg/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_GU_NIXJDG(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_GU_NIXJDG(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,4),W(1,10),GULXJP,MUL,WUL,W(1,11))                                                          
      ...
      CALL HIOXXX(W(1,4),W(1,5),GULXJP,MUL,WUL,W(1,14))                                                          
      ...
      CALL HIOXXX(W(1,2),W(1,35),GDLXJM,MDL,WDL,W(1,37))                                                          
      ...
      CALL HIOCXX(W(1,40),W(1,3),GDLNIP,MDL,WDL,W(1,41))                                                          
      ...
      CALL HIOCXX(W(1,36),W(1,3),GDLNIP,MDL,WDL,W(1,44))                                                          
      ...
      CALL HIOXXX(W(1,23),W(1,35),GDLXJM,MDL,WDL,W(1,53))                                                          
     ...
     &             +AMP(  35)+AMP(  36)+AMP(  38)+AMP(  39)+AMP(  40)
      MATRIX_GU_NIXJDG = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_GU_NIXJDG =MATRIX_GU_NIXJDG+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
