      SUBROUTINE SMATRIX_CXU_NIXJDCX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_cxu_nIxJdcx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_CXU_NIXJDCX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_CXU_NIXJDCX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,31),W(1,1),GQLGOP,MCL,WCL,W(1,32))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,32),GULNIM,AMP(11))         
      CALL HIOXXX(W(1,31),W(1,1),GQRGOP,MCR,WCR,W(1,33))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,33),GURNIM,AMP(12))         
      CALL IXXXXX(P(0,3),MNI,NHEL(3),-1*IC(3),W(1,34))         
      CALL OXXXXX(P(0,6),ZERO,NHEL(6),+1*IC(6),W(1,35))        
      CALL HIOXXX(W(1,34),W(1,1),GULNIP,MCL,WCL,W(1,36))                                                          
      CALL IOSCXX(W(1,14),W(1,35),W(1,36),GQLGOM,AMP(13))        
      CALL HIOXXX(W(1,34),W(1,1),GURNIP,MCR,WCR,W(1,37))                                                          
      CALL IOSCXX(W(1,14),W(1,35),W(1,37),GQRGOM,AMP(14))        
     ...
     &             -AMP(  16)
      MATRIX_CXU_NIXJDCX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_CXU_NIXJDCX =MATRIX_CXU_NIXJDCX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
