      SUBROUTINE SMATRIX_CXS_NIXJCCX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_cxs_nIxJccx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_CXS_NIXJCCX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_CXS_NIXJCCX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOCXX(W(1,5),W(1,3),GURNIP,MCR,WCR,W(1,20))                                                          
      ...
      CALL HIOCXX(W(1,5),W(1,19),GQLGOP,MCL,WCL,W(1,23))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,23),GULNIM,AMP(9))         
      CALL HIOCXX(W(1,5),W(1,19),GQRGOP,MCR,WCR,W(1,24))                                                          
      ...
      CALL HIOXXX(W(1,25),W(1,1),GQRGOP,MCR,WCR,W(1,27))                                                          
      ...
      CALL HIOXXX(W(1,31),W(1,1),GDLXJP,MSL,WSL,W(1,35))                                                          
      ...
      CALL HIOXXX(W(1,51),W(1,1),GULNIP,MCL,WCL,W(1,54))                                                          
      ...
      CALL HIOXXX(W(1,51),W(1,1),GURNIP,MCR,WCR,W(1,59))                                                          
     ...
     &             -AMP(  28)
      MATRIX_CXS_NIXJCCX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_CXS_NIXJCCX =MATRIX_CXS_NIXJCCX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
