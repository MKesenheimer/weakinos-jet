...
C  
C BORN AMPLITUDE IS g u -> n1 x2+ d  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C          write(*,*) "momenta not the same in Born"
     ...
     &       nhel(1,ihel).eq.-1) THEN
                 T=B_CL_010_001(P1,NHEL(1,IHEL),IHEL,JC(1),T1)            
     ...
     &                 .NOT. GOODHEL(IHEL,IPROC)) THEN
      ...
      COMPLEX*16 FUNCTION B_CL_010_001(P,NHEL,HELL,IC,BORNTILDE)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HVSXXX(W(1,1),W(1,6),-GC,MUL,WUL,W(1,8))    
      ...
      CALL HIOXXX(W(1,2),W(1,14),GDLXJM,MDL,WDL,W(1,15))                                                          
     ...
     &             -AMP(   6)-AMP(   7)-AMP(   8)
      DO I = 1, NCOLOR
          ...
          if(ihel.eq.-1) then
             B_CL_010_001=B_CL_010_001 +RTEMP
          elseif(ihel.eq.1) then
             B_CL_010_001=B_CL_010_001 +(0d0,1d0)*RTEMP
          endif
      ENDDO
      Do I = 1, NGRAPHS
