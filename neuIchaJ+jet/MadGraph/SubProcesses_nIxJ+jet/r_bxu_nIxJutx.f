      SUBROUTINE SMATRIX_BXU_NIXJUTX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_bxu_nIxJutx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_BXU_NIXJUTX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_BXU_NIXJUTX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOCXX(W(1,25),W(1,3),GULNIP,MUL,WUL,W(1,27))                                                          
      ...
      CALL HIOCXX(W(1,25),W(1,3),GURNIP,MUR,WUR,W(1,31))                                                          
     ...
     &             -AMP(  31)-AMP(  32)
      MATRIX_BXU_NIXJUTX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_BXU_NIXJUTX =MATRIX_BXU_NIXJUTX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
