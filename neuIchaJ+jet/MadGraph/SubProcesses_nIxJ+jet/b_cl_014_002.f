...
C ----------
      ...
      CALL HIOXXX(W(1,4),W(1,1),GDLXJP,MDL,WDL,W(1,6))                                                          
      CALL FVIXXX(W(1,5),W(1,2),GG,ZERO,ZERO,W(1,7))     
      CALL IOSXXX(W(1,7),W(1,3),W(1,6),GDLNIM,AMP(1))         
      CALL HIOXXX(W(1,5),W(1,3),GDLNIM,MDL,WDL,W(1,8))                                                          
      CALL VSSXXX(W(1,2),W(1,6),W(1,8),GC,AMP(2))             
      CALL FVOXXX(W(1,1),W(1,2),GG,ZERO,ZERO,W(1,9))     
      CALL HIOXXX(W(1,4),W(1,9),GDLXJP,MDL,WDL,W(1,10))                                                          
      CALL IOSXXX(W(1,5),W(1,3),W(1,10),GDLNIM,AMP(3))         
      CALL JIOCXX(W(1,4),W(1,3),GWNIXJ,WMASS,WWIDTH,W(1,      
     &     11))                                                          
      CALL IOVXXX(W(1,7),W(1,1),W(1,11),GWF,AMP(4))            
      ...
      CALL HIOXXX(W(1,12),W(1,1),GULNIP,MUL,WUL,W(1,14))                                                          
      CALL FSOXXX(W(1,13),W(1,14),GULXJM,ZERO,ZERO,W(1,15))                                                          
      CALL IOVXXX(W(1,5),W(1,15),W(1,2),GG,AMP(6))             
      CALL HVSXXX(W(1,2),W(1,14),GC,MUL,WUL,W(1,16))     
      CALL IOSXXX(W(1,5),W(1,13),W(1,16),GULXJM,AMP(7))         
      CALL HIOXXX(W(1,12),W(1,9),GULNIP,MUL,WUL,W(1,17))                                                          
      CALL IOSXXX(W(1,5),W(1,13),W(1,17),GULXJM,AMP(8))         
      do i=1,ngraphs
         if(ihel.eq.-1)then
