      SUBROUTINE SMATRIX_SXS_NIXJBTX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_sxs_nIxJbtx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_SXS_NIXJBTX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_SXS_NIXJBTX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,40),W(1,1),GDLNIP,MSL,WSL,W(1,41))                                                          
      ...
      CALL HIOXXX(W(1,40),W(1,1),GDRNIP,MSR,WSR,W(1,45))                                                          
     ...
     &             +AMP(  31)+AMP(  32)
      MATRIX_SXS_NIXJBTX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_SXS_NIXJBTX =MATRIX_SXS_NIXJBTX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
