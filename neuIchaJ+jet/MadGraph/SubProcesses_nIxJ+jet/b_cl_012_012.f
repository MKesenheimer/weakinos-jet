...
C  
C BORN AMPLITUDE IS d g -> n1 x2- u  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      CALL HIOXXX(W(1,1),W(1,3),GDLNIM,MDL,WDL,W(1,6))                                                          
      CALL FSIXXX(W(1,4),W(1,6),GDLXJP,ZERO,ZERO,W(1,7))                                                          
      CALL IOVXXX(W(1,7),W(1,5),W(1,2),GG,AMP(1))             
      CALL HVSXXX(W(1,2),W(1,6),-GC,MDL,WDL,W(1,8))    
      CALL IOSXXX(W(1,4),W(1,5),W(1,8),GDLXJP,AMP(2))         
      CALL FVIXXX(W(1,1),W(1,2),GG,ZERO,ZERO,W(1,9))     
      CALL HIOXXX(W(1,9),W(1,3),GDLNIM,MDL,WDL,W(1,10))                                                          
      CALL IOSXXX(W(1,4),W(1,5),W(1,10),GDLXJP,AMP(3))         
      CALL JIOCXX(W(1,4),W(1,3),GWNIXJ,WMASS,WWIDTH,W(1,      
     &     11))                                                          
      CALL FVOXXX(W(1,5),W(1,2),GG,ZERO,ZERO,W(1,12))     
      CALL IOVXXX(W(1,1),W(1,12),W(1,11),GWF,AMP(4))            
      CALL IOVXXX(W(1,9),W(1,5),W(1,11),GWF,AMP(5))            
      CALL IXXXXX(P(0,3),MNI,NHEL(3),-1*IC(3),W(1,13))         
      CALL OXXXXX(P(0,4),MXJ,NHEL(4),+1*IC(4),W(1,14))         
      CALL HIOXXX(W(1,1),W(1,14),GULXJM,MUL,WUL,W(1,15))                                                          
      CALL IOSXXX(W(1,13),W(1,12),W(1,15),GULNIP,AMP(6))         
      CALL HIOXXX(W(1,13),W(1,5),GULNIP,MUL,WUL,W(1,16))                                                          
      CALL VSSXXX(W(1,2),W(1,16),W(1,15),GC,AMP(7))             
      CALL HIOXXX(W(1,9),W(1,14),GULXJM,MUL,WUL,W(1,17))                                                          
      CALL IOSXXX(W(1,13),W(1,5),W(1,17),GULNIP,AMP(8))         
      do i=1,ngraphs
         if(ihel.eq.-1)then
