...
C  
C BORN AMPLITUDE IS u d~ -> n1 x2+ g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      CALL HIOXXX(W(1,1),W(1,3),GULNIM,MUL,WUL,W(1,8))                                                          
      ...
      CALL JIOXXX(W(1,4),W(1,3),GWXJNI,WMASS,WWIDTH,W(1,10))
      ...
      CALL HIOXXX(W(1,1),W(1,13),GDLXJM,MDL,WDL,W(1,16))                                                          
      CALL IOSXXX(W(1,12),W(1,11),W(1,16),GDLNIP,AMP(7))         
