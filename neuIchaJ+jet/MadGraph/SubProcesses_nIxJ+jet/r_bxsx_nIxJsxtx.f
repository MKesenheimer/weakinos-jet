      SUBROUTINE SMATRIX_BXSX_NIXJSXTX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_bxsx_nIxJsxtx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_BXSX_NIXJSXTX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_BXSX_NIXJSXTX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,25),W(1,2),GDLNIP,MSL,WSL,W(1,27))                                                          
      ...
      CALL HIOXXX(W(1,25),W(1,2),GDRNIP,MSR,WSR,W(1,31))                                                          
     ...
     &             -AMP(  31)-AMP(  32)
      MATRIX_BXSX_NIXJSXTX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_BXSX_NIXJSXTX =MATRIX_BXSX_NIXJSXTX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
