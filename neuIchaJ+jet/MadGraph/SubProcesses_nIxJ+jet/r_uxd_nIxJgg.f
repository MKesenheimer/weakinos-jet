      SUBROUTINE SMATRIX_UXD_NIXJGG(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_uxd_nIxJgg/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_UXD_NIXJGG(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_UXD_NIXJGG(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,4),W(1,10),GDLXJP,MDL,WDL,W(1,11))                                                          
      ...
      CALL HIOXXX(W(1,14),W(1,3),GDLNIM,MDL,WDL,W(1,15))                                                          
      CALL FSIXXX(W(1,4),W(1,15),GDLXJP,ZERO,ZERO,W(1,16))                                                          
      CALL IOVXXX(W(1,16),W(1,1),W(1,6),GG,AMP(6))             
      CALL HIOXXX(W(1,4),W(1,1),GDLXJP,MDL,WDL,W(1,17))                                                          
      ...
      CALL HIOXXX(W(1,2),W(1,36),GULXJM,MUL,WUL,W(1,37))                                                          
      ...
      CALL HIOXXX(W(1,35),W(1,10),GULNIP,MUL,WUL,W(1,40))                                                          
      ...
      CALL HIOXXX(W(1,14),W(1,36),GULXJM,MUL,WUL,W(1,43))                                                          
      CALL FSIXXX(W(1,35),W(1,43),GULNIP,ZERO,ZERO,W(1,44))                                                          
      CALL IOVXXX(W(1,44),W(1,1),W(1,6),GG,AMP(30))             
      CALL HIOXXX(W(1,35),W(1,1),GULNIP,MUL,WUL,W(1,45))                                                          
     ...
     &             -AMP(  32)+AMP(  36)-AMP(  37)+AMP(  38)+AMP(  40)
      MATRIX_UXD_NIXJGG = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_UXD_NIXJGG =MATRIX_UXD_NIXJGG+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
