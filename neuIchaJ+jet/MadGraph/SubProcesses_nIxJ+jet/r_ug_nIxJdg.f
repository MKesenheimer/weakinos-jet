      SUBROUTINE SMATRIX_UG_NIXJDG(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_ug_nIxJdg/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_UG_NIXJDG(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_UG_NIXJDG(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOCXX(W(1,37),W(1,3),GDLNIP,MDL,WDL,W(1,38))                                                          
      CALL FSOXXX(W(1,35),W(1,38),GDLXJM,ZERO,ZERO,W(1,39))                                                          
      CALL IOVXXX(W(1,1),W(1,39),W(1,6),GG,AMP(25))             
      CALL HIOXXX(W(1,1),W(1,35),GDLXJM,MDL,WDL,W(1,40))                                                          
     ...
     &             +AMP(  35)+AMP(  37)+AMP(  38)+AMP(  39)+AMP(  40)
      MATRIX_UG_NIXJDG = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_UG_NIXJDG =MATRIX_UG_NIXJDG+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
