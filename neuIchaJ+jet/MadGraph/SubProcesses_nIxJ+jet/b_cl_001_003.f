...
C ----------
      ...
      CALL HIOXXX(W(1,4),W(1,1),GULXJP,MUL,WUL,W(1,8))                                                          
      CALL FVIXXX(W(1,2),W(1,5),GG,ZERO,ZERO,W(1,9))     
      CALL IOSXXX(W(1,9),W(1,3),W(1,8),GULNIM,AMP(2))         
      ...
      CALL HIOXXX(W(1,2),W(1,13),GDLXJM,MDL,WDL,W(1,14))                                                          
      CALL IOSXXX(W(1,12),W(1,11),W(1,14),GDLNIP,AMP(6))         
      CALL HIOXXX(W(1,12),W(1,1),GDLNIP,MDL,WDL,W(1,15))                                                          
      CALL FSOXXX(W(1,13),W(1,15),GDLXJM,ZERO,ZERO,W(1,16))                                                          
