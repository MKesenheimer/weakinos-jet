      SUBROUTINE SMATRIX_DU_NIXJDD(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_du_nIxJdd/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_DU_NIXJDD(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_DU_NIXJDD(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,16),W(1,3),GULNIM,MUL,WUL,W(1,17))                                                          
      ...
      CALL HIOXXX(W(1,2),W(1,21),GQLGOM,MUL,WUL,W(1,22))                                                          
      CALL IOSXXX(W(1,4),W(1,6),W(1,22),GULXJP,AMP(9))         
      CALL FSOXXX(W(1,5),W(1,20),GQRGOP,MGO,WGO,W(1,23))                                                          
      CALL HIOXXX(W(1,2),W(1,23),GQLGOM,MUL,WUL,W(1,24))                                                          
      ...
      CALL HIOXXX(W(1,2),W(1,30),GDLXJM,MDL,WDL,W(1,32))                                                          
      CALL HVSXXX(W(1,14),W(1,32),-GC,MDL,WDL,W(1,33))    
      ...
      CALL HIOXXX(W(1,1),W(1,35),GQLGOM,MDL,WDL,W(1,36))                                                          
      CALL IOSCXX(W(1,31),W(1,3),W(1,36),GDLNIP,AMP(17))        
      CALL HIOXXX(W(1,1),W(1,35),GQRGOM,MDR,WDR,W(1,37))                                                          
      CALL IOSCXX(W(1,31),W(1,3),W(1,37),GDRNIP,AMP(18))        
      CALL HIOXXX(W(1,16),W(1,30),GDLXJM,MDL,WDL,W(1,38))                                                          
      ...
      CALL HIOXXX(W(1,1),W(1,49),GQRGOM,MDR,WDR,W(1,51))                                                          
      CALL IOSCXX(W(1,31),W(1,3),W(1,51),GDRNIP,AMP(30))        
      CALL HIOCXX(W(1,43),W(1,48),GQLGOM,MUL,WUL,W(1,52))                                                          
      CALL IOSXXX(W(1,4),W(1,6),W(1,52),GULXJP,AMP(31))         
      CALL HIOCXX(W(1,45),W(1,48),GQLGOM,MUL,WUL,W(1,53))                                                          
     ...
     &             +AMP(  32)
      MATRIX_DU_NIXJDD = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_DU_NIXJDD =MATRIX_DU_NIXJDD+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
