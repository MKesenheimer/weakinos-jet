      SUBROUTINE SMATRIX_BXC_NIXJCTX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_bxc_nIxJctx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_BXC_NIXJCTX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_BXC_NIXJCTX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOCXX(W(1,25),W(1,3),GULNIP,MCL,WCL,W(1,27))                                                          
      CALL FSIXXX(W(1,2),W(1,27),GQLGOM,MGO,WGO,W(1,28))                                                          
      ...
      CALL HIOCXX(W(1,25),W(1,3),GURNIP,MCR,WCR,W(1,31))                                                          
      CALL FSIXXX(W(1,2),W(1,31),GQRGOM,MGO,WGO,W(1,32))                                                          
     ...
     &             -AMP(  31)-AMP(  32)
      MATRIX_BXC_NIXJCTX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_BXC_NIXJCTX =MATRIX_BXC_NIXJCTX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
