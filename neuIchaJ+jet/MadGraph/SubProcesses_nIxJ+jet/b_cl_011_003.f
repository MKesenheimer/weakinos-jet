...
C  
C BORN AMPLITUDE IS d u~ -> n1 x2- g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      CALL HIOXXX(W(1,4),W(1,2),GDLXJP,MDL,WDL,W(1,6))                                                          
      CALL FVIXXX(W(1,1),W(1,5),GG,ZERO,ZERO,W(1,7))     
      CALL IOSXXX(W(1,7),W(1,3),W(1,6),GDLNIM,AMP(1))         
      CALL HIOXXX(W(1,1),W(1,3),GDLNIM,MDL,WDL,W(1,8))                                                          
      CALL FSIXXX(W(1,4),W(1,8),GDLXJP,ZERO,ZERO,W(1,9))                                                          
      CALL IOVXXX(W(1,9),W(1,2),W(1,5),GG,AMP(2))             
      CALL VSSXXX(W(1,5),W(1,6),W(1,8),GC,AMP(3))             
      CALL JIOCXX(W(1,4),W(1,3),GWNIXJ,WMASS,WWIDTH,W(1,      
     &     10))                                                          
      CALL IOVXXX(W(1,7),W(1,2),W(1,10),GWF,AMP(4))            
      CALL FVOXXX(W(1,2),W(1,5),GG,ZERO,ZERO,W(1,11))     
      CALL IOVXXX(W(1,1),W(1,11),W(1,10),GWF,AMP(5))            
      CALL IXXXXX(P(0,3),MNI,NHEL(3),-1*IC(3),W(1,12))         
      CALL OXXXXX(P(0,4),MXJ,NHEL(4),+1*IC(4),W(1,13))         
      CALL HIOXXX(W(1,12),W(1,2),GULNIP,MUL,WUL,W(1,14))                                                          
      CALL FSOXXX(W(1,13),W(1,14),GULXJM,ZERO,ZERO,W(1,15))                                                          
      CALL IOVXXX(W(1,1),W(1,15),W(1,5),GG,AMP(6))             
      CALL HIOXXX(W(1,1),W(1,13),GULXJM,MUL,WUL,W(1,16))                                                          
      CALL IOSXXX(W(1,12),W(1,11),W(1,16),GULNIP,AMP(7))         
      CALL VSSXXX(W(1,5),W(1,14),W(1,16),GC,AMP(8))             
      do i=1,ngraphs
         if(ihel.eq.-1)then
