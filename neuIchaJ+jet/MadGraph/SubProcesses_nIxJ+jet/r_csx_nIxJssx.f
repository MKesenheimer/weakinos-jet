      SUBROUTINE SMATRIX_CSX_NIXJSSX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_csx_nIxJssx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_CSX_NIXJSSX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_CSX_NIXJSSX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,4),W(1,5),GULXJP,MCL,WCL,W(1,7))                                                          
      ...
      CALL HIOXXX(W(1,4),W(1,2),GULXJP,MCL,WCL,W(1,11))                                                          
      ...
      CALL HIOXXX(W(1,1),W(1,3),GULNIM,MCL,WCL,W(1,14))                                                          
      CALL FSIXXX(W(1,4),W(1,14),GULXJP,ZERO,ZERO,W(1,15))                                                          
      CALL JIOXXX(W(1,15),W(1,2),GG,ZERO,ZERO,W(1,16))     
      CALL IOVXXX(W(1,6),W(1,5),W(1,16),GG,AMP(4))             
      CALL JSSXXX(W(1,11),W(1,14),GC,ZERO,ZERO,W(1,17))     
      ...
      CALL JSSXXX(W(1,7),W(1,14),GC,ZERO,ZERO,W(1,19))     
      CALL IOVXXX(W(1,6),W(1,2),W(1,19),GG,AMP(7))             
      CALL FSOXXX(W(1,3),W(1,7),GULNIM,ZERO,ZERO,W(1,20))                                                          
      CALL JIOXXX(W(1,1),W(1,20),GG,ZERO,ZERO,W(1,21))     
      CALL IOVXXX(W(1,6),W(1,2),W(1,21),GG,AMP(8))             
      CALL FSIXXX(W(1,1),W(1,11),GQLGOM,MGO,WGO,W(1,22))                                                          
      CALL HIOXXX(W(1,22),W(1,5),GQLGOP,MSL,WSL,W(1,23))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,23),GDLNIM,AMP(9))         
      CALL HIOXXX(W(1,22),W(1,5),GQRGOP,MSR,WSR,W(1,24))                                                          
      ...
      CALL JIOXXX(W(1,28),W(1,5),GG,ZERO,ZERO,W(1,30))     
      CALL IOVXXX(W(1,6),W(1,2),W(1,30),GG,AMP(13))             
      CALL FVOXXX(W(1,5),W(1,25),GWF,ZERO,ZERO,W(1,31))    
      ...
      CALL IOSCXX(W(1,22),W(1,34),W(1,35),GQLGOM,AMP(15))        
      CALL HIOCXX(W(1,33),W(1,3),GDRNIP,MSR,WSR,W(1,36))                                                          
      CALL IOSCXX(W(1,22),W(1,34),W(1,36),GQRGOM,AMP(16))        
      CALL OXXXXX(P(0,4),MXJ,NHEL(4),+1*IC(4),W(1,37))         
      CALL HIOXXX(W(1,1),W(1,37),GDLXJM,MSL,WSL,W(1,38))                                                          
      CALL FSOCXX(W(1,3),W(1,38),GDLNIP,ZERO,ZERO,W(1,39))                                                          
      CALL JIOCXX(W(1,33),W(1,39),GG,ZERO,ZERO,W(1,40))    
      CALL IOVXXX(W(1,6),W(1,2),W(1,40),GG,AMP(17))             
      CALL JSSXXX(W(1,35),W(1,38),GC,ZERO,ZERO,W(1,41))     
      CALL IOVXXX(W(1,6),W(1,2),W(1,41),GG,AMP(18))             
      CALL FSOXXX(W(1,2),W(1,38),GQLGOP,MGO,WGO,W(1,42))                                                          
      ...
      CALL HIOCXX(W(1,33),W(1,42),GQLGOP,MSL,WSL,W(1,45))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,45),GDLNIM,AMP(22))         
      CALL HIOCXX(W(1,33),W(1,42),GQRGOP,MSR,WSR,W(1,46))                                                          
      ...
      CALL HIOXXX(W(1,50),W(1,2),GDLNIP,MSL,WSL,W(1,51))                                                          
      CALL IOSCXX(W(1,8),W(1,34),W(1,51),GQLGOM,AMP(26))        
      CALL HIOXXX(W(1,50),W(1,2),GDRNIP,MSR,WSR,W(1,52))                                                          
      CALL IOSCXX(W(1,8),W(1,34),W(1,52),GQRGOM,AMP(27))        
      CALL FSOXXX(W(1,37),W(1,51),GDLXJM,ZERO,ZERO,W(1,53))                                                          
      CALL JIOXXX(W(1,1),W(1,53),GG,ZERO,ZERO,W(1,54))     
      CALL IOVXXX(W(1,6),W(1,5),W(1,54),GG,AMP(28))             
      CALL FSIXXX(W(1,50),W(1,38),GDLNIP,ZERO,ZERO,W(1,55))                                                          
     ...
     &             +AMP(  32)
      JAMP(   2) = -AMP(   3)-AMP(   4)-AMP(   5)+AMP(   9)+AMP(  10)
     &             +AMP(  11)+AMP(  12)-AMP(  15)-AMP(  16)+AMP(  19)
     &             +AMP(  20)-AMP(  22)-AMP(  23)+AMP(  28)+AMP(  29)
     &             +AMP(  30)
      MATRIX_CSX_NIXJSSX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_CSX_NIXJSSX =MATRIX_CSX_NIXJSSX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
