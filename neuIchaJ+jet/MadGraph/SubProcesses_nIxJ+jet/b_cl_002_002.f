...
C ----------
      ...
      CALL HIOXXX(W(1,12),W(1,1),GDLNIP,MDL,WDL,W(1,14))                                                          
      CALL FSOXXX(W(1,13),W(1,14),GDLXJM,ZERO,ZERO,W(1,15))                                                          
      CALL IOVXXX(W(1,5),W(1,15),W(1,2),GG,AMP(6))             
      CALL HVSXXX(W(1,2),W(1,14),GC,MDL,WDL,W(1,16))     
      CALL IOSXXX(W(1,5),W(1,13),W(1,16),GDLXJM,AMP(7))         
      CALL HIOXXX(W(1,12),W(1,9),GDLNIP,MDL,WDL,W(1,17))                                                          
      CALL IOSXXX(W(1,5),W(1,13),W(1,17),GDLXJM,AMP(8))         
      do i=1,ngraphs
         if(ihel.eq.-1)then
