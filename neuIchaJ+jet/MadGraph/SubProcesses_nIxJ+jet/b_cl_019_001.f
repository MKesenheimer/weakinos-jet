...
C  
C BORN AMPLITUDE IS g d -> n1 x2- u  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      CALL HVSXXX(W(1,1),W(1,6),-GC,MDL,WDL,W(1,8))    
     ...
     &     11))                                                          
      CALL FVOXXX(W(1,5),W(1,1),GG,ZERO,ZERO,W(1,12))     
      CALL IOVXXX(W(1,2),W(1,12),W(1,11),GWF,AMP(4))            
