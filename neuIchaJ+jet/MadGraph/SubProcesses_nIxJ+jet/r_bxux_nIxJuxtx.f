      SUBROUTINE SMATRIX_BXUX_NIXJUXTX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_bxux_nIxJuxtx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_BXUX_NIXJUXTX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_BXUX_NIXJUXTX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,25),W(1,2),GULNIP,MUL,WUL,W(1,27))                                                          
      ...
      CALL HIOXXX(W(1,25),W(1,2),GURNIP,MUR,WUR,W(1,31))                                                          
     ...
     &             -AMP(  31)-AMP(  32)
      MATRIX_BXUX_NIXJUXTX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_BXUX_NIXJUXTX =MATRIX_BXUX_NIXJUXTX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
