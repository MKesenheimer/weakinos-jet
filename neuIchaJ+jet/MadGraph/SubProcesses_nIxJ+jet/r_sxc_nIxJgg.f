      SUBROUTINE SMATRIX_SXC_NIXJGG(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_sxc_nIxJgg/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_SXC_NIXJGG(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_SXC_NIXJGG(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,4),W(1,1),GULXJP,MCL,WCL,W(1,17))                                                          
      ...
      CALL FSIXXX(W(1,4),W(1,21),GULXJP,ZERO,ZERO,W(1,22))                                                          
      ...
      CALL HIOXXX(W(1,2),W(1,36),GDLXJM,MSL,WSL,W(1,37))                                                          
      CALL FSIXXX(W(1,35),W(1,37),GDLNIP,ZERO,ZERO,W(1,38))                                                          
      CALL FVIXXX(W(1,38),W(1,5),GG,ZERO,ZERO,W(1,39))     
      CALL IOVXXX(W(1,39),W(1,1),W(1,6),GG,AMP(25))             
      CALL HIOXXX(W(1,35),W(1,10),GDLNIP,MSL,WSL,W(1,40))                                                          
      CALL FSOXXX(W(1,36),W(1,40),GDLXJM,ZERO,ZERO,W(1,41))                                                          
      ...
      CALL HIOXXX(W(1,14),W(1,36),GDLXJM,MSL,WSL,W(1,43))                                                          
      CALL FSIXXX(W(1,35),W(1,43),GDLNIP,ZERO,ZERO,W(1,44))                                                          
      CALL IOVXXX(W(1,44),W(1,1),W(1,6),GG,AMP(30))             
      CALL HIOXXX(W(1,35),W(1,1),GDLNIP,MSL,WSL,W(1,45))                                                          
      CALL FSOXXX(W(1,36),W(1,45),GDLXJM,ZERO,ZERO,W(1,46))                                                          
      ...
      CALL FSIXXX(W(1,35),W(1,49),GDLNIP,ZERO,ZERO,W(1,50))                                                          
      CALL IOVXXX(W(1,50),W(1,1),W(1,6),GG,AMP(35))             
      CALL HVSXXX(W(1,5),W(1,45),GC,MSL,WSL,W(1,51))     
      CALL FSOXXX(W(1,36),W(1,51),GDLXJM,ZERO,ZERO,W(1,52))                                                          
     ...
     &             -AMP(  32)+AMP(  36)-AMP(  37)+AMP(  38)+AMP(  40)
      MATRIX_SXC_NIXJGG = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_SXC_NIXJGG =MATRIX_SXC_NIXJGG+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
