      SUBROUTINE SMATRIX_UDX_NIXJDDX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_udx_nIxJddx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_UDX_NIXJDDX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_UDX_NIXJDDX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,8),W(1,2),GQLGOP,MDL,WDL,W(1,9))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,9),GDLNIM,AMP(1))         
      CALL HIOXXX(W(1,8),W(1,2),GQRGOP,MDR,WDR,W(1,10))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,10),GDRNIM,AMP(2))         
      CALL HIOXXX(W(1,4),W(1,2),GULXJP,MUL,WUL,W(1,11))                                                          
      ...
      CALL HIOXXX(W(1,22),W(1,5),GQLGOP,MDL,WDL,W(1,23))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,23),GDLNIM,AMP(9))         
      CALL HIOXXX(W(1,22),W(1,5),GQRGOP,MDR,WDR,W(1,24))                                                          
      ...
      CALL HIOXXX(W(1,1),W(1,37),GDLXJM,MDL,WDL,W(1,38))                                                          
      ...
      CALL HIOXXX(W(1,47),W(1,2),GQLGOP,MDL,WDL,W(1,48))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,48),GDLNIM,AMP(24))         
      CALL HIOXXX(W(1,47),W(1,2),GQRGOP,MDR,WDR,W(1,49))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,49),GDRNIM,AMP(25))         
      CALL IXXXXX(P(0,3),MNI,NHEL(3),-1*IC(3),W(1,50))         
      CALL HIOXXX(W(1,50),W(1,2),GDLNIP,MDL,WDL,W(1,51))                                                          
      CALL IOSCXX(W(1,8),W(1,34),W(1,51),GQLGOM,AMP(26))        
      CALL HIOXXX(W(1,50),W(1,2),GDRNIP,MDR,WDR,W(1,52))                                                          
     ...
     &             +AMP(  30)
      MATRIX_UDX_NIXJDDX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_UDX_NIXJDDX =MATRIX_UDX_NIXJDDX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
