      SUBROUTINE SMATRIX_BXS_NIXJSTX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_bxs_nIxJstx/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_BXS_NIXJSTX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_BXS_NIXJSTX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOXXX(W(1,2),W(1,3),GDRNIM,MSR,WSR,W(1,19))                                                          
      ...
      CALL HIOCXX(W(1,25),W(1,3),GDLNIP,MSL,WSL,W(1,27))                                                          
      ...
      CALL HIOCXX(W(1,25),W(1,3),GDRNIP,MSR,WSR,W(1,31))                                                          
     ...
     &             -AMP(  31)-AMP(  32)
      MATRIX_BXS_NIXJSTX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_BXS_NIXJSTX =MATRIX_BXS_NIXJSTX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
