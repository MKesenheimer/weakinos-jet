      SUBROUTINE SMATRIX_CXS_NIXJUUX(P1,ANS)
C  
...
C  
      ...
      common/to_Ramps_cxs_nIxJuux/  amp2,       jamp2
...
C ----------
      ...
      ANS(IPROC) = 0D0
          DO IHEL=1,NCOMB
             IF(GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=MATRIX_CXS_NIXJUUX(P1,NHEL(1,IHEL),JC(1))            
      ...
      REAL*8 FUNCTION MATRIX_CXS_NIXJUUX(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL HIOCXX(W(1,5),W(1,3),GULNIP,MUL,WUL,W(1,11))                                                          
      CALL IOSXXX(W(1,6),W(1,8),W(1,11),GQLGOM,AMP(3))         
      CALL HIOCXX(W(1,5),W(1,3),GURNIP,MUR,WUR,W(1,12))                                                          
      ...
      CALL HIOXXX(W(1,22),W(1,14),GQLGOP,MUL,WUL,W(1,23))                                                          
      CALL IOSXXX(W(1,6),W(1,3),W(1,23),GULNIM,AMP(8))         
      CALL HIOXXX(W(1,22),W(1,14),GQRGOP,MUR,WUR,W(1,24))                                                          
     ...
     &             -AMP(  16)
      MATRIX_CXS_NIXJUUX = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP =(0.D0,0.D0)
          DO J = 1, NCOLOR
              ZTEMP = ZTEMP + CF(J,I)*JAMP(J)
          ENDDO
          MATRIX_CXS_NIXJUUX =MATRIX_CXS_NIXJUUX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
