...
C  
C BORN AMPLITUDE IS u g -> n1 x2+ d  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C ----------
      ...
      CALL FSIXXX(W(1,4),W(1,6),GULXJP,ZERO,ZERO,W(1,7))                                                          
      CALL IOVXXX(W(1,7),W(1,5),W(1,2),GG,AMP(1))             
      CALL HVSXXX(W(1,2),W(1,6),-GC,MUL,WUL,W(1,8))    
      CALL IOSXXX(W(1,4),W(1,5),W(1,8),GULXJP,AMP(2))         
      CALL FVIXXX(W(1,1),W(1,2),GG,ZERO,ZERO,W(1,9))     
      CALL HIOXXX(W(1,9),W(1,3),GULNIM,MUL,WUL,W(1,10))                                                          
      CALL IOSXXX(W(1,4),W(1,5),W(1,10),GULXJP,AMP(3))         
      ...
      CALL HIOXXX(W(1,1),W(1,14),GDLXJM,MDL,WDL,W(1,15))                                                          
      CALL IOSXXX(W(1,13),W(1,12),W(1,15),GDLNIP,AMP(6))         
      CALL HIOXXX(W(1,13),W(1,5),GDLNIP,MDL,WDL,W(1,16))                                                          
      CALL VSSXXX(W(1,2),W(1,16),W(1,15),GC,AMP(7))             
      CALL HIOXXX(W(1,9),W(1,14),GDLXJM,MDL,WDL,W(1,17))                                                          
      CALL IOSXXX(W(1,13),W(1,5),W(1,17),GDLNIP,AMP(8))         
      do i=1,ngraphs
         if(ihel.eq.-1)then
